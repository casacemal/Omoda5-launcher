...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f80CR = 13;

    /* renamed from: LF */
    private static final byte f81LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f82in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f82in
            monitor-enter(r0)
        ...
        L8c:
            ...
            goto L69
        L8f:
            java.io.IOException r7 = new java.io.IOException     // Catch: java.lang.Throwable -> L97
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f82in;
        byte[] bArr = this.buf;
        int r0 = inputStream.read(bArr, 0, bArr.length);
        if (r0 == -1) {
