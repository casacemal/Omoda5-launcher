...
public class ResourceBitmapDecoder implements ResourceDecoder<Uri, Bitmap> {
    ...
    public Resource<Bitmap> decode(Uri uri, int r3, int r4, Options options) {
        Resource<Drawable> resourceDecode = this.drawableDecoder.decode(uri, r3, r4, options);
        if (resourceDecode == null) {
            return null;
        }
        return DrawableToBitmapConverter.convert(this.bitmapPool, resourceDecode.get(), r3, r4);
    }
}
