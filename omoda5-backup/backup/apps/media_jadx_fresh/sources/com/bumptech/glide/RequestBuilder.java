...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public RequestBuilder<TranscodeType> mo46clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.mo46clone();
        requestBuilder.transitionOptions = requestBuilder.transitionOptions.m47clone();
    ...
    */
    public com.bumptech.glide.request.target.ViewTarget<android.widget.ImageView, TranscodeType> into(android.widget.ImageView r4) {
        /*
            ...
            if (r0 == 0) goto L4c
            int[] r0 = com.bumptech.glide.RequestBuilder.C05211.$SwitchMap$android$widget$ImageView$ScaleType
        ...
        L27:
            goto L4c
        L28:
            com.bumptech.glide.request.BaseRequestOptions r0 = r3.mo46clone()
    ...
    @Deprecated
    public FutureTarget<File> downloadOnly(int r1, int r2) {
        return getDownloadOnlyRequest().submit(r1, r2);
    }
    ...
    private Priority getThumbnailPriority(Priority priority) {
        int r3 = C05211.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (r3 == 1) {
    ...
    private Request buildRequestRecursive(Object obj, Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int r21, int r22, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        Request requestBuildThumbnailRequestRecursive = buildThumbnailRequestRecursive(obj, target, requestListener, errorRequestCoordinator2, transitionOptions, priority, r21, r22, baseRequestOptions, executor);
        if (errorRequestCoordinator == 0) {
            return requestBuildThumbnailRequestRecursive;
        }
        int overrideWidth = this.errorBuilder.getOverrideWidth();
        int overrideHeight = this.errorBuilder.getOverrideHeight();
        if (Util.isValidDimensions(r21, r22) && !this.errorBuilder.isValidOverride()) {
    ...
    private Request buildThumbnailRequestRecursive(Object obj, Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int r25, int r26, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        if (requestBuilder != null) {
            ...
            if (Util.isValidDimensions(r25, r26) && !this.thumbnailBuilder.isValidOverride()) {
                overrideWidth = baseRequestOptions.getOverrideWidth();
                overrideHeight = baseRequestOptions.getOverrideHeight();
            }
            ThumbnailRequestCoordinator thumbnailRequestCoordinator = new ThumbnailRequestCoordinator(obj, requestCoordinator);
            Request requestObtainRequest = obtainRequest(obj, target, requestListener, baseRequestOptions, thumbnailRequestCoordinator, transitionOptions, priority, r25, r26, executor);
        ...
        if (this.thumbSizeMultiplier != null) {
            ...
            thumbnailRequestCoordinator2.setRequests(obtainRequest(obj, target, requestListener, baseRequestOptions, thumbnailRequestCoordinator2, transitionOptions, priority, r25, r26, executor), obtainRequest(obj, target, requestListener, baseRequestOptions.mo46clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue()), thumbnailRequestCoordinator2, transitionOptions, getThumbnailPriority(priority), r25, r26, executor));
            return thumbnailRequestCoordinator2;
        }
        return obtainRequest(obj, target, requestListener, baseRequestOptions, requestCoordinator, transitionOptions, priority, r25, r26, executor);
    }

    private Request obtainRequest(Object obj, Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, BaseRequestOptions<?> baseRequestOptions, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int r24, int r25, Executor executor) {
        Context context = this.context;
        GlideContext glideContext = this.glideContext;
        return SingleRequest.obtain(context, glideContext, obj, this.model, this.transcodeClass, baseRequestOptions, r24, r25, priority, target, requestListener, this.requestListeners, requestCoordinator, glideContext.getEngine(), transitionOptions.getTransitionFactory(), executor);
    }
}
