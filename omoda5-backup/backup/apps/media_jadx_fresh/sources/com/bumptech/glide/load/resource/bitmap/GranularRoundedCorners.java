...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f100ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f100ID.getBytes(CHARSET);
    ...
    protected Bitmap transform(BitmapPool bitmapPool, Bitmap bitmap, int r9, int r10) {
