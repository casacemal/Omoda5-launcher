...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable, Animatable2Compat {
    ...
    @Deprecated
    public GifDrawable(Context context, GifDecoder gifDecoder, BitmapPool bitmapPool, Transformation<Bitmap> transformation, int r12, int r13, Bitmap bitmap) {
        this(context, gifDecoder, transformation, r12, r13, bitmap);
    }

    public GifDrawable(Context context, GifDecoder gifDecoder, Transformation<Bitmap> transformation, int r13, int r14, Bitmap bitmap) {
        this(new GifState(new GifFrameLoader(Glide.get(context), gifDecoder, r13, r14, transformation, bitmap)));
    }
    ...
    public void onFrameReady() {
        ...
        int r0 = this.maxLoopCount;
        if (r0 == -1 || this.loopCount < r0) {
            return;
        }
    ...
    private void notifyAnimationEndToListeners() {
        ...
        if (list != null) {
            ...
            for (int r1 = 0; r1 < size; r1++) {
                this.animationCallbacks.get(r1).onAnimationEnd(this);
            }
        }
    }
