...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public T placeholder(int r2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo46clone().placeholder(r2);
        }
        this.placeholderId = r2;
        int r22 = this.fields | 128;
        this.fields = r22;
    ...
    public T fallback(Drawable drawable) {
        ...
        int r2 = this.fields | 8192;
        this.fields = r2;
        this.fallbackId = 0;
        this.fields = r2 & (-16385);
        return (T) selfOrThrowIfLocked();
    }

    public T fallback(int r2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo46clone().fallback(r2);
        }
        this.fallbackId = r2;
        int r22 = this.fields | 16384;
        this.fields = r22;
        this.fallbackDrawable = null;
        this.fields = r22 & (-8193);
        return (T) selfOrThrowIfLocked();
    }
    ...
    public T error(int r2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo46clone().error(r2);
        }
        this.errorId = r2;
        int r22 = this.fields | 32;
        this.fields = r22;
    ...
    public T override(int r2, int r3) {
        if (this.isAutoCloneEnabled) {
            return (T) mo46clone().override(r2, r3);
        }
    ...
    public T encodeQuality(int r2) {
        return (T) set(BitmapEncoder.COMPRESSION_QUALITY, Integer.valueOf(r2));
    }
    ...
    public T timeout(int r2) {
        return (T) set(HttpGlideUrlLoader.TIMEOUT, Integer.valueOf(r2));
    }
    ...
    public T dontTransform() {
        ...
        int r0 = this.fields & (-2049);
        this.fields = r0;
        this.isTransformationRequired = false;
        int r02 = r0 & (-131073);
        this.fields = r02;
        this.isTransformationAllowed = false;
        this.fields = r02 | 65536;
    ...
    private boolean isSet(int r1) {
        return isSet(this.fields, r1);
    }
