...
class ResourceCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final DataFetcherGenerator.FetcherReadyCallback f93cb;
    ...
    ResourceCacheGenerator(DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f93cb = fetcherReadyCallback;
    }
    ...
    public boolean startNext() {
        ...
        while (true) {
            if (this.modelLoaders == null || !hasNextModelLoader()) {
                int r3 = this.resourceClassIndex + 1;
                this.resourceClassIndex = r3;
                if (r3 >= registeredResourceClasses.size()) {
                    int r32 = this.sourceIdIndex + 1;
                    this.sourceIdIndex = r32;
                    if (r32 >= cacheKeys.size()) {
                        return false;
                    }
                ...
                while (!z && hasNextModelLoader()) {
                    ...
                    this.loadData = list.get(r1).buildLoadData(this.cacheFile, this.helper.getWidth(), this.helper.getHeight(), this.helper.getOptions());
    ...
    public void onDataReady(Object obj) {
        this.f93cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE, this.currentKey);
    }

    @Override // com.bumptech.glide.load.data.DataFetcher.DataCallback
    public void onLoadFailed(Exception exc) {
        this.f93cb.onDataFetcherFailed(this.currentKey, exc, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE);
    }
}
