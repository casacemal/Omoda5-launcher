...
public class GifDrawableTransformation implements Transformation<GifDrawable> {
    ...
    public Resource<GifDrawable> transform(Context context, Resource<GifDrawable> resource, int r7, int r8) {
        GifDrawable gifDrawable = resource.get();
        Resource<Bitmap> bitmapResource = new BitmapResource(gifDrawable.getFirstFrame(), Glide.get(context).getBitmapPool());
        Resource<Bitmap> resourceTransform = this.wrapped.transform(context, bitmapResource, r7, r8);
