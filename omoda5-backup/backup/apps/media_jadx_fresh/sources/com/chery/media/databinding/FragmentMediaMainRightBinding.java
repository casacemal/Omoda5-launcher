...
public final class FragmentMediaMainRightBinding implements ViewBinding {
    ...
    public static FragmentMediaMainRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentMediaMainRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_media_main_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentMediaMainRightBinding bind(View view) {
