...
public final class ActivityMediaBinding implements ViewBinding {
    ...
    private ActivityMediaBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ImageView imageView, FrameLayout frameLayout, MarqueeTextView marqueeTextView) {
    ...
    public static ActivityMediaBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.activity_media, viewGroup, false);
        if (z) {
            ...
            if (imageView != null) {
                ...
                if (frameLayout != null) {
                    ...
                    if (marqueeTextView != null) {
                        return new ActivityMediaBinding((ConstraintLayout) view, constraintLayout, imageView, frameLayout, marqueeTextView);
                    }
                }
            }
        }
