...
public final class PropertyPermissionMapping {
    ...
    private static final Permission VENDOR_PERMISION = Permission.m23of(Car.PERMISSION_VENDOR_EXTENSION);
    private final SparseArray<Permission> mPermissions = new SparseArray<>();

    private static boolean isVendorExtension(int r1) {
        return (r1 & 536870912) == 536870912;
    }
    ...
    public PropertyPermissionMapping() {
        ...
        map(Car.PERMISSION_CONTROL_CAR_CLIMATE, 356517120, 356517121, 358614274, 358614275, 320865540, 354419973, 354419974, 354419975, 354419976, 354419977, 354419978, 356517131, 339739916, 289408269, 289408270, 356517135, 354419984, 356582673, 354419986, 356517139, 560992257);
    ...
    public String getReadPermission(int r1) {
        Permission permission = getPermission(r1);
        if (permission == null) {
            return null;
        }
    ...
    public String getWritePermission(int r1) {
        Permission permission = getPermission(r1);
        if (permission == null) {
            return null;
        }
    ...
    private Permission getPermission(int r2) {
        return isVendorExtension(r2) ? VENDOR_PERMISION : this.mPermissions.get(r2);
    }

    private void map(String str, String str2, Integer... numArr) {
        map(Permission.m24of(str, str2), numArr);
    }

    private void map(String str, Integer... numArr) {
        map(Permission.m23of(str), numArr);
    }
    ...
    private static class Permission {
        ...
        /* renamed from: of */
        static Permission m24of(String str, String str2) {
            return new Permission(str, str2);
        }

        /* renamed from: of */
        static Permission m23of(String str) {
