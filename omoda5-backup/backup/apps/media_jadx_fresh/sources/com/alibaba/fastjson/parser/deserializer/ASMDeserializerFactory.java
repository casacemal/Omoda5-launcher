...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _setFlag(MethodVisitor methodVisitor, Context context, int r5) {
        String str = "_asm_flag_" + (r5 / 32);
        methodVisitor.visitVarInsn(21, context.var(str));
        methodVisitor.visitLdcInsn(Integer.valueOf(1 << r5));
        methodVisitor.visitInsn(128);
        methodVisitor.visitVarInsn(54, context.var(str));
    }

    private void _isFlag(MethodVisitor methodVisitor, Context context, int r4, Label label) {
        methodVisitor.visitVarInsn(21, context.var("_asm_flag_" + (r4 / 32)));
        methodVisitor.visitLdcInsn(Integer.valueOf(1 << r4));
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        int r22 = 0;
        while (r22 < length) {
            boolean z2 = r22 == length + (-1);
            int r12 = z2 ? 93 : 44;
            FieldInfo fieldInfo = fieldInfoArr2[r22];
            ...
            if (cls == Byte.TYPE || cls == Short.TYPE || cls == Integer.TYPE) {
                ...
                z = true;
                methodWriter.visitVarInsn(25, context.var("lexer"));
                methodWriter.visitVarInsn(16, r12);
                    ...
                    if (cls == String.class) {
                        ...
                        if (Collection.class.isAssignableFrom(cls)) {
                            ...
                            if (collectionItemClass == String.class) {
                                ...
                                int r32 = r242 == 0 ? 14 : 16;
                                methodWriter.visitLdcInsn(Integer.valueOf(r32));
                                ...
                                r2 = r242;
                                _newCollection(methodWriter, cls, r2, false);
                                methodWriter.visitInsn(89);
                                methodWriter.visitVarInsn(58, context.var(fieldInfo.name + "_asm"));
                                ...
                                methodWriter.visitVarInsn(25, 3);
                                c3 = 184;
                                methodWriter.visitMethodInsn(Opcodes.INVOKESTATIC, ASMUtils.type(JavaBeanDeserializer.class), "parseArray", "(Ljava/util/Collection;" + ASMUtils.desc((Class<?>) ObjectDeserializer.class) + ParamsPosition.f236L + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)V");
                            }
                            r16 = r2;
                            c2 = c3;
                            r17 = r20;
                            ...
                            methodWriter.visitVarInsn(25, 1);
                            methodWriter.visitVarInsn(25, 0);
                            methodWriter.visitLdcInsn(Integer.valueOf(r242));
                            ...
                            fieldInfoArr = fieldInfoArr3;
                            c2 = 184;
                            _deserObject(context, methodWriter, fieldInfo, cls, r16);
                            methodWriter.visitVarInsn(25, context.var("lexer"));
                            methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "token", "()I");
                            ...
                            methodWriter.visitVarInsn(25, context.var("lexer"));
                            if (!z3) {
                                methodWriter.visitLdcInsn(Integer.valueOf(r10));
                            } else {
                                methodWriter.visitLdcInsn(15);
                            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:135:0x0e50  */
    /* JADX WARN: Removed duplicated region for block: B:136:0x0e81  */
    /*
    ...
    */
    ...
    private void _batchSet(Context context, MethodVisitor methodVisitor, boolean z) {
        ...
        for (int r1 = 0; r1 < length; r1++) {
            Label label = new Label();
            if (z) {
                _isFlag(methodVisitor, context, r1, label);
            }
            _loadAndSet(context, methodVisitor, context.fieldInfoList[r1]);
            if (z) {
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int r31) {
        String str;
        String str2;
        String str3;
        int r4;
        ...
        _setFlag(methodVisitor, context, r31);
        Label label3 = new Label();
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "token", "()I");
        ...
        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "nextToken", "(I)V");
        _newCollection(methodVisitor, cls, r31, true);
        ...
        methodVisitor.visitJumpInsn(Opcodes.IF_ICMPNE, label);
        _newCollection(methodVisitor, cls, r31, false);
        ...
        if (zIsPrimitive2) {
            methodVisitor.visitVarInsn(25, context.var("lexer"));
            methodVisitor.visitVarInsn(21, context.var("fastMatchToken"));
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, str4, str5);
            r4 = Opcodes.GOTO;
        } else {
            _quickNextToken(context, methodVisitor, 12);
            r4 = Opcodes.GOTO;
        }
        methodVisitor.visitJumpInsn(r4, label7);
    ...
    private void _quickNextToken(Context context, MethodVisitor methodVisitor, int r10) {
        Label label = new Label();
        Label label2 = new Label();
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        ...
        methodVisitor.visitInsn(87);
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitLdcInsn(Integer.valueOf(r10));
    ...
    private void _newCollection(MethodVisitor methodVisitor, Class<?> cls, int r8, boolean z) {
        if (cls.isAssignableFrom(ArrayList.class) && !z) {
            ...
            methodVisitor.visitVarInsn(25, 0);
            methodVisitor.visitLdcInsn(Integer.valueOf(r8));
    ...
    private void _deserialze_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, int r21) {
        Label label2 = new Label();
        Label label3 = new Label();
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitVarInsn(25, 0);
    ...
    private void _deserObject(Context context, MethodVisitor methodVisitor, FieldInfo fieldInfo, Class<?> cls, int r22) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                ...
                methodVisitor.visitVarInsn(25, 0);
                methodVisitor.visitLdcInsn(Integer.valueOf(r22));
                methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "getFieldType", "(I)Ljava/lang/reflect/Type;");
            }
            methodVisitor.visitLdcInsn(fieldInfo.name);
    ...
    static class Context {
        ...
        public Context(String str, ParserConfig parserConfig, JavaBeanInfo javaBeanInfo, int r4) {
            this.variantIndex = -1;
            this.className = str;
            this.clazz = javaBeanInfo.clazz;
            this.variantIndex = r4;
        ...
        public int var(String str, int r4) {
        ...
        public int var(String str) {
            if (this.variants.get(str) == null) {
                ...
                int r1 = this.variantIndex;
                this.variantIndex = r1 + 1;
    ...
    private void _init(ClassWriter classWriter, Context context) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            new FieldWriter(classWriter, 1, context.fieldInfoList[r2].name + "_asm_prefix__", "[C").visitEnd();
        }
        int length2 = context.fieldInfoList.length;
        for (int r22 = 0; r22 < length2; r22++) {
            FieldInfo fieldInfo = context.fieldInfoList[r22];
            Class<?> cls = fieldInfo.fieldClass;
            if (!cls.isPrimitive()) {
                if (Collection.class.isAssignableFrom(cls)) {
        ...
        for (int r23 = 0; r23 < length3; r23++) {
            FieldInfo fieldInfo2 = context.fieldInfoList[r23];
            methodWriter.visitVarInsn(25, 0);
