    ...
    public static Object[] parseInvocationArguments(String str, MethodLocator methodLocator) {
        ...
        if (r4 != 12) {
            ...
            if (current == ']') {
                ...
                while (r5 < strArrScanFieldStringArray.length) {
                    Type type = genericParameterTypes[r5];
                    String str2 = strArrScanFieldStringArray[r5];
                    if (type != String.class) {
                        objArr2[r5] = TypeUtils.cast(str2, type, defaultJSONParser.getConfig());
                    } else {
                        objArr2[r5] = str2;
                    }
                    r5++;
        ...
        if (methodFindMethod == null) {
            ...
            while (r5 < genericParameterTypes2.length) {
                objArr3[r5] = jSONArray.getObject(r5, genericParameterTypes2[r5]);
                r5++;
            }
            return objArr3;
        }
