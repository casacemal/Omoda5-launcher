...
public class ObjectArrayCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public final void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r22) throws IOException {
        ...
        try {
            ...
            if (serializeWriter.isEnabled(SerializerFeature.PrettyFormat)) {
                ...
                for (int r2 = 0; r2 < length; r2++) {
                    ...
                    jSONSerializer.write(objArr[r2]);
                }
            ...
            for (int r15 = 0; r15 < r10; r15++) {
                Object obj3 = objArr[r15];
                if (obj3 == null) {
                    ...
                    if (jSONSerializer.containsReference(obj3)) {
                        ...
                        if (cls2 == cls) {
                            objectWriter.write(jSONSerializer, obj3, Integer.valueOf(r15), null, 0);
                        } else {
            ...
            if (obj4 == null) {
                ...
                if (jSONSerializer.containsReference(obj4)) {
                    ...
                    jSONSerializer.writeWithFieldName(obj4, Integer.valueOf(r10));
                }
                serializeWriter.append(']');
            }
        } finally {
            ...
            if (genericComponentType instanceof TypeVariable) {
                ...
                if (type4 instanceof ParameterizedType) {
                    ...
                    if (rawType instanceof Class) {
                        ...
                        for (int r4 = 0; r4 < typeParameters.length; r4++) {
                            if (typeParameters[r4].getName().equals(typeVariable.getName())) {
                                type3 = parameterizedType.getActualTypeArguments()[r4];
                            }
                        }
                    }
