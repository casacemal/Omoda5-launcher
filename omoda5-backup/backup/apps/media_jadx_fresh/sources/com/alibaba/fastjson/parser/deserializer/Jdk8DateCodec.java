...
public class Jdk8DateCodec extends ContextObjectDeserializer implements ObjectSerializer, ContextObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj, String str, int r13) {
        ...
        if (jSONLexer.token() == 4) {
            ...
            if (type == LocalTime.class) {
                ...
                for (int r8 = 0; r8 < strStringVal.length(); r8++) {
                    char cCharAt = strStringVal.charAt(r8);
            ...
            for (int r82 = 0; r82 < strStringVal.length(); r82++) {
                char cCharAt2 = strStringVal.charAt(r82);
        ...
        if (jSONLexer.token() == 2) {
            ...
            if ("unixtime".equals(str)) {
                ...
                int r0 = (int) (jLongValue / 10000000000L);
                int r11 = (int) ((jLongValue / 100000000) % 100);
                int r12 = (int) ((jLongValue / 1000000) % 100);
                int r3 = (int) ((jLongValue / 10000) % 100);
                int r4 = (int) ((jLongValue / 100) % 100);
                int r5 = (int) (jLongValue % 100);
                if (type == LocalDateTime.class) {
                    return (T) LocalDateTime.of(r0, r11, r12, r3, r4, r5);
                }
            }
            if (type == LocalDateTime.class) {
        ...
        if (dateTimeFormatter == null) {
            ...
            if (str.length() == 10) {
                ...
                if (cCharAt5 == '/' && cCharAt7 == '/') {
                    int r9 = ((cCharAt6 - '0') * 10) + (cCharAt - '0');
                ...
                if (cCharAt4 == ':' && cCharAt5 == ':') {
                    if (cCharAt == '-' && cCharAt2 == '-') {
                        ...
                        if (cCharAt8 == '/' && cCharAt10 == '/') {
                            int r11 = ((cCharAt9 - '0') * 10) + (cCharAt - '0');
                            if (((cCharAt6 - '0') * 10) + (cCharAt7 - '0') > 12) {
                                dateTimeFormatter3 = formatter_dt19_eur;
                            } else if (r11 > 12) {
                                dateTimeFormatter3 = formatter_dt19_us;
                            } else {
                                String country = Locale.getDefault().getCountry();
                                if (country.equals("US")) {
                                    dateTimeFormatter3 = formatter_dt19_us;
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r7) throws IOException {
        ...
        if (type == LocalDateTime.class) {
            ...
            if (dateFormatPattern == null) {
                if ((mask & r7) != 0 || jSONSerializer.isEnabled(SerializerFeature.UseISO8601DateFormat) || (nano = localDateTime.getNano()) == 0) {
