...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    Node<K, V> find(K k, boolean z) {
        ...
        int r6 = secondaryHash(k.hashCode());
        int length = (nodeArr.length - 1) & r6;
        Node<K, V> node2 = nodeArr[length];
        if (node2 != null) {
            Comparable comparable = comparator == NATURAL_ORDER ? (Comparable) k : null;
            while (true) {
                if (comparable != null) {
                    r7 = comparable.compareTo(node2.key);
                } else {
                    r7 = comparator.compare(k, node2.key);
                }
                if (r7 == 0) {
                    return node2;
                }
                Node<K, V> node3 = r7 < 0 ? node2.left : node2.right;
                if (node3 == null) {
                    break;
                }
                node2 = node3;
        ...
        if (node4 == null) {
            ...
            node = new Node<>(node4, k, r6, node5, node5.prev);
            nodeArr[length] = node;
        } else {
            node = new Node<>(node4, k, r6, node5, node5.prev);
            if (r11 < 0) {
    ...
    void removeInternal(Node<K, V> node, boolean z) {
        ...
        if (node2 != null && node3 != null) {
            ...
            nodeLast.height = Math.max(r2, r3) + 1;
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> node2) {
        ...
        int r3 = node.hash;
        this.table[r3 & (r2.length - 1)] = node2;
    }
