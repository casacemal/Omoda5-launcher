...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView, AttributeSet attributeSet, int r6, int r7) {
        ...
        TypedArray typedArrayObtainStyledAttributes = materialCardView.getContext().obtainStyledAttributes(attributeSet, C1199R.styleable.CardView, r6, C1199R.style.CardView);
        if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.CardView_cardCornerRadius)) {
            builder.setAllCornerSizes(typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(builder.build());
        Resources resources = materialCardView.getResources();
        this.checkedIconMargin = resources.getDimensionPixelSize(C1199R.dimen.mtrl_card_checked_icon_margin);
        this.checkedIconSize = resources.getDimensionPixelSize(C1199R.dimen.mtrl_card_checked_icon_size);
        typedArrayObtainStyledAttributes.recycle();
    }

    void loadFromAttributes(TypedArray typedArray) {
        ColorStateList colorStateList = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1199R.styleable.MaterialCardView_strokeColor);
        this.strokeColor = colorStateList;
        if (colorStateList == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C1199R.styleable.MaterialCardView_strokeWidth, 0);
        boolean z = typedArray.getBoolean(C1199R.styleable.MaterialCardView_android_checkable, false);
        this.checkable = z;
        this.materialCardView.setLongClickable(z);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1199R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), typedArray, C1199R.styleable.MaterialCardView_checkedIcon));
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1199R.styleable.MaterialCardView_rippleColor);
        this.rippleColor = colorStateList2;
        if (colorStateList2 == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C1199R.attr.colorControlHighlight));
        }
        ColorStateList colorStateList3 = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C1199R.styleable.MaterialCardView_cardForegroundColor);
    ...
    void updateContentPadding() {
        int r0 = (int) ((shouldAddCornerPaddingInsideCardBackground() || shouldAddCornerPaddingOutsideCardBackground() ? calculateActualCornerPadding() : 0.0f) - getParentCardViewCalculatedCornerPadding());
        this.materialCardView.setAncestorContentPadding(this.userContentPadding.left + r0, this.userContentPadding.top + r0, this.userContentPadding.right + r0, this.userContentPadding.bottom + r0);
    }
    ...
    void setCheckedIcon(Drawable drawable) {
        ...
        if (this.clickableForegroundDrawable != null) {
            this.clickableForegroundDrawable.setDrawableByLayerId(C1199R.id.mtrl_card_checked_layer_id, createCheckedIconLayer());
        }
    }

    void onMeasure(int r9, int r10) {
        int r4;
        int r6;
        if (this.clickableForegroundDrawable != null) {
    ...
    private Drawable insetDrawable(Drawable drawable) {
        ...
        if ((Build.VERSION.SDK_INT < 21) || this.materialCardView.getUseCompatPadding()) {
            int r1 = (int) Math.ceil(calculateVerticalBackgroundPadding());
            r7 = (int) Math.ceil(calculateHorizontalBackgroundPadding());
            r8 = r1;
        } else {
            r7 = 0;
            r8 = 0;
        }
        return new InsetDrawable(drawable, r7, r8, r7, r8) { // from class: com.google.android.material.card.MaterialCardViewHelper.1
