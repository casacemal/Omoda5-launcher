...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C1199R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C1199R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int r10) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C1199R.styleable.MaterialCardView, r10, DEF_STYLE_RES, new int[0]);
        MaterialCardViewHelper materialCardViewHelper = new MaterialCardViewHelper(this, attributeSet, r10, DEF_STYLE_RES);
    ...
    public void setStrokeColor(int r1) {
        this.cardViewHelper.setStrokeColor(ColorStateList.valueOf(r1));
    }
    ...
    public void setStrokeWidth(int r1) {
        this.cardViewHelper.setStrokeWidth(r1);
    }
    ...
    @Override // androidx.cardview.widget.CardView
    public void setContentPadding(int r1, int r2, int r3, int r4) {
        this.cardViewHelper.setUserContentPadding(r1, r2, r3, r4);
    }
    ...
    public void setCardBackgroundColor(int r1) {
        this.cardViewHelper.setCardBackgroundColor(ColorStateList.valueOf(r1));
    }
    ...
    protected int[] onCreateDrawableState(int r2) {
        ...
        if (isDragged()) {
            mergeDrawableStates(r22, DRAGGED_STATE_SET);
        }
        return r22;
    }
    ...
    public void setRippleColorResource(int r2) {
        this.cardViewHelper.setRippleColor(AppCompatResources.getColorStateList(getContext(), r2));
    }
    ...
    public void setCheckedIconResource(int r2) {
        this.cardViewHelper.setCheckedIcon(AppCompatResources.getDrawable(getContext(), r2));
    }
