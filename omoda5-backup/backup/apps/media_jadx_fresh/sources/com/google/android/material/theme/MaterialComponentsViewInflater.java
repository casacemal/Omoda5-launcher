...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    protected boolean shouldInflateAppCompatButton(Context context, AttributeSet attributeSet) {
        ...
        int r4 = floatingToolbarItemBackgroundResId;
        if (r4 != 0 && r4 != -1) {
            for (int r42 = 0; r42 < attributeSet.getAttributeCount(); r42++) {
                if (attributeSet.getAttributeNameResource(r42) == 16842964) {
                    if (floatingToolbarItemBackgroundResId == attributeSet.getAttributeListValue(r42, null, 0)) {
                        return true;
                    }
                }
            }
