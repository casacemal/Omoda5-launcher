...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C1199R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C1199R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(Context context) {
            this.alpha = 255;
            this.number = -1;
            this.badgeTextColor = new TextAppearance(context, C1199R.style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C1199R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C1199R.plurals.mtrl_badge_content_description;
        }
    ...
    public static BadgeDrawable createFromResource(Context context, int r3) throws XmlPullParserException, Resources.NotFoundException, IOException {
        AttributeSet drawableXml = DrawableUtils.parseDrawableXml(context, r3, "badge");
    ...
    private static BadgeDrawable createFromAttributes(Context context, AttributeSet attributeSet, int r3, int r4) throws Resources.NotFoundException {
        BadgeDrawable badgeDrawable = new BadgeDrawable(context);
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, int r10, int r11) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.Badge, r10, r11, new int[0]);
        setMaxCharacterCount(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.Badge_maxCharacterCount, 4));
        if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.Badge_number)) {
            setNumber(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, C1199R.styleable.Badge_backgroundColor));
        if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, C1199R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.Badge_badgeGravity, TOP_END));
    ...
    private BadgeDrawable(Context context) throws Resources.NotFoundException {
        ...
        this.badgeRadius = resources.getDimensionPixelSize(C1199R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = resources.getDimensionPixelSize(C1199R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = resources.getDimensionPixelSize(C1199R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper;
        textDrawableHelper.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C1199R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    public void setNumber(int r2) throws Resources.NotFoundException {
        int r22 = Math.max(0, r2);
        if (this.savedState.number != r22) {
            this.savedState.number = r22;
    ...
    public void setMaxCharacterCount(int r2) throws Resources.NotFoundException {
    ...
    public void setContentDescriptionQuantityStringsResource(int r1) {
        this.savedState.contentDescriptionQuantityStrings = r1;
    }
    ...
    private void setTextAppearanceResource(int r3) throws Resources.NotFoundException {
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) throws Resources.NotFoundException {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C1199R.dimen.mtrl_badge_text_horizontal_edge_offset : C1199R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        Context context = this.contextRef.get();
        return context == null ? "" : context.getString(C1199R.string.mtrl_exceed_max_badge_number_suffix, Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
