...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.tabStyle);
    }

    public TabLayout(Context context, AttributeSet attributeSet, int r14) throws Resources.NotFoundException {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.TabLayout, r14, C1199R.style.Widget_Design_TabLayout, C1199R.styleable.TabLayout_tabTextAppearance);
        ...
        this.slidingTabIndicator.setSelectedIndicatorHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabIndicatorHeight, -1));
        this.slidingTabIndicator.setSelectedIndicatorColor(typedArrayObtainStyledAttributes.getColor(C1199R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, typedArrayObtainStyledAttributes, C1199R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.TabLayout_tabTextAppearance, C1199R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(resourceId, C0105R.styleable.TextAppearance);
        try {
            this.tabTextSize = typedArrayObtainStyledAttributes2.getDimensionPixelSize(C0105R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes2, C0105R.styleable.TextAppearance_android_textColor);
            typedArrayObtainStyledAttributes2.recycle();
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1199R.styleable.TabLayout_tabTextColor);
            }
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(C1199R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1199R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1199R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.TabLayout_tabIndicatorAnimationDuration, ANIMATION_DURATION);
            this.requestedTabMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.TabLayout_tabContentStart, 0);
            this.mode = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.TabLayout_tabUnboundedRipple, false);
            typedArrayObtainStyledAttributes.recycle();
            Resources resources = getResources();
            this.tabTextMultiLineSize = resources.getDimensionPixelSize(C1199R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = resources.getDimensionPixelSize(C1199R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            typedArrayObtainStyledAttributes2.recycle();
            throw th;
    ...
    public void setSelectedTabIndicatorColor(int r1) {
        this.slidingTabIndicator.setSelectedIndicatorColor(r1);
    }

    @Deprecated
    public void setSelectedTabIndicatorHeight(int r1) {
        this.slidingTabIndicator.setSelectedIndicatorHeight(r1);
    }
    ...
    public void setScrollPosition(int r3, float f, boolean z, boolean z2) {
        int r0 = Math.round(r3 + f);
        if (r0 < 0 || r0 >= this.slidingTabIndicator.getChildCount()) {
            return;
        }
        if (z2) {
    ...
    */
    ...
    private void animateToTab(int r7) {
        ...
        int r2 = calculateScrollXForTab(r7, 0.0f);
        if (scrollX != r2) {
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onMeasure(int r8, int r9) {
            ...
            if (this.textView != null) {
                ...
                if (f != textSize || (maxLines >= 0 && r1 != maxLines)) {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C1199R.layout.design_layout_tab_icon, (ViewGroup) frameLayoutCreatePreApi18BadgeAnchorRoot, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C1199R.layout.design_layout_tab_text, (ViewGroup) frameLayoutCreatePreApi18BadgeAnchorRoot, false);
        ...
        private void updateTextAndIcon(TextView textView, ImageView imageView) {
            ...
            if (imageView != null) {
                ...
                int r2 = (z && imageView.getVisibility() == 0) ? (int) ViewUtils.dpToPx(getContext(), 8) : 0;
                if (TabLayout.this.inlineLabel) {
                    if (r2 != MarginLayoutParamsCompat.getMarginEnd(marginLayoutParams)) {
                        MarginLayoutParamsCompat.setMarginEnd(marginLayoutParams, r2);
        ...
        public int getContentWidth() {
            ...
            for (int r3 = 0; r3 < 3; r3++) {
                ...
                if (view != null && view.getVisibility() == 0) {
                    r2 = z ? Math.min(r2, view.getLeft()) : view.getLeft();
                    r8 = z ? Math.max(r8, view.getRight()) : view.getRight();
                    z = true;
                }
            }
            return r8 - r2;
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        private void calculateTabViewContentBounds(TabView tabView, RectF rectF) {
            ...
            int r2 = (int) ViewUtils.dpToPx(getContext(), 24);
            if (contentWidth < r2) {
                contentWidth = r2;
            }
