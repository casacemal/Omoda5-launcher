...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C1199R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(ShapePath shapePath, Matrix matrix, int r3) {
                MaterialShapeDrawable.this.cornerShadowOperation[r3] = shapePath.createShadowCompatOperation(matrix);
            }

            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(ShapePath shapePath, Matrix matrix, int r3) {
                MaterialShapeDrawable.this.edgeShadowOperation[r3] = shapePath.createShadowCompatOperation(matrix);
            }
        };
    }
    ...
    public void setStrokeTint(int r1) {
        setStrokeTint(ColorStateList.valueOf(r1));
    }

    public void setStroke(float f, int r2) {
        setStrokeWidth(f);
        setStrokeColor(ColorStateList.valueOf(r2));
    }
    ...
    public void setAlpha(int r2) {
        if (this.drawableState.alpha != r2) {
            this.drawableState.alpha = r2;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public boolean isPointInTransparentRegion(int r1, int r2) {
        return getTransparentRegion().contains(r1, r2);
    }
    ...
    public void setPadding(int r3, int r4, int r5, int r6) {
        ...
        this.drawableState.padding.set(r3, r4, r5, r6);
        this.padding = this.drawableState.padding;
        invalidateSelf();
    }

    public void setShadowCompatibilityMode(int r2) {
        if (this.drawableState.shadowCompatMode != r2) {
            this.drawableState.shadowCompatMode = r2;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    private int compositeElevationOverlayIfNeeded(int r3) {
        return this.drawableState.elevationOverlayProvider != null ? this.drawableState.elevationOverlayProvider.compositeOverlayIfNeeded(r3, getZ() + getParentAbsoluteElevation()) : r3;
    }
    ...
    public void setShadowVerticalOffset(int r2) {
        if (this.drawableState.shadowCompatOffset != r2) {
            this.drawableState.shadowCompatOffset = r2;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowCompatRotation(int r2) {
        if (this.drawableState.shadowCompatRotation != r2) {
            this.drawableState.shadowCompatRotation = r2;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowRadius(int r1) {
        this.drawableState.shadowCompatRadius = r1;
    }
    ...
    public void setShadowColor(int r2) {
        this.shadowRenderer.setShadowColor(r2);
    ...
    public void draw(Canvas canvas) {
        ...
        if (hasCompatShadow()) {
            ...
            int r2 = (int) (this.pathBounds.width() - getBounds().width());
            int r3 = (int) (this.pathBounds.height() - getBounds().height());
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(((int) this.pathBounds.width()) + (this.drawableState.shadowCompatRadius * 2) + r2, ((int) this.pathBounds.height()) + (this.drawableState.shadowCompatRadius * 2) + r3, Bitmap.Config.ARGB_8888);
            Canvas canvas2 = new Canvas(bitmapCreateBitmap);
            float f = (getBounds().left - this.drawableState.shadowCompatRadius) - r2;
            float f2 = (getBounds().top - this.drawableState.shadowCompatRadius) - r3;
    ...
    private void drawCompatShadow(Canvas canvas) {
        ...
        for (int r0 = 0; r0 < 4; r0++) {
            this.cornerShadowOperation[r0].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[r0].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
        int shadowOffsetX = getShadowOffsetX();
        int shadowOffsetY = getShadowOffsetY();
        canvas.translate(-shadowOffsetX, -shadowOffsetY);
    ...
    @Deprecated
    public void getPathForSize(int r3, int r4, Path path) {
        calculatePathForSize(new RectF(0.0f, 0.0f, r3, r4), path);
    }
    ...
    private PorterDuffColorFilter calculatePaintColorTintFilter(Paint paint, boolean z) {
        int color;
        int r0;
        if (!z || (r0 = compositeElevationOverlayIfNeeded((color = paint.getColor()))) == color) {
            return null;
        }
        return new PorterDuffColorFilter(r0, PorterDuff.Mode.SRC_IN);
    }
    ...
    protected boolean onStateChange(int[] r2) {
        boolean z = updateColorsForState(r2) || updateTintFilter();
        if (z) {
            invalidateSelf();
        }
        return z;
    ...
    private boolean updateColorsForState(int[] r5) {
        ...
        int color2;
        int colorForState2;
        if (this.drawableState.fillColor == null || color2 == (colorForState2 = this.drawableState.fillColor.getColorForState(r5, (color2 = this.fillPaint.getColor())))) {
            z = false;
        } else {
            this.fillPaint.setColor(colorForState2);
            z = true;
        }
        if (this.drawableState.strokeColor == null || color == (colorForState = this.drawableState.strokeColor.getColorForState(r5, (color = this.strokePaint.getColor())))) {
            return z;
        }
