...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.chipStyle);
    }

    public Chip(Context context, AttributeSet attributeSet, int r11) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, r11, C1199R.style.Widget_MaterialComponents_Chip_Action);
        initMinTouchTarget(context, attributeSet, r11);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.Chip, r11, C1199R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        if (Build.VERSION.SDK_INT < 23) {
            setTextColor(MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1199R.styleable.Chip_android_textColor));
        }
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.Chip_shapeAppearance);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int r10) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.Chip, r10, C1199R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        this.ensureMinTouchTargetSize = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ParamsResValue.MusicActiveStatus.BACKGROUND) != null) {
    ...
    protected int[] onCreateDrawableState(int r2) {
        ...
        if (isChecked()) {
            mergeDrawableStates(r22, SELECTED_STATE);
        }
        if (isCheckable()) {
            mergeDrawableStates(r22, CHECKABLE_STATE_SET);
        }
        return r22;
    }
    ...
    */
    ...
    protected void onFocusChanged(boolean z, int r2, Rect rect) {
        ...
        this.touchHelper.onFocusChanged(z, r2, rect);
    }
    ...
    public PointerIcon onResolvePointerIcon(MotionEvent motionEvent, int r3) {
    ...
    private class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        @Override // androidx.customview.widget.ExploreByTouchHelper
        protected void onVirtualViewKeyboardFocusChanged(int r2, boolean z) {
            if (r2 == 1) {
        ...
        @Override // androidx.customview.widget.ExploreByTouchHelper
        protected void onPopulateNodeForVirtualView(int r7, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (r7 == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int r3 = C1199R.string.mtrl_chip_close_icon_content_description;
                    Object[] objArr = new Object[1];
                    objArr[0] = TextUtils.isEmpty(text) ? "" : text;
                    accessibilityNodeInfoCompat.setContentDescription(context.getString(r3, objArr).trim());
                }
    ...
    public void setChipBackgroundColorResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipBackgroundColorResource(r1);
        }
    }
    ...
    public void setChipMinHeightResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipMinHeightResource(r1);
        }
    }
    ...
    @Deprecated
    public void setChipCornerRadiusResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipCornerRadiusResource(r1);
        }
    }
    ...
    public void setChipStrokeColorResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStrokeColorResource(r1);
        }
    }
    ...
    public void setChipStrokeWidthResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStrokeWidthResource(r1);
        }
    }
    ...
    public void setRippleColorResource(int r2) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setRippleColorResource(r2);
    ...
    public void setTextAppearance(Context context, int r2) {
        ...
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextAppearanceResource(r2);
        }
        updateTextPaintDrawState();
    }
    ...
    public void setChipIconVisible(int r1) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconVisible(r1);
        }
    }
    ...
    public void setChipIconResource(int r1) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconResource(r1);
        }
    }
    ...
    public void setChipIconTintResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconTintResource(r1);
        }
    }
    ...
    public void setChipIconSizeResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipIconSizeResource(r1);
        }
    }
    ...
    public void setCloseIconResource(int r2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconResource(r2);
        }
        updateAccessibilityDelegate();
    }
    ...
    public void setCloseIconTintResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconTintResource(r1);
        }
    }
    ...
    public void setCloseIconSizeResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconSizeResource(r1);
        }
    }
    ...
    public void setCheckableResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckableResource(r1);
        }
    }
    ...
    public void setCheckedIconVisible(int r1) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckedIconVisible(r1);
        }
    }
    ...
    @Deprecated
    public void setCheckedIconEnabledResource(int r1) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public void setCheckedIconResource(int r1) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckedIconResource(r1);
        }
    }
    ...
    public void setShowMotionSpecResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setShowMotionSpecResource(r1);
        }
    }
    ...
    public void setHideMotionSpecResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setHideMotionSpecResource(r1);
        }
    }
    ...
    public void setChipStartPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipStartPaddingResource(r1);
        }
    }
    ...
    public void setIconStartPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setIconStartPaddingResource(r1);
        }
    }
    ...
    public void setIconEndPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setIconEndPaddingResource(r1);
        }
    }
    ...
    public void setTextStartPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextStartPaddingResource(r1);
        }
    }
    ...
    public void setTextEndPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextEndPaddingResource(r1);
        }
    }
    ...
    public void setCloseIconStartPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconStartPaddingResource(r1);
        }
    }
    ...
    public void setCloseIconEndPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCloseIconEndPaddingResource(r1);
        }
    }
    ...
    public void setChipEndPaddingResource(int r1) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setChipEndPaddingResource(r1);
        }
    }
    ...
    public boolean ensureAccessibleTouchTarget(int r6) {
        ...
        int r0 = Math.max(0, r6 - this.chipDrawable.getIntrinsicHeight());
        int r2 = Math.max(0, r6 - this.chipDrawable.getIntrinsicWidth());
        if (r2 <= 0 && r0 <= 0) {
            removeBackgroundInset();
            return false;
        }
        ...
        insetChipBackgroundDrawable(r22, r1, r22, r1);
        return true;
    }
    ...
    private void insetChipBackgroundDrawable(int r8, int r9, int r10, int r11) {
        this.insetBackgroundDrawable = new InsetDrawable((Drawable) this.chipDrawable, r8, r9, r10, r11);
    }
}
