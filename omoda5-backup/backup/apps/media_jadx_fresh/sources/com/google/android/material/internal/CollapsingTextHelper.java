...
public final class CollapsingTextHelper {
    ...
    public void setExpandedBounds(int r2, int r3, int r4, int r5) {
        if (rectEquals(this.expandedBounds, r2, r3, r4, r5)) {
            return;
        }
        this.expandedBounds.set(r2, r3, r4, r5);
    ...
    public void setCollapsedBounds(int r2, int r3, int r4, int r5) {
        if (rectEquals(this.collapsedBounds, r2, r3, r4, r5)) {
            return;
        }
        this.collapsedBounds.set(r2, r3, r4, r5);
        this.boundsChanged = true;
        onBoundsChanged();
    }
    ...
    public void setExpandedTextGravity(int r2) {
        if (this.expandedTextGravity != r2) {
            this.expandedTextGravity = r2;
            recalculate();
        }
    }
    ...
    public void setCollapsedTextGravity(int r2) {
        if (this.collapsedTextGravity != r2) {
            this.collapsedTextGravity = r2;
            recalculate();
        }
    }
    ...
    public void setCollapsedTextAppearance(int r4) {
        TextAppearance textAppearance = new TextAppearance(this.view.getContext(), r4);
    ...
    private void calculateBaseOffsets() {
        ...
        int r4 = absoluteGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (r4 == 1) {
        ...
        int r1 = absoluteGravity2 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (r1 == 1) {
    ...
    private void ensureExpandedTexture() {
        ...
        CharSequence charSequence = this.textToDraw;
        int r0 = Math.round(textPaint.measureText(charSequence, 0, charSequence.length()));
        int r1 = Math.round(this.textureDescent - this.textureAscent);
        if (r0 <= 0 || r1 <= 0) {
            return;
        }
        this.expandedTitleTexture = Bitmap.createBitmap(r0, r1, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.expandedTitleTexture);
        CharSequence charSequence2 = this.textToDraw;
        canvas.drawText(charSequence2, 0, charSequence2.length(), 0.0f, r1 - this.textPaint.descent(), this.textPaint);
    ...
    private static int blendColors(int r5, int r6, float f) {
        float f2 = 1.0f - f;
    ...
    private static boolean rectEquals(Rect rect, int r2, int r3, int r4, int r5) {
