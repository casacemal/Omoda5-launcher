...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() throws Resources.NotFoundException {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C1199R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C1199R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1199R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C1199R.drawable.mtrl_dropdown_arrow : C1199R.drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1199R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1199R.attr.colorControlHighlight);
        int[][] r4 = {new int[]{R.attr.state_pressed}, new int[0]};
        if (boxBackgroundMode == 2) {
            addRippleEffectOnOutlinedLayout(autoCompleteTextView, color, r4, boxBackground);
        } else if (boxBackgroundMode == 1) {
            addRippleEffectOnFilledLayout(autoCompleteTextView, color, r4, boxBackground);
        }
    }

    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int r8, int[][] r9, MaterialShapeDrawable materialShapeDrawable) {
        LayerDrawable layerDrawable;
        int color = MaterialColors.getColor(autoCompleteTextView, C1199R.attr.colorSurface);
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        int r82 = MaterialColors.layer(r8, color, 0.1f);
        materialShapeDrawable2.setFillColor(new ColorStateList(r9, new int[]{r82, 0}));
        if (IS_LOLLIPOP) {
            materialShapeDrawable2.setTint(color);
            ColorStateList colorStateList = new ColorStateList(r9, new int[]{r82, color});
    ...
    private void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int r6, int[][] r7, MaterialShapeDrawable materialShapeDrawable) {
        int boxBackgroundColor = this.textInputLayout.getBoxBackgroundColor();
        int[] r1 = {MaterialColors.layer(r6, boxBackgroundColor, 0.1f), boxBackgroundColor};
        if (IS_LOLLIPOP) {
            ViewCompat.setBackground(autoCompleteTextView, new RippleDrawable(new ColorStateList(r7, r1), materialShapeDrawable, materialShapeDrawable));
            return;
        }
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        materialShapeDrawable2.setFillColor(new ColorStateList(r7, r1));
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f, float f2, float f3, int r5) {
        ...
        materialShapeDrawableCreateWithElevationOverlay.setPadding(0, r5, 0, r5);
    ...
    private ValueAnimator getAlphaAnimator(int r3, float... fArr) {
