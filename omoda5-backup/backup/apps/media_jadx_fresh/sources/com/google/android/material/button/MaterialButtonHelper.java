...
class MaterialButtonHelper {
    ...
    void loadFromAttributes(TypedArray typedArray) {
        this.insetLeft = typedArray.getDimensionPixelOffset(C1199R.styleable.MaterialButton_android_insetLeft, 0);
        this.insetRight = typedArray.getDimensionPixelOffset(C1199R.styleable.MaterialButton_android_insetRight, 0);
        this.insetTop = typedArray.getDimensionPixelOffset(C1199R.styleable.MaterialButton_android_insetTop, 0);
        this.insetBottom = typedArray.getDimensionPixelOffset(C1199R.styleable.MaterialButton_android_insetBottom, 0);
        if (typedArray.hasValue(C1199R.styleable.MaterialButton_cornerRadius)) {
            int dimensionPixelSize = typedArray.getDimensionPixelSize(C1199R.styleable.MaterialButton_cornerRadius, -1);
            this.cornerRadius = dimensionPixelSize;
            setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize(dimensionPixelSize));
            this.cornerRadiusSet = true;
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C1199R.styleable.MaterialButton_strokeWidth, 0);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArray.getInt(C1199R.styleable.MaterialButton_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.backgroundTint = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1199R.styleable.MaterialButton_backgroundTint);
        this.strokeColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1199R.styleable.MaterialButton_strokeColor);
        this.rippleColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1199R.styleable.MaterialButton_rippleColor);
        this.checkable = typedArray.getBoolean(C1199R.styleable.MaterialButton_android_checkable, false);
        int dimensionPixelSize2 = typedArray.getDimensionPixelSize(C1199R.styleable.MaterialButton_elevation, 0);
    ...
    private Drawable createBackground() {
        ...
        materialShapeDrawable2.setStroke(this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, C1199R.attr.colorSurface) : 0);
        if (IS_LOLLIPOP) {
    ...
    void updateMaskBounds(int r5, int r6) {
        ...
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, r6 - this.insetRight, r5 - this.insetBottom);
        }
    }

    void setBackgroundColor(int r2) {
        if (getMaterialShapeDrawable() != null) {
            getMaterialShapeDrawable().setTint(r2);
        }
    }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                surfaceColorStrokeDrawable.setStroke(this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, C1199R.attr.colorSurface) : 0);
            }
        }
    }

    void setCornerRadius(int r2) {
        if (this.cornerRadiusSet && this.cornerRadius == r2) {
            return;
        }
        this.cornerRadius = r2;
        this.cornerRadiusSet = true;
        setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize(r2));
    }
