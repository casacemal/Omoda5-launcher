...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C1199R.dimen.design_navigation_separator_vertical_padding);
    }

    @Override // androidx.appcompat.view.menu.MenuPresenter
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C1199R.layout.design_navigation_menu, viewGroup, false);
            ...
            int r4 = this.overScrollMode;
            if (r4 != -1) {
                this.menuView.setOverScrollMode(r4);
            }
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C1199R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public View inflateHeaderView(int r4) {
        View viewInflate = this.layoutInflater.inflate(r4, (ViewGroup) this.headerLayout, false);
    ...
    public View getHeaderView(int r1) {
        return this.headerLayout.getChildAt(r1);
    }
    ...
    public void setItemIconPadding(int r1) {
        this.itemIconPadding = r1;
        updateMenuView(false);
    }

    public void setItemMaxLines(int r1) {
        this.itemMaxLines = r1;
        updateMenuView(false);
    }
    ...
    public void setItemIconSize(int r2) {
        if (this.itemIconSize != r2) {
            this.itemIconSize = r2;
    ...
    private void updateTopPadding() {
        int r0 = (this.headerLayout.getChildCount() == 0 && this.isBehindStatusBar) ? this.paddingTopDefault : 0;
        NavigationMenuView navigationMenuView = this.menuView;
    ...
    public void setOverScrollMode(int r1) {
        this.overScrollMode = r1;
        NavigationMenuView navigationMenuView = this.menuView;
        if (navigationMenuView != null) {
            navigationMenuView.setOverScrollMode(r1);
        }
    }
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C1199R.layout.design_navigation_item, viewGroup, false));
    ...
    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C1199R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }

    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C1199R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public int getItemViewType(int r1) {
            NavigationMenuItem navigationMenuItem = this.items.get(r1);
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onBindViewHolder(ViewHolder viewHolder, int r5) throws Resources.NotFoundException {
            int itemViewType = getItemViewType(r5);
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ((TextView) viewHolder.itemView).setText(((NavigationMenuTextItem) this.items.get(r5)).getMenuItem().getTitle());
                    return;
                } else {
                    if (itemViewType != 2) {
                        return;
                    }
                    NavigationMenuSeparatorItem navigationMenuSeparatorItem = (NavigationMenuSeparatorItem) this.items.get(r5);
            ...
            NavigationMenuTextItem navigationMenuTextItem = (NavigationMenuTextItem) this.items.get(r5);
        ...
        private void prepareMenuItems() {
            ...
            int size2 = 0;
            while (r5 < size) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.menu.getVisibleItems().get(r5);
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ...
                    if (subMenu.hasVisibleItems()) {
                        ...
                        boolean z3 = false;
                        while (r12 < size4) {
                            MenuItemImpl menuItemImpl2 = (MenuItemImpl) subMenu.getItem(r12);
        ...
        private void appendTransparentIconIfMissing(int r3, int r4) {
            while (r3 < r4) {
                ((NavigationMenuTextItem) this.items.get(r3)).needsEmptyIcon = true;
                r3++;
            }
        }
        ...
        public Bundle createInstanceState() {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                NavigationMenuItem navigationMenuItem = this.items.get(r2);
                if (navigationMenuItem instanceof NavigationMenuTextItem) {
        ...
        public void restoreInstanceState(Bundle bundle) {
            ...
            int r0 = bundle.getInt(STATE_CHECKED_ITEM, 0);
            if (r0 != 0) {
                this.updateSuspended = true;
                int size = this.items.size();
                int r3 = 0;
                while (true) {
                    ...
                    NavigationMenuItem navigationMenuItem = this.items.get(r3);
                    if ((navigationMenuItem instanceof NavigationMenuTextItem) && (menuItem2 = ((NavigationMenuTextItem) navigationMenuItem).getMenuItem()) != null && menuItem2.getItemId() == r0) {
            ...
            if (sparseParcelableArray != null) {
                ...
                for (int r1 = 0; r1 < size2; r1++) {
                    NavigationMenuItem navigationMenuItem2 = this.items.get(r1);
        ...
        int getRowCount() {
            int r0 = NavigationMenuPresenter.this.headerLayout.getChildCount() == 0 ? 0 : 1;
            for (int r1 = 0; r1 < NavigationMenuPresenter.this.adapter.getItemCount(); r1++) {
                if (NavigationMenuPresenter.this.adapter.getItemViewType(r1) == 0) {
                    r0++;
                }
            }
            return r0;
