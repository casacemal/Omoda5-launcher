...
class FloatingActionButtonImpl {
    ...
    void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int r4) {
    ...
    final void setMaxImageSize(int r2) {
        if (this.maxImageSize != r2) {
            this.maxImageSize = r2;
    ...
    private void calculateImageMatrixFromScale(float f, Matrix matrix) {
        ...
        int r5 = this.maxImageSize;
        matrix.postScale(f, f, r5 / 2.0f, r5 / 2.0f);
    }
    ...
    void onDrawableStateChanged(int[] r1) {
        this.stateListAnimator.setState(r1);
    }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1199R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1199R.animator.design_fab_hide_motion_spec);
        }
    ...
    void getPadding(Rect rect) {
        ...
        int r4 = Math.max(sizeDimension, (int) Math.ceil(this.shadowPaddingEnabled ? getElevation() + this.pressedTranslationZ : 0.0f));
        int r0 = Math.max(sizeDimension, (int) Math.ceil(r1 * SHADOW_MULTIPLIER));
        rect.set(r4, r0, r4, r0);
    }
