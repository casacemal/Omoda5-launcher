...
public class ShapeAppearanceModel {
    ...
    public static Builder builder(Context context, AttributeSet attributeSet, int r3, int r4, CornerSize cornerSize) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.MaterialShape, r3, r4);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.MaterialShape_shapeAppearance, 0);
        int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.MaterialShape_shapeAppearanceOverlay, 0);
    ...
    private static Builder builder(Context context, int r7, int r8, CornerSize cornerSize) throws Resources.NotFoundException {
        if (r8 != 0) {
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, r7);
            r7 = r8;
            context = contextThemeWrapper;
        }
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(r7, C1199R.styleable.ShapeAppearance);
        try {
            int r72 = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.ShapeAppearance_cornerFamily, 0);
            int r82 = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.ShapeAppearance_cornerFamilyTopLeft, r72);
            int r0 = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.ShapeAppearance_cornerFamilyTopRight, r72);
            int r1 = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.ShapeAppearance_cornerFamilyBottomRight, r72);
            int r73 = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.ShapeAppearance_cornerFamilyBottomLeft, r72);
            CornerSize cornerSize2 = getCornerSize(typedArrayObtainStyledAttributes, C1199R.styleable.ShapeAppearance_cornerSize, cornerSize);
            CornerSize cornerSize3 = getCornerSize(typedArrayObtainStyledAttributes, C1199R.styleable.ShapeAppearance_cornerSizeTopLeft, cornerSize2);
            CornerSize cornerSize4 = getCornerSize(typedArrayObtainStyledAttributes, C1199R.styleable.ShapeAppearance_cornerSizeTopRight, cornerSize2);
            CornerSize cornerSize5 = getCornerSize(typedArrayObtainStyledAttributes, C1199R.styleable.ShapeAppearance_cornerSizeBottomRight, cornerSize2);
            return new Builder().setTopLeftCorner(r82, cornerSize3).setTopRightCorner(r0, cornerSize4).setBottomRightCorner(r1, cornerSize5).setBottomLeftCorner(r73, getCornerSize(typedArrayObtainStyledAttributes, C1199R.styleable.ShapeAppearance_cornerSizeBottomLeft, cornerSize2));
        } finally {
            typedArrayObtainStyledAttributes.recycle();
        }
    }
