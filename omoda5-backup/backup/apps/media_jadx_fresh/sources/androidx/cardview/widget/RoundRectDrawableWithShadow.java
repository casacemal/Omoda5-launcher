...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0196R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0196R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0196R.dimen.cardview_compat_inset_shadow);
    ...
    public void setAlpha(int r2) {
        ...
        this.mCornerShadowPaint.setAlpha(r2);
        this.mEdgeShadowPaint.setAlpha(r2);
    }
    ...
    public boolean getPadding(Rect rect) {
        int r0 = (int) Math.ceil(calculateVerticalPadding(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
        int r3 = (int) Math.ceil(calculateHorizontalPadding(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
        rect.set(r3, r0, r3, r0);
        return true;
    }
    ...
    private void buildShadowCorners() {
        ...
        int r6 = this.mShadowStartColor;
        paint.setShader(new RadialGradient(0.0f, 0.0f, f5, new int[]{r6, r6, this.mShadowEndColor}, new float[]{0.0f, f4, 1.0f}, Shader.TileMode.CLAMP));
        Paint paint2 = this.mEdgeShadowPaint;
        float f6 = this.mCornerRadius;
        float f7 = this.mShadowSize;
        int r5 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient(0.0f, (-f6) + f7, 0.0f, (-f6) - f7, new int[]{r5, r5, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
