...
public class LifecycleRegistry extends Lifecycle {
    ...
    static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C03101.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
    ...
    static /* synthetic */ class C03101 {
        ...
        static {
            ...
            try {
                r0[Lifecycle.State.INITIALIZED.ordinal()] = 1;
            ...
            int[] r5 = new int[Lifecycle.Event.values().length];
            $SwitchMap$androidx$lifecycle$Lifecycle$Event = r5;
            try {
                r5[Lifecycle.Event.ON_CREATE.ordinal()] = 1;
    ...
    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int r0 = C03101.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (r0 == 1) {
