...
public class ContextCompat {
    ...
    public static Drawable getDrawable(Context context, int r5) {
        int r52;
        ...
        synchronized (sLock) {
            ...
            context.getResources().getValue(r5, sTempValue, true);
            r52 = sTempValue.resourceId;
        }
        return context.getResources().getDrawable(r52);
    }

    public static ColorStateList getColorStateList(Context context, int r3) {
        if (Build.VERSION.SDK_INT >= 23) {
            return context.getColorStateList(r3);
        }
        return context.getResources().getColorStateList(r3);
    }
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(AudioManager.class, Car.AUDIO_SERVICE);
            ...
            SERVICES.put(PowerManager.class, Car.POWER_SERVICE);
            SERVICES.put(SearchManager.class, "search");
            SERVICES.put(SensorManager.class, Car.SENSOR_SERVICE);
