...
public final class ResourcesCompat {
    ...
    public static Drawable getDrawable(Resources resources, int r3, Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 21) {
            return resources.getDrawable(r3, theme);
        }
        return resources.getDrawable(r3);
    }

    public static Drawable getDrawableForDensity(Resources resources, int r3, int r4, Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 21) {
            return resources.getDrawableForDensity(r3, r4, theme);
        }
        if (Build.VERSION.SDK_INT >= 15) {
            return resources.getDrawableForDensity(r3, r4);
        }
        return resources.getDrawable(r3);
    }

    public static int getColor(Resources resources, int r3, Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 23) {
            return resources.getColor(r3, theme);
        }
        return resources.getColor(r3);
    }

    public static ColorStateList getColorStateList(Resources resources, int r3, Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 23) {
            return resources.getColorStateList(r3, theme);
        }
        return resources.getColorStateList(r3);
    }

    public static float getFloat(Resources resources, int r4) throws Resources.NotFoundException {
    ...
    public static Typeface getFont(Context context, int r8) throws Resources.NotFoundException {
        ...
        return loadFont(context, r8, new TypedValue(), 0, null, null, false);
    }
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(final int r2, Handler handler) {
            if (handler == null) {
                handler = new Handler(Looper.getMainLooper());
            }
            handler.post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat.FontCallback.2
                @Override // java.lang.Runnable
                public void run() {
                    FontCallback.this.onFontRetrievalFailed(r2);
                }
            });
        }
    }

    public static void getFont(Context context, int r8, FontCallback fontCallback, Handler handler) throws Resources.NotFoundException {
        Preconditions.checkNotNull(fontCallback);
        if (context.isRestricted()) {
            fontCallback.callbackFailAsync(-4, handler);
        } else {
            loadFont(context, r8, new TypedValue(), 0, fontCallback, handler, false);
        }
    }

    public static Typeface getFont(Context context, int r8, TypedValue typedValue, int r10, FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, r8, typedValue, r10, fontCallback, null, true);
    }

    private static Typeface loadFont(Context context, int r9, TypedValue typedValue, int r11, FontCallback fontCallback, Handler handler, boolean z) throws Resources.NotFoundException {
        Resources resources = context.getResources();
        resources.getValue(r9, typedValue, true);
        Typeface typefaceLoadFont = loadFont(context, resources, typedValue, r9, r11, fontCallback, handler, z);
