...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int r1 = 0;
            while (r1 < this.mPersons.length) {
                StringBuilder sb = new StringBuilder();
                sb.append(EXTRA_PERSON_);
                int r3 = r1 + 1;
                sb.append(r3);
                persistableBundle.putPersistableBundle(sb.toString(), this.mPersons[r1].toPersistableBundle());
                r1 = r3;
            }
        }
    ...
    static Person[] getPersonsFromExtra(PersistableBundle persistableBundle) {
        ...
        int r0 = persistableBundle.getInt(EXTRA_PERSON_COUNT);
        Person[] personArr = new Person[r0];
        int r2 = 0;
        while (r2 < r0) {
            StringBuilder sb = new StringBuilder();
            sb.append(EXTRA_PERSON_);
            int r4 = r2 + 1;
            sb.append(r4);
            personArr[r2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sb.toString()));
            r2 = r4;
        }
        return personArr;
    }
