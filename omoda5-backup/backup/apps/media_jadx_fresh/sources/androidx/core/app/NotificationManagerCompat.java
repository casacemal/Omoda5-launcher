...
public final class NotificationManagerCompat {
    ...
    public void cancel(String str, int r4) {
        this.mNotificationManager.cancel(str, r4);
        if (Build.VERSION.SDK_INT <= 19) {
            pushSideChannelQueue(new CancelTask(this.mContext.getPackageName(), r4, str));
        }
    }
    ...
    public void notify(int r2, Notification notification) {
        notify(null, r2, notification);
    }

    public void notify(String str, int r4, Notification notification) {
        if (useSideChannelForNotification(notification)) {
            pushSideChannelQueue(new NotifyTask(this.mContext.getPackageName(), r4, str, notification));
            this.mNotificationManager.cancel(str, r4);
        } else {
            this.mNotificationManager.notify(str, r4, notification);
        }
    }
    ...
    public boolean areNotificationsEnabled() throws ClassNotFoundException {
        ...
        try {
            ...
            return ((Integer) cls.getMethod(CHECK_OP_NO_THROW, Integer.TYPE, Integer.TYPE, String.class).invoke(appOpsManager, Integer.valueOf(((Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(r1), packageName)).intValue() == 0;
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            int r0 = (1 << (listenerRecord.retryCount - 1)) * 1000;
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                Log.d(NotificationManagerCompat.TAG, "Scheduling retry for " + r0 + " ms");
            }
            this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(3, listenerRecord.componentName), r0);
        }
    ...
    private static class NotifyTask implements Task {
        ...
        NotifyTask(String str, int r2, String str2, Notification notification) {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f34id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f34id + ", tag:" + this.tag + "]";
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        CancelTask(String str, int r2, String str2) {
            this.packageName = str;
            this.f33id = r2;
            this.tag = str2;
            this.all = false;
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f33id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f33id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}
