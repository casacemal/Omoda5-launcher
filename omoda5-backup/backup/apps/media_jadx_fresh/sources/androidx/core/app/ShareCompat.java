...
public final class ShareCompat {
    ...
    public static void configureMenuItem(Menu menu, int r2, IntentBuilder intentBuilder) {
    ...
    public static class IntentBuilder {
        ...
        public IntentBuilder setChooserTitle(int r2) {
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb, CharSequence charSequence, int r5, int r6) {
            while (r5 < r6) {
