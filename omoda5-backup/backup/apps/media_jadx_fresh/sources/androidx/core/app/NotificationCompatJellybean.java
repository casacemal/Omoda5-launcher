...
class NotificationCompatJellybean {
    ...
    public static NotificationCompat.Action readAction(int r11, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return new NotificationCompat.Action(r11, charSequence, pendingIntent, bundle, remoteInputArrFromBundleArray, remoteInputArrFromBundleArray2, z, 0, true);
    }
    ...
    public static NotificationCompat.Action getAction(Notification notification, int r6) {
            ...
            try {
                try {
                    ...
                    if (actionObjectsLocked != null) {
                        Object obj = actionObjectsLocked[r6];
                        Bundle extras = getExtras(notification);
                        return readAction(sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), (extras == null || (sparseParcelableArray = extras.getSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS)) == null) ? null : (Bundle) sparseParcelableArray.get(r6));
                    }
                } catch (IllegalAccessException e) {
    ...
    private static RemoteInput[] fromBundleArray(Bundle[] bundleArr) {
        ...
        for (int r1 = 0; r1 < bundleArr.length; r1++) {
            remoteInputArr[r1] = fromBundle(bundleArr[r1]);
        }
    ...
    private static Bundle[] toBundleArray(RemoteInput[] remoteInputArr) {
        ...
        for (int r1 = 0; r1 < remoteInputArr.length; r1++) {
            bundleArr[r1] = toBundle(remoteInputArr[r1]);
        }
        return bundleArr;
    }
