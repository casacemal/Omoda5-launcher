    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (builder.mInvisibleActions.size() > 0) {
                ...
                for (int r4 = 0; r4 < builder.mInvisibleActions.size(); r4++) {
                    bundle2.putBundle(Integer.toString(r4), NotificationCompatJellybean.getBundleForAction(builder.mInvisibleActions.get(r4)));
                }
