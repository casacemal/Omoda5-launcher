...
public abstract class JobIntentService extends Service {
    ...
    static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        CompatWorkEnqueuer(Context context, ComponentName componentName) {
            ...
            PowerManager powerManager = (PowerManager) context.getSystemService(Car.POWER_SERVICE);
    ...
    static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        JobWorkEnqueuer(Context context, ComponentName componentName, int r5) {
            super(componentName);
            ensureJobId(r5);
            this.mJobInfo = new JobInfo.Builder(r5, this.mComponentName).setOverrideDeadline(0L).build();
    ...
    final class CompatWorkItem implements GenericWorkItem {
        ...
        CompatWorkItem(Intent intent, int r3) {
            this.mIntent = intent;
            this.mStartId = r3;
        }
    ...
    public int onStartCommand(Intent intent, int r4, int r5) {
        ...
        synchronized (this.mCompatQueue) {
            ...
            arrayList.add(new CompatWorkItem(intent, r5));
    ...
    public static void enqueueWork(Context context, Class cls, int r3, Intent intent) {
        enqueueWork(context, new ComponentName(context, (Class<?>) cls), r3, intent);
    }

    public static void enqueueWork(Context context, ComponentName componentName, int r4, Intent intent) {
        if (intent == null) {
            throw new IllegalArgumentException("work must not be null");
        }
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, r4);
            workEnqueuer.ensureJobId(r4);
            workEnqueuer.enqueueWork(intent);
        }
    }

    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z, int r5) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            compatWorkEnqueuer = new JobWorkEnqueuer(context, componentName, r5);
        }
