...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder setSmallIcon(int r2, int r3) {
            this.mNotification.icon = r2;
            this.mNotification.iconLevel = r3;
            return this;
        }
        ...
        public Builder setProgress(int r1, int r2, boolean z) {
        ...
        public Builder setSound(Uri uri, int r4) {
            this.mNotification.sound = uri;
            this.mNotification.audioStreamType = r4;
            if (Build.VERSION.SDK_INT >= 21) {
                this.mNotification.audioAttributes = new AudioAttributes.Builder().setContentType(4).setLegacyStreamType(r4).build();
            }
            return this;
        }
        ...
        public Builder setLights(int r2, int r3, int r4) {
            this.mNotification.ledARGB = r2;
            this.mNotification.ledOnMS = r3;
            this.mNotification.ledOffMS = r4;
            int r22 = (this.mNotification.ledOnMS == 0 || this.mNotification.ledOffMS == 0) ? 0 : 1;
            Notification notification = this.mNotification;
            notification.flags = r22 | (notification.flags & (-2));
            return this;
        }
        ...
        public Builder setDefaults(int r2) {
            this.mNotification.defaults = r2;
            if ((r2 & 4) != 0) {
        ...
        private void setFlag(int r1, boolean z) {
            if (z) {
                Notification notification = this.mNotification;
                notification.flags = r1 | notification.flags;
            } else {
                Notification notification2 = this.mNotification;
                notification2.flags = (~r1) & notification2.flags;
            }
        }
        ...
        public Builder addAction(int r3, CharSequence charSequence, PendingIntent pendingIntent) {
            this.mActions.add(new Action(r3, charSequence, pendingIntent));
            return this;
        }
        ...
        public Builder addInvisibleAction(int r2, CharSequence charSequence, PendingIntent pendingIntent) {
            return addInvisibleAction(new Action(r2, charSequence, pendingIntent));
        }
        ...
        public Builder setColor(int r1) {
            this.mColor = r1;
            return this;
        }
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createColoredBitmap(int r3, int r4, int r5) throws Resources.NotFoundException {
            Drawable drawable = this.mBuilder.mContext.getResources().getDrawable(r3);
            int intrinsicWidth = r5 == 0 ? drawable.getIntrinsicWidth() : r5;
            if (r5 == 0) {
                r5 = drawable.getIntrinsicHeight();
            }
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(intrinsicWidth, r5, Bitmap.Config.ARGB_8888);
            drawable.setBounds(0, 0, intrinsicWidth, r5);
            if (r4 != 0) {
                drawable.mutate().setColorFilter(new PorterDuffColorFilter(r4, PorterDuff.Mode.SRC_IN));
            }
            drawable.draw(new Canvas(bitmapCreateBitmap));
            return bitmapCreateBitmap;
        }

        private Bitmap createIconWithBackground(int r2, int r3, int r4, int r5) throws Resources.NotFoundException {
            int r0 = C0211R.drawable.notification_icon_background;
            if (r5 == 0) {
                r5 = 0;
            }
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(r0, r5, r3);
            Canvas canvas = new Canvas(bitmapCreateColoredBitmap);
            Drawable drawableMutate = this.mBuilder.mContext.getResources().getDrawable(r2).mutate();
            drawableMutate.setFilterBitmap(true);
            int r32 = (r3 - r4) / 2;
            int r42 = r4 + r32;
            drawableMutate.setBounds(r32, r32, r42, r42);
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0211R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        private TextAppearanceSpan makeFontColorSpan(int r7) {
            return new TextAppearanceSpan(null, 0, 0, ColorStateList.valueOf(r7), null);
        }
        ...
        public static final class Message {
            ...
            static Bundle[] getBundleArrayForMessages(List<Message> list) {
                ...
                for (int r2 = 0; r2 < size; r2++) {
                    bundleArr[r2] = list.get(r2).toBundle();
                }
                return bundleArr;
            }
            ...
            static List<Message> getMessagesFromBundleArray(Parcelable[] parcelableArr) {
                ...
                for (int r1 = 0; r1 < parcelableArr.length; r1++) {
                    if ((parcelableArr[r1] instanceof Bundle) && (messageFromBundle = getMessageFromBundle((Bundle) parcelableArr[r1])) != null) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int r8;
            boolean z2 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0211R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0211R.id.actions);
            if (!z || this.mBuilder.mActions == null || (r8 = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int r3 = 0; r3 < r8; r3++) {
                    remoteViewsApplyStandardTemplate.addView(C0211R.id.actions, generateActionButton(this.mBuilder.mActions.get(r3)));
                }
            }
            int r2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0211R.id.actions, r2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0211R.id.action_divider, r2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0211R.layout.notification_action_tombstone : C0211R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0211R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0211R.color.notification_action_color_filter)));
            ...
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0211R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public Action(int r11, CharSequence charSequence, PendingIntent pendingIntent) {
            this(r11, charSequence, pendingIntent, new Bundle(), null, null, true, 0, true);
        }

        Action(int r2, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int r9, boolean z2) {
        ...
        public static final class Builder {
            ...
            public Builder(int r10, CharSequence charSequence, PendingIntent pendingIntent) {
                this(r10, charSequence, pendingIntent, new Bundle(), null, true, 0, true);
            }
            ...
            private Builder(int r2, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z, int r8, boolean z2) {
    ...
    public static final class WearableExtender implements Extender {
                ...
                if (Build.VERSION.SDK_INT >= 16 && parcelableArrayList != null) {
                    ...
                    for (int r9 = 0; r9 < size; r9++) {
                        if (Build.VERSION.SDK_INT >= 20) {
                            actionArr[r9] = NotificationCompat.getActionCompatFromAction((Notification.Action) parcelableArrayList.get(r9));
                        } else if (Build.VERSION.SDK_INT >= 16) {
                            actionArr[r9] = NotificationCompatJellybean.getActionFromBundle((Bundle) parcelableArrayList.get(r9));
                        }
                    }
        ...
        public Builder extend(Builder builder) {
            ...
            int r12 = this.mContentIcon;
            if (r12 != 0) {
                bundle.putInt(KEY_CONTENT_ICON, r12);
            }
            int r13 = this.mContentIconGravity;
            if (r13 != 8388613) {
                bundle.putInt(KEY_CONTENT_ICON_GRAVITY, r13);
            }
            int r14 = this.mContentActionIndex;
            if (r14 != -1) {
                bundle.putInt(KEY_CONTENT_ACTION_INDEX, r14);
            }
            int r15 = this.mCustomSizePreset;
            if (r15 != 0) {
                bundle.putInt(KEY_CUSTOM_SIZE_PRESET, r15);
            }
            int r16 = this.mCustomContentHeight;
            if (r16 != 0) {
                bundle.putInt(KEY_CUSTOM_CONTENT_HEIGHT, r16);
            }
            int r17 = this.mGravity;
            if (r17 != 80) {
                bundle.putInt(KEY_GRAVITY, r17);
            }
            int r18 = this.mHintScreenTimeout;
            if (r18 != 0) {
                bundle.putInt(KEY_HINT_SCREEN_TIMEOUT, r18);
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (parcelableArray != null) {
                ...
                while (true) {
                    ...
                    strArr2[r7] = ((Bundle) parcelableArray[r7]).getString(KEY_TEXT);
                    if (strArr2[r7] == null) {
                        break;
                    }
                    r7++;
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation unreadConversation) {
            ...
            for (int r2 = 0; r2 < length; r2++) {
                ...
                bundle2.putString(KEY_TEXT, unreadConversation.getMessages()[r2]);
        ...
        public CarExtender setColor(int r1) {
            this.mColor = r1;
            return this;
        }
    ...
    public static Action getAction(Notification notification, int r4) {
        if (Build.VERSION.SDK_INT >= 20) {
            return getActionCompatFromAction(notification.actions[r4]);
        }
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            return NotificationCompatJellybean.readAction(action.icon, action.title, action.actionIntent, sparseParcelableArray != null ? (Bundle) sparseParcelableArray.get(r4) : null);
        }
        if (Build.VERSION.SDK_INT >= 16) {
            return NotificationCompatJellybean.getAction(notification, r4);
        }
        return null;
    }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int r3 = 0; r3 < remoteInputs.length; r3++) {
                android.app.RemoteInput remoteInput = remoteInputs[r3];
                remoteInputArr2[r3] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), null);
            }
    ...
    public static List<Action> getInvisibleActions(Notification notification) {
        ...
        if (bundle2 != null && (bundle = bundle2.getBundle("invisible_actions")) != null) {
            for (int r1 = 0; r1 < bundle.size(); r1++) {
                arrayList.add(NotificationCompatJellybean.getActionFromBundle(bundle.getBundle(Integer.toString(r1))));
            }
        }
        return arrayList;
    }
