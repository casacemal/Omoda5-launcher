...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(final Activity activity, final String[] strArr, final int r4) {
        PermissionCompatDelegate permissionCompatDelegate = sDelegate;
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, r4)) {
            if (Build.VERSION.SDK_INT >= 23) {
                if (activity instanceof RequestPermissionsRequestCodeValidator) {
                    ((RequestPermissionsRequestCodeValidator) activity).validateRequestPermissionsRequestCode(r4);
                }
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.ActivityCompat.1
                    ...
                    public void run() {
                        ...
                        for (int r42 = 0; r42 < length; r42++) {
                            r0[r42] = packageManager.checkPermission(strArr[r42], packageName);
                        }
                        ((OnRequestPermissionsResultCallback) activity).onRequestPermissionsResult(r4, strArr, r0);
                    }
                });
            }
        }
