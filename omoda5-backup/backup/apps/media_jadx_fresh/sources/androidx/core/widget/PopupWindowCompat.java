...
public final class PopupWindowCompat {
    ...
    public static void showAsDropDown(PopupWindow popupWindow, View view, int r4, int r5, int r6) {
        if (Build.VERSION.SDK_INT >= 19) {
            popupWindow.showAsDropDown(view, r4, r5, r6);
            return;
        }
        if ((GravityCompat.getAbsoluteGravity(r6, ViewCompat.getLayoutDirection(view)) & 7) == 5) {
    ...
    public static void setWindowLayoutType(PopupWindow popupWindow, int r7) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
