...
public final class TextViewCompat {
    ...
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, int r3, int r4, int r5, int r6) {
        if (Build.VERSION.SDK_INT >= 18) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            textView.setCompoundDrawablesWithIntrinsicBounds(r0, r4, r3, r6);
            return;
        }
    ...
    public static void setTextAppearance(TextView textView, int r3) {
    ...
    public static void setAutoSizeTextTypeWithDefaults(TextView textView, int r3) {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeWithDefaults(r3);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeWithDefaults(r3);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithConfiguration(TextView textView, int r3, int r4, int r5, int r6) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeUniformWithConfiguration(r3, r4, r5, r6);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithConfiguration(r3, r4, r5, r6);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static void setAutoSizeTextTypeUniformWithPresetSizes(TextView textView, int[] r3, int r4) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeUniformWithPresetSizes(r3, r4);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithPresetSizes(r3, r4);
        }
    }
    ...
    private static class OreoCallback implements ActionMode.Callback {
        ...
        private void recomputeProcessTextMenuItems(Menu menu) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                for (int r2 = 0; r2 < supportedActivities.size(); r2++) {
                    ResolveInfo resolveInfo = supportedActivities.get(r2);
                    menu.add(0, 0, r2 + 100, resolveInfo.loadLabel(packageManager)).setIntent(createProcessTextIntentForResolveInfo(resolveInfo, this.mTextView)).setShowAsAction(1);
                }
    ...
    public static void setLineHeight(TextView textView, int r3) {
