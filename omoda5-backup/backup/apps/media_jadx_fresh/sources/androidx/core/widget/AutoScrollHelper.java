...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public AutoScrollHelper(View view) {
        ...
        int r0 = (int) ((displayMetrics.density * 1575.0f) + 0.5f);
        int r4 = (int) ((displayMetrics.density * 315.0f) + 0.5f);
        float f = r0;
    ...
    */
    ...
    private void startAnimating() {
        ...
        if (!this.mAlreadyDelayed && (r1 = this.mActivationDelay) > 0) {
    ...
    private float computeTargetVelocity(int r3, float f, float f2, float f3) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[r3], f2, this.mMaximumEdges[r3], f);
        if (edgeValue == 0.0f) {
            return 0.0f;
        }
        float f4 = this.mRelativeVelocity[r3];
        float f5 = this.mMinimumVelocity[r3];
        float f6 = this.mMaximumVelocity[r3];
        float f7 = f4 * f3;
        if (edgeValue > 0.0f) {
