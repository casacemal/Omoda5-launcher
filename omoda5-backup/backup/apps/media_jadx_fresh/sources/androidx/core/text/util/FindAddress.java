...
class FindAddress {
    ...
    private static class ZipRange {
        ...
        boolean matches(String str) throws NumberFormatException {
            ...
            return (this.mLow <= r3 && r3 <= this.mHigh) || r3 == this.mException1 || r3 == this.mException2;
        }
    }
    ...
    private static boolean checkHouseNumber(String str) throws NumberFormatException {
        ...
        int r3 = r12 % 10;
        String str2 = PageConstants.SystemSettings.LanguageId.f212TH;
        if (r3 == 1) {
            if (r12 % 100 != 11) {
                str2 = "st";
            }
        ...
        return lowerCase.equals(PageConstants.SystemSettings.LanguageId.f212TH);
    }

    public static MatchResult matchHouseNumber(String str, int r4) {
        if (r4 > 0 && HOUSE_PRE_DELIM.indexOf(str.charAt(r4 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(r4, str.length());
    ...
    public static MatchResult matchState(String str, int r4) {
        if (r4 > 0 && WORD_DELIM.indexOf(str.charAt(r4 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sStateRe.matcher(str).region(r4, str.length());
        if (matcherRegion.lookingAt()) {
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        return sZipCodeRe.matcher(str).matches() && sStateZipCodeRanges[r1].matches(str);
    }
    ...
    static String findAddress(String str) {
        ...
        while (matcher.find(r2)) {
            if (checkHouseNumber(matcher.group(0))) {
                ...
                int r3 = attemptMatch(str, matcher);
                if (r3 > 0) {
