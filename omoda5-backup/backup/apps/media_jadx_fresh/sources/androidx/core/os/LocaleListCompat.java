...
public final class LocaleListCompat {
    ...
    public Locale get(int r1) {
        return this.mImpl.get(r1);
    }
    ...
    public static LocaleListCompat forLanguageTags(String str) {
        ...
        for (int r2 = 0; r2 < length; r2++) {
            if (Build.VERSION.SDK_INT >= 21) {
                localeForLanguageTagCompat = Locale.forLanguageTag(strArrSplit[r2]);
            } else {
                localeForLanguageTagCompat = forLanguageTagCompat(strArrSplit[r2]);
            }
            localeArr[r2] = localeForLanguageTagCompat;
        }
