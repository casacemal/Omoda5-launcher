...
public final class FingerprintManagerCompat {
    ...
    public static abstract class AuthenticationCallback {
        public void onAuthenticationError(int r1, CharSequence charSequence) {
        }

        public void onAuthenticationFailed() {
        }

        public void onAuthenticationHelp(int r1, CharSequence charSequence) {
        }
    ...
    public void authenticate(CryptoObject cryptoObject, int r8, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler) {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) == null) {
            return;
        }
        fingerprintManagerOrNull.authenticate(wrapCryptoObject(cryptoObject), cancellationSignal != null ? (android.os.CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, r8, wrapCallback(authenticationCallback), handler);
    }
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: androidx.core.hardware.fingerprint.FingerprintManagerCompat.1
            ...
            public void onAuthenticationError(int r1, CharSequence charSequence) {
                authenticationCallback.onAuthenticationError(r1, charSequence);
            }

            @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
            public void onAuthenticationHelp(int r1, CharSequence charSequence) {
                authenticationCallback.onAuthenticationHelp(r1, charSequence);
            }
