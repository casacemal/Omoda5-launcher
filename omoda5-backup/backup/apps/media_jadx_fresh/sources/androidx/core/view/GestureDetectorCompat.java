            ...
            if (r0 != 1) {
                if (r0 != 2) {
                    ...
                    for (int r4 = 0; r4 < pointerCount; r4++) {
                        if (r4 != actionIndex2) {
                            int pointerId2 = motionEvent.getPointerId(r4);
                ...
                int r6 = (int) (f2 - this.mDownFocusX);
                int r7 = (int) (f3 - this.mDownFocusY);
                int r62 = (r6 * r6) + (r7 * r7);
                if (r62 > this.mTouchSlopSquare) {
