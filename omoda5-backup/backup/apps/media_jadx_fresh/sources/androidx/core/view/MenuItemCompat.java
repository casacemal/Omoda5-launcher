...
public final class MenuItemCompat {
    ...
    @Deprecated
    public static void setShowAsAction(MenuItem menuItem, int r1) {
    ...
    @Deprecated
    public static MenuItem setActionView(MenuItem menuItem, int r1) {
    ...
    public static void setShortcut(MenuItem menuItem, char c, char c2, int r5, int r6) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c, c2, r5, r6);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setShortcut(c, c2, r5, r6);
        }
    }

    public static void setNumericShortcut(MenuItem menuItem, char c, int r4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c, r4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setNumericShortcut(c, r4);
        }
    }
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c, int r4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c, r4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setAlphabeticShortcut(c, r4);
        }
    }
