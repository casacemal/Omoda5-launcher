...
public class ViewCompat {
    ...
    @Deprecated
    public static boolean canScrollHorizontally(View view, int r1) {
        return view.canScrollHorizontally(r1);
    }

    @Deprecated
    public static boolean canScrollVertically(View view, int r1) {
    ...
    @Deprecated
    public static void setOverScrollMode(View view, int r1) {
    ...
    public static void setImportantForAutofill(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void postInvalidateOnAnimation(View view, int r3, int r4, int r5, int r6) {
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static void setImportantForAccessibility(View view, int r3) {
    ...
    public static boolean performAccessibilityAction(View view, int r3, Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    private static int getAvailableActionIdFromResources(View view) {
        ...
        int r2 = 0;
        while (true) {
            int[] r4 = ACCESSIBILITY_ACTIONS_RESOURCE_IDS;
            if (r2 >= r4.length || r3 != -1) {
                break;
            }
            int r42 = r4[r2];
            boolean z = true;
            for (int r6 = 0; r6 < actionList.size(); r6++) {
                z &= actionList.get(r6).getId() != r42;
            }
            if (z) {
                r3 = r42;
            }
    ...
    public static void removeAccessibilityAction(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 21) {
            removeActionWithId(r3, view);
            notifyViewAccessibilityStateChangedIfNeeded(view, 0);
        }
    }

    private static void removeActionWithId(int r2, View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actionList = getActionList(view);
        for (int r0 = 0; r0 < actionList.size(); r0++) {
            if (actionList.get(r0).getId() == r2) {
    ...
    @Deprecated
    public static void setLayerType(View view, int r1, Paint paint) {
    ...
    public static void setLabelFor(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 17) {
            view.setLabelFor(r3);
        }
    }
    ...
    public static void setLayoutDirection(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    public static <T extends View> T requireViewById(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (T) view.requireViewById(r3);
        }
        T t = (T) view.findViewById(r3);
        if (t != null) {
            return t;
        }
    ...
    public static void setAccessibilityLiveRegion(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static void setPaddingRelative(View view, int r3, int r4, int r5, int r6) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean startNestedScroll(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 21) {
            return view.startNestedScroll(r3);
        }
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).startNestedScroll(r3);
        }
        return false;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedScroll(View view, int r8, int r9, int r10, int r11, int[] r12) {
        if (Build.VERSION.SDK_INT >= 21) {
            return view.dispatchNestedScroll(r8, r9, r10, r11, r12);
        }
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedScroll(r8, r9, r10, r11, r12);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedPreScroll(View view, int r3, int r4, int[] r5, int[] r6) {
        if (Build.VERSION.SDK_INT >= 21) {
            return view.dispatchNestedPreScroll(r3, r4, r5, r6);
        }
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedPreScroll(r3, r4, r5, r6);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean startNestedScroll(View view, int r2, int r3) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).startNestedScroll(r2, r3);
        }
        if (r3 == 0) {
            return startNestedScroll(view, r2);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static void stopNestedScroll(View view, int r2) {
        if (view instanceof NestedScrollingChild2) {
            ((NestedScrollingChild2) view).stopNestedScroll(r2);
        } else if (r2 == 0) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static boolean hasNestedScrollingParent(View view, int r2) {
        if (view instanceof NestedScrollingChild2) {
            ((NestedScrollingChild2) view).hasNestedScrollingParent(r2);
            return false;
        }
        if (r2 == 0) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static void dispatchNestedScroll(View view, int r11, int r12, int r13, int r14, int[] r15, int r16, int[] r17) {
        if (view instanceof NestedScrollingChild3) {
            ((NestedScrollingChild3) view).dispatchNestedScroll(r11, r12, r13, r14, r15, r16, r17);
        } else {
            dispatchNestedScroll(view, r11, r12, r13, r14, r15, r16);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedScroll(View view, int r9, int r10, int r11, int r12, int[] r13, int r14) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedScroll(r9, r10, r11, r12, r13, r14);
        }
        if (r14 == 0) {
            return dispatchNestedScroll(view, r9, r10, r11, r12, r13);
        }
        return false;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static boolean dispatchNestedPreScroll(View view, int r8, int r9, int[] r10, int[] r11, int r12) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedPreScroll(r8, r9, r10, r11, r12);
        }
        if (r12 == 0) {
            return dispatchNestedPreScroll(view, r8, r9, r10, r11);
        }
        return false;
    }
    ...
    public static void offsetTopAndBottom(View view, int r7) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            compatOffsetTopAndBottom(view, r7);
    ...
    private static void compatOffsetTopAndBottom(View view, int r1) {
    ...
    public static void offsetLeftAndRight(View view, int r7) {
        if (Build.VERSION.SDK_INT >= 23) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            compatOffsetLeftAndRight(view, r7);
            if (z && emptyTempRect.intersect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom())) {
                ((View) parent).invalidate(emptyTempRect);
                return;
            }
    ...
    private static void compatOffsetLeftAndRight(View view, int r1) {
    ...
    public static void setScrollIndicators(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 23) {
            view.setScrollIndicators(r3);
        }
    }

    public static void setScrollIndicators(View view, int r3, int r4) {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    public static boolean startDragAndDrop(View view, ClipData clipData, View.DragShadowBuilder dragShadowBuilder, Object obj, int r6) {
        if (Build.VERSION.SDK_INT >= 24) {
            return view.startDragAndDrop(clipData, dragShadowBuilder, obj, r6);
        }
        return view.startDrag(clipData, dragShadowBuilder, obj, r6);
    }
    ...
    public static void setNextClusterForwardId(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static View keyboardNavigationClusterSearch(View view, View view2, int r4) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void addKeyboardNavigationClusters(View view, Collection<View> collection, int r4) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static int generateViewId() {
        ...
        do {
            r0 = sNextGeneratedId.get();
            r1 = r0 + 1;
            if (r1 > 16777215) {
                r1 = 1;
            }
        } while (!sNextGeneratedId.compareAndSet(r0, r1));
        return r0;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map arrayMap = (Map) view.getTag(C0211R.id.tag_unhandled_key_listeners);
            if (arrayMap == null) {
                arrayMap = new ArrayMap();
                view.setTag(C0211R.id.tag_unhandled_key_listeners, arrayMap);
            }
    ...
    public static void removeOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0211R.id.tag_unhandled_key_listeners);
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0211R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.3
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0211R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0211R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.5
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public Boolean frameworkGet(View view) {
    ...
    static abstract class AccessibilityViewProperty<T> {
        ...
        AccessibilityViewProperty(int r2, Class<T> cls, int r4) {
            this(r2, cls, 0, r4);
        }

        AccessibilityViewProperty(int r1, Class<T> cls, int r3, int r4) {
            this.mTagKey = r1;
            this.mType = cls;
    ...
    static void notifyViewAccessibilityStateChangedIfNeeded(View view, int r3) {
    ...
    static class UnhandledKeyEventManager {
        ...
        boolean preDispatch(KeyEvent keyEvent) {
            ...
            if (keyEvent.getAction() == 1 && (r3 = capturedKeys.indexOfKey(keyEvent.getKeyCode())) >= 0) {
                weakReferenceValueAt = capturedKeys.valueAt(r3);
                capturedKeys.removeAt(r3);
            }
        ...
        static void unregisterListeningView(View view) {
            synchronized (sViewsWithListeners) {
                for (int r1 = 0; r1 < sViewsWithListeners.size(); r1++) {
                    if (sViewsWithListeners.get(r1).get() == view) {
                        sViewsWithListeners.remove(r1);
                        return;
                    }
                }
            }
