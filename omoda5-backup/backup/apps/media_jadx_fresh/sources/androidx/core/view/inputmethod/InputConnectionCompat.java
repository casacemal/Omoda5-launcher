...
public final class InputConnectionCompat {
    ...
    public interface OnCommitContentListener {
        boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int r2, Bundle bundle);
    }
    ...
    static boolean handlePerformPrivateCommand(String str, Bundle bundle, OnCommitContentListener onCommitContentListener) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                int r6 = bundle.getInt(z ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY);
    ...
    public static boolean commitContent(InputConnection inputConnection, EditorInfo editorInfo, InputContentInfoCompat inputContentInfoCompat, int r10, Bundle bundle) {
        boolean z;
        ...
        while (true) {
            ...
            if (description.hasMimeType(contentMimeTypes[r4])) {
                z = true;
                break;
            }
            r4++;
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return inputConnection.commitContent((InputContentInfo) inputContentInfoCompat.unwrap(), r10, bundle);
        }
        ...
        bundle2.putInt(z2 ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY, r10);
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return new InputConnectionWrapper(inputConnection, z) { // from class: androidx.core.view.inputmethod.InputConnectionCompat.1
                ...
                public boolean commitContent(InputContentInfo inputContentInfo, int r4, Bundle bundle) {
                    if (onCommitContentListener.onCommitContent(InputContentInfoCompat.wrap(inputContentInfo), r4, bundle)) {
                        return true;
                    }
