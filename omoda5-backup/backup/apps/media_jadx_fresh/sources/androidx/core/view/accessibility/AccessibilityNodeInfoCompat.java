...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public AccessibilityActionCompat(int r7, CharSequence charSequence) {
            this(null, r7, charSequence, null, null);
        }

        public AccessibilityActionCompat(int r7, CharSequence charSequence, AccessibilityViewCommand accessibilityViewCommand) {
            this(null, r7, charSequence, accessibilityViewCommand, null);
        }
        ...
        private AccessibilityActionCompat(int r7, CharSequence charSequence, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            this(null, r7, charSequence, null, cls);
        }

        AccessibilityActionCompat(Object obj, int r3, CharSequence charSequence, AccessibilityViewCommand accessibilityViewCommand, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            this.mId = r3;
            this.mLabel = charSequence;
            this.mCommand = accessibilityViewCommand;
            if (Build.VERSION.SDK_INT >= 21 && obj == null) {
                this.mAction = new AccessibilityNodeInfo.AccessibilityAction(r3, charSequence);
            } else {
                this.mAction = obj;
            }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int r2, int r3, boolean z, int r5) {
            if (Build.VERSION.SDK_INT >= 21) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(r2, r3, z, r5));
            }
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(r2, r3, z));
            }
            return new CollectionInfoCompat(null);
        }

        public static CollectionInfoCompat obtain(int r2, int r3, boolean z) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(r2, r3, z));
            }
            return new CollectionInfoCompat(null);
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int r2, int r3, int r4, int r5, boolean z, boolean z2) {
            if (Build.VERSION.SDK_INT >= 21) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(r2, r3, r4, r5, z, z2));
            }
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(r2, r3, r4, r5, z));
            }
            return new CollectionItemInfoCompat(null);
        }

        public static CollectionItemInfoCompat obtain(int r2, int r3, int r4, int r5, boolean z) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(r2, r3, r4, r5, z));
            }
            return new CollectionItemInfoCompat(null);
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int r2, float f, float f2, float f3) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(r2, f, f2, f3));
            }
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int r3) {
        if (Build.VERSION.SDK_INT >= 16) {
            return wrapNonNullInstance(AccessibilityNodeInfo.obtain(view, r3));
        }
        return null;
    }
    ...
    public void setSource(View view, int r4) {
        this.mVirtualDescendantId = r4;
        if (Build.VERSION.SDK_INT >= 16) {
            this.mInfo.setSource(view, r4);
        }
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int r1) {
        return wrapNonNullInstance(this.mInfo.getChild(r1));
    }
    ...
    public void addChild(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 16) {
            this.mInfo.addChild(view, r4);
        }
    }
    ...
    public boolean removeChild(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 21) {
            return this.mInfo.removeChild(view, r4);
        }
        return false;
    }
    ...
    public void addAction(int r1) {
        this.mInfo.addAction(r1);
    }
    ...
    public boolean performAction(int r1) {
        return this.mInfo.performAction(r1);
    }

    public boolean performAction(int r3, Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 16) {
            return this.mInfo.performAction(r3, bundle);
        }
        return false;
    }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String str) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            arrayList.add(wrap(listFindAccessibilityNodeInfosByText.get(r1)));
        }
        return arrayList;
    }
    ...
    public void setParent(View view, int r4) {
        this.mParentVirtualDescendantId = r4;
        if (Build.VERSION.SDK_INT >= 16) {
            this.mInfo.setParent(view, r4);
        }
    }
    ...
    public CharSequence getText() {
        if (hasSpans()) {
            ...
            for (int r7 = 0; r7 < listExtrasIntList.size(); r7++) {
                spannableString.setSpan(new AccessibilityClickableSpanCompat(listExtrasIntList4.get(r7).intValue(), this, getExtras().getInt(SPANS_ACTION_ID_KEY)), listExtrasIntList.get(r7).intValue(), listExtrasIntList2.get(r7).intValue(), listExtrasIntList3.get(r7).intValue());
            }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        ...
        for (int r1 = 0; clickableSpans != null && r1 < clickableSpans.length; r1++) {
            int r2 = idForClickableSpan(clickableSpans[r1], orCreateSpansFromViewTags);
            orCreateSpansFromViewTags.put(r2, new WeakReference<>(clickableSpans[r1]));
            addSpanLocationToExtras(clickableSpans[r1], (Spanned) charSequence, r2);
        }
    }
    ...
    private int idForClickableSpan(ClickableSpan clickableSpan, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        if (sparseArray != null) {
            for (int r1 = 0; r1 < sparseArray.size(); r1++) {
                if (clickableSpan.equals(sparseArray.valueAt(r1).get())) {
                    return sparseArray.keyAt(r1);
                }
            }
        }
        int r12 = sClickableSpanId;
        sClickableSpanId = r12 + 1;
        return r12;
    }
    ...
    private void addSpanLocationToExtras(ClickableSpan clickableSpan, Spanned spanned, int r5) {
        ...
        extrasIntList(SPANS_ID_KEY).add(Integer.valueOf(r5));
    }
    ...
    private void removeCollectedSpans(View view) {
        ...
        if (spansFromViewTags != null) {
            ArrayList arrayList = new ArrayList();
            for (int r1 = 0; r1 < spansFromViewTags.size(); r1++) {
                if (spansFromViewTags.valueAt(r1).get() == null) {
                    arrayList.add(Integer.valueOf(r1));
                }
            }
            for (int r0 = 0; r0 < arrayList.size(); r0++) {
                spansFromViewTags.remove(((Integer) arrayList.get(r0)).intValue());
            }
        }
    }
    ...
    public List<AccessibilityActionCompat> getActionList() {
        ...
        if (actionList != null) {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                arrayList.add(new AccessibilityActionCompat(actionList.get(r2)));
            }
            return arrayList;
        }
    ...
    public void setLabelFor(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 17) {
            this.mInfo.setLabelFor(view, r4);
        }
    }
    ...
    public void setLabeledBy(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 17) {
            this.mInfo.setLabeledBy(view, r4);
        }
    }
    ...
    public void setTraversalBefore(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalBefore(view, r4);
        }
    }
    ...
    public void setTraversalAfter(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalAfter(view, r4);
        }
    }
    ...
    public String toString() {
        ...
        while (actions != 0) {
            int r1 = 1 << Integer.numberOfTrailingZeros(actions);
            actions &= ~r1;
            sb.append(getActionSymbolicName(r1));
            if (actions != 0) {
                sb.append(", ");
            }
        }
    ...
    private void setBooleanProperty(int r5, boolean z) {
        Bundle extras = getExtras();
        if (extras != null) {
            int r2 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~r5);
            if (!z) {
                r5 = 0;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, r5 | r2);
        }
    }

    private boolean getBooleanProperty(int r3) {
        Bundle extras = getExtras();
        return extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & r3) == r3;
    }
}
