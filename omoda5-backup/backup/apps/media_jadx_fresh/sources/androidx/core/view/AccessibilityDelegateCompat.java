...
public class AccessibilityDelegateCompat {
    ...
    static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int r3 = 0; r3 < actionList.size(); r3++) {
                accessibilityNodeInfoCompatWrap.addAction(actionList.get(r3));
            }
        }
        ...
        @Override // android.view.View.AccessibilityDelegate
        public void sendAccessibilityEvent(View view, int r2) {
            this.mCompat.sendAccessibilityEvent(view, r2);
        }
        ...
        @Override // android.view.View.AccessibilityDelegate
        public boolean performAccessibilityAction(View view, int r2, Bundle bundle) {
            return this.mCompat.performAccessibilityAction(view, r2, bundle);
        }
    }
    ...
    public void sendAccessibilityEvent(View view, int r2) {
        this.mOriginalDelegate.sendAccessibilityEvent(view, r2);
    }
    ...
    public boolean performAccessibilityAction(View view, int r7, Bundle bundle) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actionList = getActionList(view);
        boolean zPerformAccessibilityAction = false;
        int r2 = 0;
        while (true) {
            if (r2 >= actionList.size()) {
                break;
            }
            AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat = actionList.get(r2);
        ...
        if (!zPerformAccessibilityAction && Build.VERSION.SDK_INT >= 16) {
            zPerformAccessibilityAction = this.mOriginalDelegate.performAccessibilityAction(view, r7, bundle);
        }
        return (zPerformAccessibilityAction || r7 != C0211R.id.accessibility_action_clickable_span) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int r2, View view) {
    ...
    private boolean isSpanStillValid(ClickableSpan clickableSpan, View view) {
        if (clickableSpan != null) {
            ...
            for (int r0 = 0; clickableSpans != null && r0 < clickableSpans.length; r0++) {
                if (clickableSpan.equals(clickableSpans[r0])) {
                    return true;
                }
            }
        }
