...
public final class DrawableCompat {
    ...
    public static void setHotspotBounds(Drawable drawable, int r3, int r4, int r5, int r6) {
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public static void setTint(Drawable drawable, int r3) {
        if (Build.VERSION.SDK_INT >= 21) {
            drawable.setTint(r3);
        } else if (drawable instanceof TintAwareDrawable) {
            ((TintAwareDrawable) drawable).setTint(r3);
        }
    }
    ...
    public static boolean setLayoutDirection(Drawable drawable, int r8) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
