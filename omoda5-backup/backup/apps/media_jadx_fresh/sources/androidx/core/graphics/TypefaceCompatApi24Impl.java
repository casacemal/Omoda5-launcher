...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, ByteBuffer byteBuffer, int r5, int r6, boolean z) {
        try {
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int r12) throws IOException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        ...
        return Typeface.create(typefaceCreateFromFamiliesWithDefault, r12);
    }

    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int r10) {
        Object objNewFamily = newFamily();
        if (objNewFamily == null) {
            return null;
        }
