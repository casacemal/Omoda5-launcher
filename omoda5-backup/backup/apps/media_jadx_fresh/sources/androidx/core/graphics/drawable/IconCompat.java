...
public class IconCompat extends CustomVersionedParcelable {
    ...
    private static String typeToString(int r1) {
        return r1 != 1 ? r1 != 2 ? r1 != 3 ? r1 != 4 ? r1 != 5 ? "UNKNOWN" : "BITMAP_MASKABLE" : "URI" : TurboBroadcastValue.DATA : "RESOURCE" : "BITMAP";
    }
    ...
    */
    ...
    public static IconCompat createFromBundle(Bundle bundle) {
        int r0 = bundle.getInt(EXTRA_TYPE);
    ...
    static Bitmap createLegacyIconFromAdaptiveIcon(Bitmap bitmap, boolean z) {
        int r0 = (int) (Math.min(bitmap.getWidth(), bitmap.getHeight()) * DEFAULT_VIEW_PORT_SCALE);
