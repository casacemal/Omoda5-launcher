...
public class LruCache<K, V> {
    ...
    */
    ...
    public final synchronized String toString() {
        int r0;
        r0 = this.hitCount + this.missCount;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(r0 != 0 ? (this.hitCount * 100) / r0 : 0));
    }
}
