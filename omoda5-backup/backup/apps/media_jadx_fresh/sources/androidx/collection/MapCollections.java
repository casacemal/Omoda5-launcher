...
abstract class MapCollections<K, V> {
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean addAll(Collection<? extends Map.Entry<K, V>> collection) {
            int r0 = MapCollections.this.colGetSize();
            for (Map.Entry<K, V> entry : collection) {
                MapCollections.this.colPut(entry.getKey(), entry.getValue());
            }
            return r0 != MapCollections.this.colGetSize();
        }
        ...
        public boolean contains(Object obj) {
            ...
            Map.Entry entry = (Map.Entry) obj;
            int r0 = MapCollections.this.colIndexOfKey(entry.getKey());
            if (r0 < 0) {
                return false;
            }
            return ContainerHelpers.equal(MapCollections.this.colGetEntry(r0, 1), entry.getValue());
        }
        ...
        public int hashCode() {
            int r3 = 0;
            for (int r0 = MapCollections.this.colGetSize() - 1; r0 >= 0; r0--) {
                Object objColGetEntry = MapCollections.this.colGetEntry(r0, 0);
                Object objColGetEntry2 = MapCollections.this.colGetEntry(r0, 1);
                r3 += (objColGetEntry == null ? 0 : objColGetEntry.hashCode()) ^ (objColGetEntry2 == null ? 0 : objColGetEntry2.hashCode());
            }
            return r3;
        }
    }
    ...
    final class KeySet implements Set<K> {
        ...
        @Override // java.util.Set, java.util.Collection
        public boolean remove(Object obj) {
            int r2 = MapCollections.this.colIndexOfKey(obj);
            if (r2 < 0) {
                return false;
            }
            MapCollections.this.colRemoveAt(r2);
            return true;
        }
        ...
        public int hashCode() {
            ...
            for (int r0 = MapCollections.this.colGetSize() - 1; r0 >= 0; r0--) {
                Object objColGetEntry = MapCollections.this.colGetEntry(r0, 0);
                r2 += objColGetEntry == null ? 0 : objColGetEntry.hashCode();
            }
            return r2;
        }
    }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        @Override // java.util.Collection
        public boolean remove(Object obj) {
            int r2 = MapCollections.this.colIndexOfValue(obj);
            if (r2 < 0) {
                return false;
            }
            MapCollections.this.colRemoveAt(r2);
