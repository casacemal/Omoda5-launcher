...
class DocumentsContractApi19 {
    ...
    public static boolean canWrite(Context context, Uri uri) {
        ...
        String rawType = getRawType(context, uri);
        int r4 = queryForInt(context, uri, "flags", 0);
        ...
        if (!"vnd.android.document/directory".equals(rawType) || (r4 & 8) == 0) {
            return (TextUtils.isEmpty(rawType) || (r4 & 2) == 0) ? false : true;
        }
        return true;
    }
    ...
    private static int queryForInt(Context context, Uri uri, String str, int r5) {
        return (int) queryForLong(context, uri, str, r5);
    }
