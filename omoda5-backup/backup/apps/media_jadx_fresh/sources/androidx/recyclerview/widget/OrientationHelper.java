...
public abstract class OrientationHelper {
    ...
    public abstract void offsetChild(View view, int r2);
    ...
    public static OrientationHelper createHorizontalHelper(RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) { // from class: androidx.recyclerview.widget.OrientationHelper.1
            ...
            @Override // androidx.recyclerview.widget.OrientationHelper
            public void offsetChildren(int r1) {
                this.mLayoutManager.offsetChildrenHorizontal(r1);
            }
            ...
            @Override // androidx.recyclerview.widget.OrientationHelper
            public void offsetChild(View view, int r2) {
    ...
    public static OrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) { // from class: androidx.recyclerview.widget.OrientationHelper.2
            ...
            @Override // androidx.recyclerview.widget.OrientationHelper
            public void offsetChildren(int r1) {
                this.mLayoutManager.offsetChildrenVertical(r1);
            }
