...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class ViewCacheExtension {
        public abstract View getViewForPositionAndType(Recycler recycler, int r2, int r3);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0366R.attr.recyclerViewStyle);
    }

    public RecyclerView(Context context, AttributeSet attributeSet, int r15) throws NoSuchMethodException, SecurityException {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0366R.styleable.RecyclerView, r15, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0366R.styleable.RecyclerView, attributeSet, typedArrayObtainStyledAttributes, r15, 0);
        }
        String string = typedArrayObtainStyledAttributes.getString(C0366R.styleable.RecyclerView_layoutManager);
        if (typedArrayObtainStyledAttributes.getInt(C0366R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(C0366R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C0366R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0366R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0366R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0366R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0366R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        typedArrayObtainStyledAttributes.recycle();
        createLayoutManager(context, string, attributeSet, r15, 0);
        if (Build.VERSION.SDK_INT >= 21) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, NESTED_SCROLLING_ATTRS, r15, 0);
            if (Build.VERSION.SDK_INT >= 29) {
                saveAttributeDataForStyleable(context, NESTED_SCROLLING_ATTRS, attributeSet, typedArrayObtainStyledAttributes2, r15, 0);
            }
    ...
    private void createLayoutManager(Context context, String str, AttributeSet attributeSet, int r11, int r12) throws NoSuchMethodException, SecurityException {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.5
            ...
            @Override // androidx.recyclerview.widget.ChildHelper.Callback
            public View getChildAt(int r1) {
                return RecyclerView.this.getChildAt(r1);
            }
            ...
            @Override // androidx.recyclerview.widget.ChildHelper.Callback
            public void attachViewToParent(View view, int r4, ViewGroup.LayoutParams layoutParams) {
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.6
            ...
            public ViewHolder findViewHolder(int r3) {
                ViewHolder viewHolderFindViewHolderForPosition = RecyclerView.this.findViewHolderForPosition(r3, true);
            ...
            public void offsetPositionsForRemovingInvisible(int r3, int r4) {
                RecyclerView.this.offsetPositionRecordsForRemove(r3, r4, true);
                RecyclerView.this.mItemsAddedOrRemoved = true;
                RecyclerView.this.mState.mDeletedInvisibleItemCountSincePreviousLayout += r4;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int r3, int r4) {
                RecyclerView.this.offsetPositionRecordsForRemove(r3, r4, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int r2, int r3, Object obj) {
                RecyclerView.this.viewRangeUpdate(r2, r3, obj);
            ...
            public void offsetPositionsForAdd(int r2, int r3) {
                RecyclerView.this.offsetPositionRecordsForInsert(r2, r3);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int r2, int r3) {
                RecyclerView.this.offsetPositionRecordsForMove(r2, r3);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
        });
    }
    ...
    public void setItemViewCacheSize(int r1) {
        this.mRecycler.setViewCacheSize(r1);
    }
    ...
    public ItemDecoration getItemDecorationAt(int r3) {
        int itemDecorationCount = getItemDecorationCount();
        if (r3 < 0 || r3 >= itemDecorationCount) {
            throw new IndexOutOfBoundsException(r3 + " is an invalid index for size " + itemDecorationCount);
        }
        return this.mItemDecorations.get(r3);
    }
    ...
    public void removeItemDecorationAt(int r3) {
        int itemDecorationCount = getItemDecorationCount();
        if (r3 < 0 || r3 >= itemDecorationCount) {
            throw new IndexOutOfBoundsException(r3 + " is an invalid index for size " + itemDecorationCount);
        }
        removeItemDecoration(getItemDecorationAt(r3));
    }
    ...
    void scrollStep(int r5, int r6, int[] r7) {
        ...
        int r52 = r5 != 0 ? this.mLayout.scrollHorizontallyBy(r5, this.mRecycler, this.mState) : 0;
    ...
    boolean scrollByInternal(int r19, int r20, MotionEvent motionEvent) {
        int r14;
        int r15;
        int r16;
        int r17;
        ...
        r7[0] = 0;
        r7[1] = 0;
        dispatchNestedScroll(r15, r14, r16, r17, this.mScrollOffset, 0, r7);
        int[] r04 = this.mReusableIntPair;
        int r12 = r16 - r04[0];
        int r2 = r17 - r04[1];
        boolean z = (r04[0] == 0 && r04[1] == 0) ? false : true;
        int r3 = this.mLastTouchX;
        int[] r4 = this.mScrollOffset;
        this.mLastTouchX = r3 - r4[0];
        this.mLastTouchY -= r4[1];
        int[] r32 = this.mNestedOffsets;
        r32[0] = r32[0] + r4[0];
        r32[1] = r32[1] + r4[1];
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                pullGlows(motionEvent.getX(), r12, motionEvent.getY(), r2);
            }
        ...
        return (!z && r15 == 0 && r14 == 0) ? false : true;
    }
    ...
    void smoothScrollBy(int r4, int r5, Interpolator interpolator, int r7, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
        ...
        if (r7 == Integer.MIN_VALUE || r7 > 0) {
            ...
            this.mViewFlinger.smoothScrollBy(r4, r5, r7, interpolator);
            return;
        }
        scrollBy(r4, r5);
    }
    ...
    public boolean fling(int r8, int r9) {
        ...
        boolean zCanScrollHorizontally = layoutManager.canScrollHorizontally();
        boolean zCanScrollVertically = this.mLayout.canScrollVertically();
        if (!zCanScrollHorizontally || Math.abs(r8) < this.mMinFlingVelocity) {
            r8 = 0;
        }
        if (!zCanScrollVertically || Math.abs(r9) < this.mMinFlingVelocity) {
            r9 = 0;
        }
        if (r8 == 0 && r9 == 0) {
            return false;
        ...
        if (!dispatchNestedPreFling(f, f2)) {
            ...
            if (onFlingListener != null && onFlingListener.onFling(r8, r9)) {
                return true;
            }
            if (z) {
                int r1 = zCanScrollHorizontally ? 1 : 0;
                if (zCanScrollVertically) {
                    r1 |= 2;
                }
                startNestedScroll(r1, 1);
                int r0 = this.mMaxFlingVelocity;
                int r82 = Math.max(-r0, Math.min(r8, r0));
                int r02 = this.mMaxFlingVelocity;
                this.mViewFlinger.fling(r82, Math.max(-r02, Math.min(r9, r02)));
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public View focusSearch(View view, int r10) {
        ...
        if (z2 && (r10 == 2 || r10 == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int r0 = r10 == 2 ? 130 : 33;
                z = focusFinder.findNextFocus(this, view, r0) == null;
            ...
            if (!z && this.mLayout.canScrollHorizontally()) {
                int r02 = (this.mLayout.getLayoutDirection() == 1) ^ (r10 == 2) ? 66 : 17;
                boolean z3 = focusFinder.findNextFocus(this, view, r02) == null;
                if (FORCE_ABS_FOCUS_SEARCH_DIRECTION) {
                    r10 = r02;
                }
                z = z3;
    ...
    private boolean isPreferredNextFocus(View view, View view2, int r8) {
        int r2;
        ...
        char c = 65535;
        int r6 = this.mLayout.getLayoutDirection() == 1 ? -1 : 1;
        if ((this.mTempRect.left < this.mTempRect2.left || this.mTempRect.right <= this.mTempRect2.left) && this.mTempRect.right < this.mTempRect2.right) {
            r2 = 1;
        } else {
            r2 = ((this.mTempRect.right > this.mTempRect2.right || this.mTempRect.left >= this.mTempRect2.right) && this.mTempRect.left > this.mTempRect2.left) ? -1 : 0;
        }
        ...
        throw new IllegalArgumentException("Invalid direction: " + r8 + exceptionLabel());
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            r9[1] = 0;
            r9[0] = 0;
            int r92 = zCanScrollHorizontally ? 1 : 0;
            if (zCanScrollVertically) {
                r92 |= 2;
            }
            ...
            int r4 = motionEvent.findPointerIndex(this.mScrollPointerId);
            if (r4 < 0) {
                Log.e(TAG, "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?");
                return false;
            }
            int x2 = (int) (motionEvent.getX(r4) + 0.5f);
            int y2 = (int) (motionEvent.getY(r4) + 0.5f);
            if (this.mScrollState != 1) {
                int r42 = x2 - this.mInitialTouchX;
                int r6 = y2 - this.mInitialTouchY;
                if (!zCanScrollHorizontally || Math.abs(r42) <= this.mTouchSlop) {
                    z = false;
                } else {
                    this.mLastTouchX = x2;
                    z = true;
    ...
    */
    ...
    void defaultOnMeasure(int r3, int r4) {
        setMeasuredDimension(LayoutManager.chooseSize(r3, getPaddingLeft() + getPaddingRight(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(r4, getPaddingTop() + getPaddingBottom(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        AccessibilityEventCompat.setContentChangeTypes(accessibilityEventObtain, r0);
    ...
    private View findNextViewToFocus() {
        ...
        int r0 = this.mState.mFocusedItemPosition != -1 ? this.mState.mFocusedItemPosition : 0;
        int itemCount = this.mState.getItemCount();
        for (int r2 = r0; r2 < itemCount; r2++) {
            ViewHolder viewHolderFindViewHolderForAdapterPosition2 = findViewHolderForAdapterPosition(r2);
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (int r0 = 0; r0 < this.mChildHelper.getChildCount(); r0++) {
                ...
                if (!childViewHolderInt2.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(childViewHolderInt2)) {
                    int r3 = ItemAnimator.buildAdapterChangeFlagsForAnimations(childViewHolderInt2);
                    boolean zHasAnyOfTheFlags = childViewHolderInt2.hasAnyOfTheFlags(8192);
                    if (!zHasAnyOfTheFlags) {
                        r3 |= 4096;
                    }
                    ItemAnimator.ItemHolderInfo itemHolderInfoRecordPreLayoutInformation = this.mItemAnimator.recordPreLayoutInformation(this.mState, childViewHolderInt2, r3, childViewHolderInt2.getUnmodifiedPayloads());
                    if (zHasAnyOfTheFlags) {
    ...
    private void dispatchLayoutStep3() {
        ...
        stopInterceptRequestLayout(false);
        this.mViewInfoStore.clear();
        int[] r2 = this.mMinMaxLayoutPositions;
        if (didChildRangeChange(r2[0], r2[1])) {
    ...
    private boolean didChildRangeChange(int r4, int r5) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        int[] r3 = this.mMinMaxLayoutPositions;
        return (r3[0] == r4 && r3[1] == r5) ? false : true;
    }
    ...
    void markItemDecorInsetsDirty() {
        ...
        for (int r1 = 0; r1 < unfilteredChildCount; r1++) {
            ((LayoutParams) this.mChildHelper.getUnfilteredChildAt(r1).getLayoutParams()).mInsetsDirty = true;
        }
    ...
    public void draw(Canvas canvas) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            this.mItemDecorations.get(r2).onDrawOver(canvas, this, this.mState);
        }
        EdgeEffect edgeEffect = this.mLeftGlow;
    ...
    public void onDraw(Canvas canvas) {
        ...
        int size = this.mItemDecorations.size();
        for (int r1 = 0; r1 < size; r1++) {
            this.mItemDecorations.get(r1).onDraw(canvas, this, this.mState);
        }
    }
    ...
    void offsetPositionRecordsForMove(int r10, int r11) {
        ...
        for (int r6 = 0; r6 < unfilteredChildCount; r6++) {
            ...
            if (childViewHolderInt != null && childViewHolderInt.mPosition >= r3 && childViewHolderInt.mPosition <= r4) {
                if (childViewHolderInt.mPosition == r10) {
                    childViewHolderInt.offsetPosition(r11 - r10, false);
                } else {
                    childViewHolderInt.offsetPosition(r2, false);
                }
                this.mState.mStructureChanged = true;
            }
        }
        this.mRecycler.offsetPositionRecordsForMove(r10, r11);
        requestLayout();
    }
    ...
    void offsetPositionRecordsForInsert(int r6, int r7) {
        ...
        for (int r2 = 0; r2 < unfilteredChildCount; r2++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= r6) {
                childViewHolderInt.offsetPosition(r7, false);
                this.mState.mStructureChanged = true;
            }
        }
        this.mRecycler.offsetPositionRecordsForInsert(r6, r7);
        requestLayout();
    }

    void offsetPositionRecordsForRemove(int r8, int r9, boolean z) {
        int r0 = r8 + r9;
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        for (int r2 = 0; r2 < unfilteredChildCount; r2++) {
            ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(r2));
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                if (childViewHolderInt.mPosition >= r0) {
                    childViewHolderInt.offsetPosition(-r9, z);
                    this.mState.mStructureChanged = true;
                } else if (childViewHolderInt.mPosition >= r8) {
                    childViewHolderInt.flagRemovedAndOffsetPosition(r8 - 1, -r9, z);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(r8, r9, z);
        requestLayout();
    }

    void viewRangeUpdate(int r7, int r8, Object obj) {
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        int r1 = r7 + r8;
        for (int r2 = 0; r2 < unfilteredChildCount; r2++) {
            View unfilteredChildAt = this.mChildHelper.getUnfilteredChildAt(r2);
            ViewHolder childViewHolderInt = getChildViewHolderInt(unfilteredChildAt);
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= r7 && childViewHolderInt.mPosition < r1) {
                childViewHolderInt.addFlags(2);
                childViewHolderInt.addChangePayload(obj);
                ((LayoutParams) unfilteredChildAt.getLayoutParams()).mInsetsDirty = true;
            }
        }
        this.mRecycler.viewRangeUpdate(r7, r8);
    }
    ...
    public ViewHolder findViewHolderForAdapterPosition(int r6) {
        ...
        for (int r2 = 0; r2 < unfilteredChildCount; r2++) {
            ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(r2));
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && getAdapterPositionFor(childViewHolderInt) == r6) {
    ...
    */
    ...
    Rect getItemDecorInsetsForChild(View view) {
        ...
        for (int r4 = 0; r4 < size; r4++) {
            ...
            this.mItemDecorations.get(r4).getItemOffsets(this.mTempRect, view, this, this.mState);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int r13 = currY - this.mLastFlingY;
                this.mLastFlingX = currX;
                this.mLastFlingY = currY;
                RecyclerView.this.mReusableIntPair[0] = 0;
                RecyclerView.this.mReusableIntPair[1] = 0;
                RecyclerView recyclerView = RecyclerView.this;
                if (recyclerView.dispatchNestedPreScroll(r6, r13, recyclerView.mReusableIntPair, null, 1)) {
                    r6 -= RecyclerView.this.mReusableIntPair[0];
                    r13 -= RecyclerView.this.mReusableIntPair[1];
                }
                if (RecyclerView.this.getOverScrollMode() != 2) {
                    RecyclerView.this.considerReleasingGlowsOnScroll(r6, r13);
                }
                if (RecyclerView.this.mAdapter != null) {
                    RecyclerView.this.mReusableIntPair[0] = 0;
                    RecyclerView.this.mReusableIntPair[1] = 0;
                    RecyclerView recyclerView2 = RecyclerView.this;
                    recyclerView2.scrollStep(r6, r13, recyclerView2.mReusableIntPair);
                    r4 = RecyclerView.this.mReusableIntPair[0];
                    r7 = RecyclerView.this.mReusableIntPair[1];
                    r6 -= r4;
                    r13 -= r7;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(r4, r7);
                        } else {
                            smoothScroller.onAnimation(r4, r7);
                        }
                    }
                ...
                recyclerView3.dispatchNestedScroll(r4, r7, r6, r13, null, 1, recyclerView3.mReusableIntPair);
                int r62 = r6 - RecyclerView.this.mReusableIntPair[0];
                int r132 = r13 - RecyclerView.this.mReusableIntPair[1];
                if (r4 != 0 || r7 != 0) {
                    RecyclerView.this.dispatchOnScrolled(r4, r7);
                }
                ...
                if (!(smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) && z) {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
                        ...
                        int r42 = r62 < 0 ? -currVelocity : r62 > 0 ? currVelocity : 0;
                        if (r132 < 0) {
                            currVelocity = -currVelocity;
                        } else if (r132 <= 0) {
                            currVelocity = 0;
                        }
                        RecyclerView.this.absorbGlows(r42, currVelocity);
                    }
                    ...
                    if (RecyclerView.this.mGapWorker != null) {
                        RecyclerView.this.mGapWorker.postFromTraversal(RecyclerView.this, r4, r7);
                    }
                }
            }
        ...
        public void fling(int r13, int r14) {
            ...
            this.mOverScroller.fling(0, 0, r13, r14, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
            postOnAnimation();
        }

        public void smoothScrollBy(int r8, int r9, int r10, Interpolator interpolator) {
            if (r10 == Integer.MIN_VALUE) {
                r10 = computeScrollDuration(r8, r9, 0, 0);
            }
            int r6 = r10;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, r8, r9, r6);
        ...
        private int computeScrollDuration(int r5, int r6, int r7, int r8) {
            ...
            int r52 = (int) Math.sqrt((r5 * r5) + (r6 * r6));
            RecyclerView recyclerView = RecyclerView.this;
            int width = z ? recyclerView.getWidth() : recyclerView.getHeight();
            int r82 = width / 2;
            float f = width;
            float f2 = r82;
            float fDistanceInfluenceForSnapDuration = f2 + (distanceInfluenceForSnapDuration(Math.min(1.0f, (r52 * 1.0f) / f)) * f2);
            if (r72 > 0) {
                r4 = Math.round(Math.abs(fDistanceInfluenceForSnapDuration / r72) * 1000.0f) * 4;
            } else {
                if (!z) {
                    r0 = r1;
                }
                r4 = (int) (((r0 / f) + 1.0f) * 300.0f);
            }
            return Math.min(r4, RecyclerView.MAX_SCROLL_DURATION);
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int r3, int r4, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(r3, r4, obj)) {
        ...
        public void onItemRangeInserted(int r3, int r4) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(r3, r4)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int r3, int r4) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(r3, r4)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int r3, int r4, int r5) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(r3, r4, r5)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static class EdgeEffectFactory {
        ...
        protected EdgeEffect createEdgeEffect(RecyclerView recyclerView, int r2) {
    ...
    public static class RecycledViewPool {
        ...
        public void clear() {
            for (int r0 = 0; r0 < this.mScrap.size(); r0++) {
                this.mScrap.valueAt(r0).mScrapHeap.clear();
            }
        }

        public void setMaxRecycledViews(int r1, int r2) {
            ScrapData scrapDataForType = getScrapDataForType(r1);
            scrapDataForType.mMaxScrap = r2;
        ...
        public int getRecycledViewCount(int r1) {
            return getScrapDataForType(r1).mScrapHeap.size();
        }

        public ViewHolder getRecycledView(int r2) {
            ScrapData scrapData = this.mScrap.get(r2);
        ...
        int size() {
            int size = 0;
            for (int r0 = 0; r0 < this.mScrap.size(); r0++) {
                ArrayList<ViewHolder> arrayList = this.mScrap.valueAt(r0).mScrapHeap;
                if (arrayList != null) {
                    size += arrayList.size();
                }
            }
        ...
        void factorInCreateTime(int r3, long j) {
            ScrapData scrapDataForType = getScrapDataForType(r3);
            scrapDataForType.mCreateRunningAverageNs = runningAverage(scrapDataForType.mCreateRunningAverageNs, j);
        }

        void factorInBindTime(int r3, long j) {
            ScrapData scrapDataForType = getScrapDataForType(r3);
            scrapDataForType.mBindRunningAverageNs = runningAverage(scrapDataForType.mBindRunningAverageNs, j);
        }

        boolean willCreateInTime(int r3, long j, long j2) {
            long j3 = getScrapDataForType(r3).mCreateRunningAverageNs;
            return j3 == 0 || j + j3 < j2;
        }

        boolean willBindInTime(int r3, long j, long j2) {
            long j3 = getScrapDataForType(r3).mBindRunningAverageNs;
            return j3 == 0 || j + j3 < j2;
        }
        ...
        private ScrapData getScrapDataForType(int r2) {
            ScrapData scrapData = this.mScrap.get(r2);
            if (scrapData != null) {
                return scrapData;
            }
            ScrapData scrapData2 = new ScrapData();
            this.mScrap.put(r2, scrapData2);
            return scrapData2;
        }
    }
    ...
    static RecyclerView findNestedRecyclerView(View view) {
        ...
        for (int r2 = 0; r2 < childCount; r2++) {
            RecyclerView recyclerViewFindNestedRecyclerView = findNestedRecyclerView(viewGroup.getChildAt(r2));
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder viewHolder, int r11, int r12, long j) {
            ...
            RecyclerView.this.mAdapter.bindViewHolder(viewHolder, r11);
            this.mRecyclerPool.factorInBindTime(viewHolder.getItemViewType(), RecyclerView.this.getNanoTime() - nanoTime);
            attachAccessibilityDelegateOnBind(viewHolder);
            if (!RecyclerView.this.mState.isPreLayout()) {
                return true;
            }
            viewHolder.mPreLayoutPosition = r12;
            return true;
        }

        public void bindViewToPosition(View view, int r8) {
            LayoutParams layoutParams;
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter" + RecyclerView.this.exceptionLabel());
            }
            int r2 = RecyclerView.this.mAdapterHelper.findPositionOffset(r8);
            if (r2 < 0 || r2 >= RecyclerView.this.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + r8 + "(offset:" + r2 + ").state:" + RecyclerView.this.mState.getItemCount() + RecyclerView.this.exceptionLabel());
            }
            tryBindViewHolderByDeadline(childViewHolderInt, r2, r8, RecyclerView.FOREVER_NS);
        ...
        public int convertPreLayoutPositionToPostLayout(int r4) {
            if (r4 >= 0 && r4 < RecyclerView.this.mState.getItemCount()) {
                return !RecyclerView.this.mState.isPreLayout() ? r4 : RecyclerView.this.mAdapterHelper.findPositionOffset(r4);
            }
            throw new IndexOutOfBoundsException("invalid position " + r4 + ". State item count is " + RecyclerView.this.mState.getItemCount() + RecyclerView.this.exceptionLabel());
        }

        public View getViewForPosition(int r2) {
            return getViewForPosition(r2, false);
        }

        View getViewForPosition(int r3, boolean z) {
            return tryGetViewHolderForPositionByDeadline(r3, z, RecyclerView.FOREVER_NS).itemView;
        }
        ...
        */
        ...
        void recycleCachedViewAt(int r3) {
            addViewHolderToRecycledViewPool(this.mCachedViews.get(r3), true);
            this.mCachedViews.remove(r3);
        }
            ...
            if ((RecyclerView.this.mAdapter != null && zDoesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(526)) {
                    ...
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK && size > 0 && !RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(viewHolder.mPosition)) {
                        int r3 = size - 1;
                        while (r3 >= 0) {
                            if (!RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(this.mCachedViews.get(r3).mPosition)) {
                                break;
                            } else {
                                r3--;
                            }
        ...
        View getScrapViewAt(int r1) {
            return this.mAttachedScrap.get(r1).itemView;
        }
        ...
        ViewHolder getChangedScrapViewForPosition(int r10) {
            int size;
            int r102;
            ArrayList<ViewHolder> arrayList = this.mChangedScrap;
            if (arrayList != null && (size = arrayList.size()) != 0) {
                for (int r3 = 0; r3 < size; r3++) {
                    ViewHolder viewHolder = this.mChangedScrap.get(r3);
                ...
                if (RecyclerView.this.mAdapter.hasStableIds() && (r102 = RecyclerView.this.mAdapterHelper.findPositionOffset(r10)) > 0 && r102 < RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    for (int r2 = 0; r2 < size; r2++) {
                        ViewHolder viewHolder2 = this.mChangedScrap.get(r2);
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int r6, boolean z) {
            View viewFindHiddenNonRemovedView;
            int size = this.mAttachedScrap.size();
            for (int r2 = 0; r2 < size; r2++) {
                ViewHolder viewHolder = this.mAttachedScrap.get(r2);
            ...
            if (!z && (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(r6)) != null) {
                ...
                int r7 = RecyclerView.this.mChildHelper.indexOfChild(viewFindHiddenNonRemovedView);
                if (r7 == -1) {
                    throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + childViewHolderInt + RecyclerView.this.exceptionLabel());
                }
                RecyclerView.this.mChildHelper.detachViewFromParent(r7);
        ...
        ViewHolder getScrapOrCachedViewForId(long j, int r8, boolean z) {
            for (int size = this.mAttachedScrap.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mAttachedScrap.get(size);
                if (viewHolder.getItemId() == j && !viewHolder.wasReturnedFromScrap()) {
                    if (r8 == viewHolder.getItemViewType()) {
                        viewHolder.addFlags(32);
            ...
            while (true) {
                ...
                if (viewHolder2.getItemId() == j && !viewHolder2.isAttachedToTransitionOverlay()) {
                    if (r8 == viewHolder2.getItemViewType()) {
                        if (!z) {
        ...
        void offsetPositionRecordsForMove(int r9, int r10) {
            ...
            for (int r5 = 0; r5 < size; r5++) {
                ViewHolder viewHolder = this.mCachedViews.get(r5);
                if (viewHolder != null && viewHolder.mPosition >= r1 && viewHolder.mPosition <= r2) {
                    if (viewHolder.mPosition == r9) {
                        viewHolder.offsetPosition(r10 - r9, false);
                    } else {
                        viewHolder.offsetPosition(r0, false);
                    }
                }
            }
        }
        ...
        void offsetPositionRecordsForInsert(int r5, int r6) {
            int size = this.mCachedViews.size();
            for (int r1 = 0; r1 < size; r1++) {
                ViewHolder viewHolder = this.mCachedViews.get(r1);
                if (viewHolder != null && viewHolder.mPosition >= r5) {
                    viewHolder.offsetPosition(r6, true);
                }
            }
        }

        void offsetPositionRecordsForRemove(int r5, int r6, boolean z) {
            int r0 = r5 + r6;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null) {
                    if (viewHolder.mPosition >= r0) {
                        viewHolder.offsetPosition(-r6, z);
                    } else if (viewHolder.mPosition >= r5) {
        ...
        void viewRangeUpdate(int r4, int r5) {
            ...
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (r2 = viewHolder.mPosition) >= r4 && r2 < r52) {
        ...
        void clearOldPositions() {
            int size = this.mCachedViews.size();
            for (int r2 = 0; r2 < size; r2++) {
                this.mCachedViews.get(r2).clearOldPosition();
            }
            int size2 = this.mAttachedScrap.size();
            for (int r22 = 0; r22 < size2; r22++) {
                this.mAttachedScrap.get(r22).clearOldPosition();
            }
            ArrayList<ViewHolder> arrayList = this.mChangedScrap;
            if (arrayList != null) {
                int size3 = arrayList.size();
                for (int r1 = 0; r1 < size3; r1++) {
                    this.mChangedScrap.get(r1).clearOldPosition();
                }
            }
        }
        ...
        void markItemDecorInsetsDirty() {
            int size = this.mCachedViews.size();
            for (int r1 = 0; r1 < size; r1++) {
                LayoutParams layoutParams = (LayoutParams) this.mCachedViews.get(r1).itemView.getLayoutParams();
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int r3) {
            try {
                TraceCompat.beginSection(RecyclerView.TRACE_CREATE_VIEW_TAG);
                VH vh = (VH) onCreateViewHolder(viewGroup, r3);
        ...
        public final void bindViewHolder(VH vh, int r4) {
            vh.mPosition = r4;
            if (hasStableIds()) {
                vh.mItemId = getItemId(r4);
            }
            vh.setFlags(1, 519);
            TraceCompat.beginSection(RecyclerView.TRACE_BIND_VIEW_TAG);
            onBindViewHolder(vh, r4, vh.getUnmodifiedPayloads());
            vh.clearPayload();
        ...
        public final void notifyItemChanged(int r2) {
            this.mObservable.notifyItemRangeChanged(r2, 1);
        }

        public final void notifyItemChanged(int r2, Object obj) {
            this.mObservable.notifyItemRangeChanged(r2, 1, obj);
        }

        public final void notifyItemRangeChanged(int r1, int r2) {
            this.mObservable.notifyItemRangeChanged(r1, r2);
        }

        public final void notifyItemRangeChanged(int r1, int r2, Object obj) {
            this.mObservable.notifyItemRangeChanged(r1, r2, obj);
        }

        public final void notifyItemInserted(int r2) {
            this.mObservable.notifyItemRangeInserted(r2, 1);
        }

        public final void notifyItemMoved(int r1, int r2) {
            this.mObservable.notifyItemMoved(r1, r2);
        }

        public final void notifyItemRangeInserted(int r1, int r2) {
            this.mObservable.notifyItemRangeInserted(r1, r2);
        }

        public final void notifyItemRemoved(int r2) {
            this.mObservable.notifyItemRangeRemoved(r2, 1);
        }

        public final void notifyItemRangeRemoved(int r1, int r2) {
            this.mObservable.notifyItemRangeRemoved(r1, r2);
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.1
            ...
            public View getChildAt(int r1) {
                return LayoutManager.this.getChildAt(r1);
            }
        ...
        void setMeasuredDimensionFromChildren(int r9, int r10) {
            ...
            this.mRecyclerView.mTempRect.set(r4, r5, r2, r3);
            setMeasuredDimension(this.mRecyclerView.mTempRect, r9, r10);
        }

        public void setMeasuredDimension(Rect rect, int r4, int r5) {
            setMeasuredDimension(chooseSize(r4, rect.width() + getPaddingLeft() + getPaddingRight(), getMinimumWidth()), chooseSize(r5, rect.height() + getPaddingTop() + getPaddingBottom(), getMinimumHeight()));
        }
        ...
        public static int chooseSize(int r2, int r3, int r4) {
            ...
            if (mode != Integer.MIN_VALUE) {
                return mode != 1073741824 ? Math.max(r3, r4) : size;
            }
        ...
        private void addViewInt(View view, int r6, boolean z) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                int r1 = this.mChildHelper.indexOfChild(view);
                if (r6 == -1) {
                ...
                if (r1 != r6) {
                    this.mRecyclerView.mLayout.moveView(r1, r6);
                }
            } else {
        ...
        public void detachView(View view) {
            int r0 = this.mChildHelper.indexOfChild(view);
            if (r0 >= 0) {
        ...
        public void attachView(View view, int r4, LayoutParams layoutParams) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            ...
            this.mChildHelper.attachViewToParent(view, r4, layoutParams, childViewHolderInt.isRemoved());
        }
        ...
        public View getChildAt(int r1) {
            ChildHelper childHelper = this.mChildHelper;
            if (childHelper != null) {
                return childHelper.getChildAt(r1);
            }
            return null;
        }
        ...
        public void offsetChildrenHorizontal(int r1) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
                recyclerView.offsetChildrenHorizontal(r1);
            }
        }

        public void offsetChildrenVertical(int r1) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
                recyclerView.offsetChildrenVertical(r1);
            }
        }
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int r1 = scrapCount - 1; r1 >= 0; r1--) {
                View scrapViewAt = recycler.getScrapViewAt(r1);
        ...
        public void measureChild(View view, int r7, int r8) {
            ...
            int r72 = r7 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
            int r82 = r8 + itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + r72, layoutParams.width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + r82, layoutParams.height, canScrollVertically());
            if (shouldMeasureChild(view, childMeasureSpec, childMeasureSpec2, layoutParams)) {
                view.measure(childMeasureSpec, childMeasureSpec2);
            }
        }

        boolean shouldReMeasureChild(View view, int r3, int r4, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), r3, layoutParams.width) && isMeasurementUpToDate(view.getMeasuredHeight(), r4, layoutParams.height)) ? false : true;
        }

        boolean shouldMeasureChild(View view, int r3, int r4, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), r3, layoutParams.width) && isMeasurementUpToDate(view.getHeight(), r4, layoutParams.height)) ? false : true;
        }
        ...
        public void measureChildWithMargins(View view, int r7, int r8) {
            ...
            int r72 = r7 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
            int r82 = r8 + itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin + r72, layoutParams.width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + layoutParams.topMargin + layoutParams.bottomMargin + r82, layoutParams.height, canScrollVertically());
            if (shouldMeasureChild(view, childMeasureSpec, childMeasureSpec2, layoutParams)) {
                view.measure(childMeasureSpec, childMeasureSpec2);
            }
        }
        ...
        */
        ...
        public void layoutDecorated(View view, int r3, int r4, int r5, int r6) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(r3 + rect.left, r4 + rect.top, r5 - rect.right, r6 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(View view, int r4, int r5, int r6, int r7) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect rect = layoutParams.mDecorInsets;
            view.layout(r4 + rect.left + layoutParams.leftMargin, r5 + rect.top + layoutParams.topMargin, (r6 - rect.right) - layoutParams.rightMargin, (r7 - rect.bottom) - layoutParams.bottomMargin);
        }
        ...
        private int[] getChildRectangleOnScreenScrollAmount(View view, Rect rect) {
            ...
            int r9 = rect.width() + left;
            int r10 = rect.height() + top;
            int r5 = left - paddingLeft;
            int r7 = Math.min(0, r5);
            int r6 = top - paddingTop;
            int r2 = Math.min(0, r6);
            int r92 = r9 - width;
            int r3 = Math.max(0, r92);
            int r102 = Math.max(0, r10 - height);
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int r8, int r9) {
            ...
            return rect.left - r8 < width && rect.right - r8 > paddingLeft && rect.top - r9 < height && rect.bottom - r9 > paddingTop;
        }
        ...
        public void setMeasuredDimension(int r1, int r2) {
            this.mRecyclerView.setMeasuredDimension(r1, r2);
        }
        ...
        boolean performAccessibilityAction(int r3, Bundle bundle) {
            return performAccessibilityAction(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, r3, bundle);
        }
        ...
        boolean performAccessibilityActionForItem(View view, int r9, Bundle bundle) {
            return performAccessibilityActionForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, r9, bundle);
        }

        public static Properties getProperties(Context context, AttributeSet attributeSet, int r4, int r5) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0366R.styleable.RecyclerView, r4, r5);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0366R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0366R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0366R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0366R.styleable.RecyclerView_stackFromEnd, false);
            typedArrayObtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public static abstract class ItemDecoration {
        ...
        @Deprecated
        public void getItemOffsets(Rect rect, int r2, RecyclerView recyclerView) {
            rect.set(0, 0, 0, 0);
        }
    ...
    public static abstract class ViewHolder {
        ...
        void flagRemovedAndOffsetPosition(int r2, int r3, boolean z) {
            addFlags(8);
            offsetPosition(r3, z);
            this.mPosition = r2;
        }

        void offsetPosition(int r3, boolean z) {
        ...
        boolean hasAnyOfTheFlags(int r1) {
            return (this.mFlags & r1) != 0;
        }
    ...
    boolean setChildImportantForAccessibilityInternal(ViewHolder viewHolder, int r3) {
        if (isComputingLayout()) {
            viewHolder.mPendingAccessibilityState = r3;
            this.mPendingAccessibilityImportanceChange.add(viewHolder);
            return false;
        }
        ViewCompat.setImportantForAccessibility(viewHolder.itemView, r3);
        return true;
    }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        ...
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore() && (r2 = viewHolder.mPendingAccessibilityState) != -1) {
                ViewCompat.setImportantForAccessibility(viewHolder.itemView, r2);
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0366R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0366R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0366R.dimen.fastscroll_margin));
    }
    ...
    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean startNestedScroll(int r1) {
        return getScrollingChildHelper().startNestedScroll(r1);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean startNestedScroll(int r1, int r2) {
        return getScrollingChildHelper().startNestedScroll(r1, r2);
    }
    ...
    public void stopNestedScroll(int r1) {
        getScrollingChildHelper().stopNestedScroll(r1);
    }
    ...
    public boolean hasNestedScrollingParent(int r1) {
        return getScrollingChildHelper().hasNestedScrollingParent(r1);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedScroll(int r7, int r8, int r9, int r10, int[] r11) {
        return getScrollingChildHelper().dispatchNestedScroll(r7, r8, r9, r10, r11);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int r8, int r9, int r10, int r11, int[] r12, int r13) {
        return getScrollingChildHelper().dispatchNestedScroll(r8, r9, r10, r11, r12, r13);
    }

    @Override // androidx.core.view.NestedScrollingChild3
    public final void dispatchNestedScroll(int r9, int r10, int r11, int r12, int[] r13, int r14, int[] r15) {
        getScrollingChildHelper().dispatchNestedScroll(r9, r10, r11, r12, r13, r14, r15);
    }

    @Override // android.view.View, androidx.core.view.NestedScrollingChild
    public boolean dispatchNestedPreScroll(int r1, int r2, int[] r3, int[] r4) {
        return getScrollingChildHelper().dispatchNestedPreScroll(r1, r2, r3, r4);
    }
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(int r1, int r2, State state, Action action);
        ...
        public PointF computeScrollVectorForPosition(int r2) {
            ...
            if (layoutManager instanceof ScrollVectorProvider) {
                return ((ScrollVectorProvider) layoutManager).computeScrollVectorForPosition(r2);
            }
        ...
        void onAnimation(int r6, int r7) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(r6, r7, recyclerView.mState, this.mRecyclingAction);
        ...
        public View findViewByPosition(int r1) {
            return this.mRecyclerView.mLayout.findViewByPosition(r1);
        }

        @Deprecated
        public void instantScrollToPosition(int r1) {
            this.mRecyclerView.scrollToPosition(r1);
        }
        ...
        public static class Action {
            ...
            public Action(int r2, int r3, int r4, Interpolator interpolator) {
            ...
            public void update(int r1, int r2, int r3, Interpolator interpolator) {
                this.mDx = r1;
                this.mDy = r2;
                this.mDuration = r3;
                this.mInterpolator = interpolator;
    ...
    static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemRangeChanged(int r2, int r3) {
            notifyItemRangeChanged(r2, r3, null);
        }

        public void notifyItemRangeChanged(int r3, int r4, Object obj) {
            for (int size = this.mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) this.mObservers.get(size)).onItemRangeChanged(r3, r4, obj);
            }
        }

        public void notifyItemRangeInserted(int r3, int r4) {
            for (int size = this.mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) this.mObservers.get(size)).onItemRangeInserted(r3, r4);
            }
        }

        public void notifyItemRangeRemoved(int r3, int r4) {
            for (int size = this.mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) this.mObservers.get(size)).onItemRangeRemoved(r3, r4);
            }
        }

        public void notifyItemMoved(int r4, int r5) {
            for (int size = this.mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) this.mObservers.get(size)).onItemRangeMoved(r4, r5, 1);
            }
        }
    }
    ...
    public static class State {
        ...
        public void remove(int r1) {
            ...
            sparseArray.remove(r1);
        }

        public <T> T get(int r1) {
            SparseArray<Object> sparseArray = this.mData;
            if (sparseArray == null) {
                return null;
            }
            return (T) sparseArray.get(r1);
        }

        public void put(int r2, Object obj) {
            if (this.mData == null) {
                this.mData = new SparseArray<>();
            }
            this.mData.put(r2, obj);
        }
    ...
    public static abstract class ItemAnimator {
        ...
        public ItemHolderInfo recordPreLayoutInformation(State state, ViewHolder viewHolder, int r3, List<Object> list) {
        ...
        static int buildAdapterChangeFlagsForAnimations(ViewHolder viewHolder) {
            ...
            return (oldPosition == -1 || adapterPosition == -1 || oldPosition == adapterPosition) ? r0 : r0 | 2048;
        }
        ...
        public final void dispatchAnimationsFinished() {
            ...
            for (int r1 = 0; r1 < size; r1++) {
                this.mFinishedListeners.get(r1).onAnimationsFinished();
            }
        ...
        public static class ItemHolderInfo {
            ...
            public ItemHolderInfo setFrom(ViewHolder viewHolder, int r2) {
                View view = viewHolder.itemView;
    ...
    protected int getChildDrawingOrder(int r2, int r3) {
        ...
        if (childDrawingOrderCallback == null) {
            return super.getChildDrawingOrder(r2, r3);
        }
        return childDrawingOrderCallback.onGetChildDrawingOrder(r2, r3);
    }
