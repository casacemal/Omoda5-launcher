...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private static class MoveInfo {
        ...
        MoveInfo(RecyclerView.ViewHolder viewHolder, int r2, int r3, int r4, int r5) {
    ...
    private static class ChangeInfo {
        ...
        ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int r3, int r4, int r5, int r6) {
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int r10, int r11, int r12, int r13) {
        ...
        int translationX = r10 + ((int) viewHolder.itemView.getTranslationX());
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int r9, int r10, int r11, int r12) {
        final View view = viewHolder.itemView;
        final int r3 = r11 - r9;
        final int r5 = r12 - r10;
        if (r3 != 0) {
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int r11, int r12, int r13, int r14) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, r11, r12, r13, r14);
        }
        float translationX = viewHolder.itemView.getTranslationX();
        float translationY = viewHolder.itemView.getTranslationY();
        float alpha = viewHolder.itemView.getAlpha();
        resetAnimation(viewHolder);
        int r3 = (int) ((r13 - r11) - translationX);
        int r4 = (int) ((r14 - r12) - translationY);
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, r11, r12, r13, r14));
        return true;
    }
