...
class ViewInfoStore {
    ...
    private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder viewHolder, int r5) {
        InfoRecord infoRecordValueAt;
        RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo;
        int r4 = this.mLayoutHolderMap.indexOfKey(viewHolder);
        if (r4 < 0 || (infoRecordValueAt = this.mLayoutHolderMap.valueAt(r4)) == null || (infoRecordValueAt.flags & r5) == 0) {
            return null;
        }
        infoRecordValueAt.flags &= ~r5;
        if (r5 == 4) {
        ...
        if ((infoRecordValueAt.flags & 12) == 0) {
            this.mLayoutHolderMap.removeAt(r4);
    ...
    void process(ProcessCallback processCallback) {
        for (int size = this.mLayoutHolderMap.size() - 1; size >= 0; size--) {
            ...
            if ((infoRecordRemoveAt.flags & 3) == 3) {
                ...
                int r1 = infoRecordRemoveAt.flags;
            }
