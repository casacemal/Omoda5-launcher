...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int r2, Bundle bundle) {
        if (super.performAccessibilityAction(view, r2, bundle)) {
            return true;
        }
        if (shouldIgnore() || this.mRecyclerView.getLayoutManager() == null) {
            return false;
        }
        return this.mRecyclerView.getLayoutManager().performAccessibilityAction(r2, bundle);
    }
    ...
    public static class ItemDelegate extends AccessibilityDelegateCompat {
        ...
        @Override // androidx.core.view.AccessibilityDelegateCompat
        public boolean performAccessibilityAction(View view, int r4, Bundle bundle) {
            if (!this.mRecyclerViewDelegate.shouldIgnore() && this.mRecyclerViewDelegate.mRecyclerView.getLayoutManager() != null) {
                AccessibilityDelegateCompat accessibilityDelegateCompat = this.mOriginalItemDelegates.get(view);
                if (accessibilityDelegateCompat != null) {
                    if (accessibilityDelegateCompat.performAccessibilityAction(view, r4, bundle)) {
                        return true;
                    }
                } else if (super.performAccessibilityAction(view, r4, bundle)) {
                    return true;
                }
                return this.mRecyclerViewDelegate.mRecyclerView.getLayoutManager().performAccessibilityActionForItem(view, r4, bundle);
            }
            return super.performAccessibilityAction(view, r4, bundle);
        }
