...
public final class DirectedAcyclicGraph<T> {
    ...
    public List<T> getOutgoingEdges(T t) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            ArrayList<T> arrayListValueAt = this.mGraph.valueAt(r2);
            if (arrayListValueAt != null && arrayListValueAt.contains(t)) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                arrayList.add(this.mGraph.keyAt(r2));
            }
        }
        return arrayList;
    }
    ...
    public void clear() {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            ArrayList<T> arrayListValueAt = this.mGraph.valueAt(r1);
    ...
    private void dfs(T t, ArrayList<T> arrayList, HashSet<T> hashSet) {
        ...
        if (arrayList2 != null) {
            ...
            for (int r1 = 0; r1 < size; r1++) {
                dfs(arrayList2.get(r1), arrayList, hashSet);
            }
        }
        hashSet.remove(t);
        arrayList.add(t);
