        ...
        synchronized (this.mReceivers) {
            ...
            if (arrayList3 != null) {
                ...
                while (r6 < arrayList3.size()) {
                    ReceiverRecord receiverRecord = arrayList3.get(r6);
                    if (z) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        arrayList2 = arrayList3;
                        str2 = strResolveTypeIfNeeded;
                        int r3 = receiverRecord.filter.match(action, strResolveTypeIfNeeded, scheme, data, categories, TAG);
                        if (r3 >= 0) {
                            if (z) {
                                Log.v(TAG, "  Filter matched!  match=0x" + Integer.toHexString(r3));
                            }
                            ...
                            Log.v(TAG, "  Filter did not match: " + (r3 != -4 ? r3 != -3 ? r3 != -2 ? r3 != -1 ? "unknown reason" : "type" : "data" : "action" : "category"));
                        }
                    }
                ...
                if (arrayList5 != null) {
                    for (int r32 = 0; r32 < arrayList5.size(); r32++) {
                        ((ReceiverRecord) arrayList5.get(r32)).broadcasting = false;
                    }
