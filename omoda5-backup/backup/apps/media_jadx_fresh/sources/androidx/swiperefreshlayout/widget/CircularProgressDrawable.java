...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int r7, int r8) {
        return ((((r7 >> 24) & 255) + ((int) ((((r8 >> 24) & 255) - r5) * f))) << 24) | ((((r7 >> 16) & 255) + ((int) ((((r8 >> 16) & 255) - r0) * f))) << 16) | ((((r7 >> 8) & 255) + ((int) ((((r8 >> 8) & 255) - r1) * f))) << 8) | ((r7 & 255) + ((int) (f * ((r8 & 255) - r7))));
    }
    ...
    private static class Ring {
        ...
        void setColorIndex(int r2) {
            this.mColorIndex = r2;
            this.mCurrentColor = this.mColors[r2];
        }
