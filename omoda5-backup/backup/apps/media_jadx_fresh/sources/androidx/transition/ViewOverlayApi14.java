...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        protected ViewParent invalidateChildInParentFast(int r5, int r6, Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (!(this.mHostView instanceof ViewGroup) || sInvalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                sInvalidateChildInParentFastMethod.invoke(this.mHostView, Integer.valueOf(r5), Integer.valueOf(r6), rect);
                return null;
