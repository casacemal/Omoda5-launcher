...
public class TransitionInflater {
    ...
    public Transition inflateTransition(int r4) throws Resources.NotFoundException {
        XmlResourceParser xml = this.mContext.getResources().getXml(r4);
        try {
            try {
    ...
    public TransitionManager inflateTransitionManager(int r3, ViewGroup viewGroup) throws Resources.NotFoundException {
        XmlResourceParser xml = this.mContext.getResources().getXml(r3);
        try {
            try {
