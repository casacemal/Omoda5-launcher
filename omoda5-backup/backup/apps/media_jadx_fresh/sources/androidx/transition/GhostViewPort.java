...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public void setVisibility(int r2) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        ...
        if (getGhostView(this.mView) == this) {
            ViewUtils.setTransitionVisibility(this.mView, r2 == 0 ? 4 : 0);
        }
    }
    ...
    static GhostViewPort getGhostView(View view) {
        return (GhostViewPort) view.getTag(C0450R.id.ghost_view);
    }

    static void setGhostView(View view, GhostViewPort ghostViewPort) {
        view.setTag(C0450R.id.ghost_view, ghostViewPort);
    }
    ...
    static void removeGhost(View view) {
        GhostViewPort ghostView = getGhostView(view);
        if (ghostView != null) {
            int r0 = ghostView.mReferences - 1;
            ghostView.mReferences = r0;
            if (r0 <= 0) {
