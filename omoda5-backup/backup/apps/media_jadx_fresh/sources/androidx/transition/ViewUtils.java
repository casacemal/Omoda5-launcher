...
class ViewUtils {
    ...
    static void setTransitionVisibility(View view, int r2) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        IMPL.setTransitionVisibility(view, r2);
    }
    ...
    static void setLeftTopRightBottom(View view, int r7, int r8, int r9, int r10) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
