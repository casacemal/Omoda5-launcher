...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, "position") { // from class: androidx.transition.ChangeBounds.6
        ...
        public void set(View view, PointF pointF) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            int r2 = Math.round(pointF.x);
            int r4 = Math.round(pointF.y);
            ViewUtils.setLeftTopRightBottom(view, r2, r4, view.getWidth() + r2, view.getHeight() + r4);
        }
    };
    ...
    public Animator createAnimator(final ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            int r6 = rect2.left;
            final int r7 = rect3.left;
            int r11 = rect2.top;
            final int r12 = rect3.top;
            int r13 = rect2.right;
            final int r14 = rect3.right;
            int r32 = rect2.bottom;
            ...
            if ((r5 == 0 || r2 == 0) && (r10 == 0 || r4 == 0)) {
                r1 = 0;
            } else {
                r1 = (r6 == r7 && r11 == r12) ? 0 : 1;
                if (r13 != r14 || r32 != r15) {
                    r1++;
                }
            }
            ...
            if (!this.mResizeClip) {
                view = view2;
                ViewUtils.setLeftTopRightBottom(view, r6, r11, r13, r32);
                if (r1 == 2) {
                    if (r5 == r10 && r2 == r4) {
                        animatorMergeAnimators = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                    } else {
                        final ViewBounds viewBounds = new ViewBounds(view);
                        ObjectAnimator objectAnimatorOfPointF = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                        ObjectAnimator objectAnimatorOfPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(r13, r32, r14, r15));
                ...
                } else if (r6 != r7 || r11 != r12) {
                    animatorMergeAnimators = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                } else {
                    animatorMergeAnimators = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(r13, r32, r14, r15));
                }
            } else {
                view = view2;
                ViewUtils.setLeftTopRightBottom(view, r6, r11, Math.max(r5, r10) + r6, Math.max(r2, r4) + r11);
                ObjectAnimator objectAnimatorOfPointF3 = (r6 == r7 && r11 == r12) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(r6, r11, r7, r12));
                if (rect4 == null) {
                    r3 = 0;
                    rect = new Rect(0, 0, r5, r2);
                } else {
                    r3 = 0;
                    rect = rect4;
                }
                Rect rect6 = rect5 == null ? new Rect(r3, r3, r10, r4) : rect5;
                if (rect.equals(rect6)) {
                    ...
                    objectAnimatorOfObject.addListener(new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeBounds.8
                        ...
                        public void onAnimationEnd(Animator animator) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                            ...
                            ViewUtils.setLeftTopRightBottom(view, r7, r12, r14, r15);
                        }
                    });
        ...
        int r0 = ((Integer) transitionValues.values.get(PROPNAME_WINDOW_Y)).intValue();
        int r33 = ((Integer) transitionValues2.values.get(PROPNAME_WINDOW_X)).intValue();
        int r16 = ((Integer) transitionValues2.values.get(PROPNAME_WINDOW_Y)).intValue();
        if (r22 == r33 && r0 == r16) {
            return null;
        }
        ...
        int[] r102 = this.mTempLocation;
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, pathMotion.getPath(r22 - r102[0], r0 - r102[1], r33 - r102[0], r16 - r102[1])));
    ...
    private static class ViewBounds {
        ...
        void setTopLeft(PointF pointF) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ...
            int r2 = this.mTopLeftCalls + 1;
            this.mTopLeftCalls = r2;
            if (r2 == this.mBottomRightCalls) {
        ...
        void setBottomRight(PointF pointF) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ...
            int r2 = this.mBottomRightCalls + 1;
            this.mBottomRightCalls = r2;
            if (this.mTopLeftCalls == r2) {
                setLeftTopRightBottom();
            }
        }
