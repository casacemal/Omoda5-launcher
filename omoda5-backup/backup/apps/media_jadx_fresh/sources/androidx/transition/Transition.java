...
public abstract class Transition implements Cloneable {
    ...
    private void matchItemIds(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, LongSparseArray<View> longSparseArray, LongSparseArray<View> longSparseArray2) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            View viewValueAt = longSparseArray.valueAt(r1);
            if (viewValueAt != null && isValidTarget(viewValueAt) && (view = longSparseArray2.get(longSparseArray.keyAt(r1))) != null && isValidTarget(view)) {
    ...
    private void matchIds(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, SparseArray<View> sparseArray, SparseArray<View> sparseArray2) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            ...
            if (viewValueAt != null && isValidTarget(viewValueAt) && (view = sparseArray2.get(sparseArray.keyAt(r1))) != null && isValidTarget(view)) {
                TransitionValues transitionValues = arrayMap.get(viewValueAt);
                TransitionValues transitionValues2 = arrayMap2.get(view);
                if (transitionValues != null && transitionValues2 != null) {
                    this.mStartValuesList.add(transitionValues);
    ...
    private void matchNames(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, ArrayMap<String, View> arrayMap3, ArrayMap<String, View> arrayMap4) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            View viewValueAt = arrayMap3.valueAt(r1);
            if (viewValueAt != null && isValidTarget(viewValueAt) && (view = arrayMap4.get(arrayMap3.keyAt(r1))) != null && isValidTarget(view)) {
                TransitionValues transitionValues = arrayMap.get(viewValueAt);
                TransitionValues transitionValues2 = arrayMap2.get(view);
                if (transitionValues != null && transitionValues2 != null) {
                    this.mStartValuesList.add(transitionValues);
    ...
    private void addUnmatched(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2) {
        for (int r1 = 0; r1 < arrayMap.size(); r1++) {
            TransitionValues transitionValuesValueAt = arrayMap.valueAt(r1);
        ...
        for (int r0 = 0; r0 < arrayMap2.size(); r0++) {
            TransitionValues transitionValuesValueAt2 = arrayMap2.valueAt(r0);
    ...
    void captureValues(ViewGroup viewGroup, boolean z) {
        ...
        if ((this.mTargetIds.size() > 0 || this.mTargets.size() > 0) && (((arrayList = this.mTargetNames) == null || arrayList.isEmpty()) && ((arrayList2 = this.mTargetTypes) == null || arrayList2.isEmpty()))) {
            for (int r0 = 0; r0 < this.mTargetIds.size(); r0++) {
                View viewFindViewById = viewGroup.findViewById(this.mTargetIds.get(r0).intValue());
    ...
    */
    androidx.transition.TransitionValues getMatchedTransitionValues(android.view.View r7, boolean r8) {
        /*
            ...
            if (r0 == 0) goto L9
            androidx.transition.TransitionValues r6 = r0.getMatchedTransitionValues(r7, r8)
            return r6
        L9:
            if (r8 == 0) goto Le
        ...
        L2e:
            if (r3 < 0) goto L3e
            if (r8 == 0) goto L35
            java.util.ArrayList<androidx.transition.TransitionValues> r6 = r6.mEndValuesList
            goto L37
        L35:
            java.util.ArrayList<androidx.transition.TransitionValues> r6 = r6.mStartValuesList
        L37:
    ...
    public void pause(View view) {
        ...
        for (int r1 = size - 1; r1 >= 0; r1--) {
            AnimationInfo animationInfoValueAt = runningAnimators.valueAt(r1);
        ...
        if (this.mPaused) {
            if (!this.mEnded) {
                ...
                for (int r2 = size - 1; r2 >= 0; r2--) {
                    AnimationInfo animationInfoValueAt = runningAnimators.valueAt(r2);
                    if (animationInfoValueAt.mView != null && windowId.equals(animationInfoValueAt.mWindowId)) {
    ...
    void playTransition(ViewGroup viewGroup) {
        ...
        for (int r1 = size - 1; r1 >= 0; r1--) {
            Animator animatorKeyAt = runningAnimators.keyAt(r1);
    ...
    protected void end() {
        ...
        if (r0 == 0) {
            ...
            for (int r02 = 0; r02 < this.mStartValues.mItemIdValues.size(); r02++) {
                View viewValueAt = this.mStartValues.mItemIdValues.valueAt(r02);
                if (viewValueAt != null) {
                    ViewCompat.setHasTransientState(viewValueAt, false);
                }
            }
            for (int r03 = 0; r03 < this.mEndValues.mItemIdValues.size(); r03++) {
                View viewValueAt2 = this.mEndValues.mItemIdValues.valueAt(r03);
    ...
    void forceToEnd(ViewGroup viewGroup) {
        ...
        for (int r0 = size - 1; r0 >= 0; r0--) {
            AnimationInfo animationInfo = (AnimationInfo) arrayMap.valueAt(r0);
            if (animationInfo.mView != null && windowId != null && windowId.equals(animationInfo.mWindowId)) {
                ((Animator) arrayMap.keyAt(r0)).end();
            }
        }
    }
