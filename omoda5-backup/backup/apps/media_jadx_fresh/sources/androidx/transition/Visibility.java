...
public abstract class Visibility extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        int[] r2 = new int[2];
        transitionValues.view.getLocationOnScreen(r2);
        transitionValues.values.put(PROPNAME_SCREEN_LOCATION, r2);
    }
    ...
    public Animator onAppear(ViewGroup viewGroup, TransitionValues transitionValues, int r5, TransitionValues transitionValues2, int r7) {
    ...
    */
    public android.animation.Animator onDisappear(final android.view.ViewGroup r11, androidx.transition.TransitionValues r12, int r13, androidx.transition.TransitionValues r14, int r15) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.IllegalArgumentException {
        /*
    ...
    private static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        DisappearListener(View view, int r3, boolean z) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            this.mView = view;
