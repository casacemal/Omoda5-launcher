...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo43clone = transition.mo43clone();
        transitionMo43clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo43clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo43clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo43clone);
    }
    ...
    /* renamed from: go */
    public static void m18go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m19go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo43clone = transition.mo43clone();
        sceneChangeSetup(viewGroup, transitionMo43clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo43clone);
    }
