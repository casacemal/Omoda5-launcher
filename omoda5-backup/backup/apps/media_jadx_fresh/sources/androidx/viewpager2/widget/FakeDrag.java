...
final class FakeDrag {
    ...
    boolean fakeDragBy(float f) {
        ...
        int r10 = Math.round(f2 - this.mActualDraggedDistance);
        this.mActualDraggedDistance += r10;
    ...
    private void addFakeMotionEvent(long j, int r11, float f, float f2) {
        MotionEvent motionEventObtain = MotionEvent.obtain(this.mFakeDragBeginTime, j, r11, f, f2, 0);
