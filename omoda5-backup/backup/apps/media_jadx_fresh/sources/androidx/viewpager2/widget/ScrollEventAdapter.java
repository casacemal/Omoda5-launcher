...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int r7) {
        boolean z = true;
        if ((this.mAdapterState != 1 || this.mScrollState != 1) && r7 == 1) {
            startDrag(false);
            return;
        }
        if (isInAnyDraggingState() && r7 == 2) {
        ...
        if (this.mAdapterState == 2 && r7 == 0 && this.mDataSetChangeHappened) {
            updateScrollEventValues();
    ...
    */
    ...
    void notifyProgrammaticScroll(int r3, boolean z) {
        this.mAdapterState = z ? 2 : 3;
        this.mFakeDragging = false;
        boolean z2 = this.mTarget != r3;
        this.mTarget = r3;
        dispatchStateChanged(2);
        if (z2) {
            dispatchSelected(r3);
    ...
    private void dispatchStateChanged(int r3) {
        if ((this.mAdapterState == 3 && this.mScrollState == 0) || this.mScrollState == r3) {
            return;
        }
    ...
    private void dispatchSelected(int r1) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageSelected(r1);
        }
    }

    private void dispatchScrolled(int r1, float f, int r3) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(r1, f, r3);
        }
    }
