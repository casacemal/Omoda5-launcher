...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public abstract Fragment createFragment(int r1);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final FragmentViewHolder onCreateViewHolder(ViewGroup viewGroup, int r2) {
        return FragmentViewHolder.create(viewGroup);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final void onBindViewHolder(final FragmentViewHolder fragmentViewHolder, int r9) {
        ...
        if (ViewCompat.isAttachedToWindow(container)) {
            ...
            container.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.viewpager2.adapter.FragmentStateAdapter.1
                ...
                public void onLayoutChange(View view, int r2, int r3, int r4, int r5, int r6, int r7, int r8, int r92) {
                    if (container.getParent() != null) {
    ...
    void gcFragments() {
        ...
        for (int r2 = 0; r2 < this.mFragments.size(); r2++) {
            long jKeyAt = this.mFragments.keyAt(r2);
        ...
        if (!this.mIsInGracePeriod) {
            this.mHasStaleFragments = false;
            for (int r1 = 0; r1 < this.mFragments.size(); r1++) {
                long jKeyAt2 = this.mFragments.keyAt(r1);
    ...
    private Long itemForViewHolder(int r5) {
        Long lValueOf = null;
        for (int r1 = 0; r1 < this.mItemIdToViewHolder.size(); r1++) {
            if (this.mItemIdToViewHolder.valueAt(r1).intValue() == r5) {
                if (lValueOf != null) {
                    throw new IllegalStateException("Design assumption violated: a ViewHolder can only be bound to one item at a time.");
                }
                lValueOf = Long.valueOf(this.mItemIdToViewHolder.keyAt(r1));
            }
        }
        return lValueOf;
    }
    ...
    private void ensureFragment(int r4) {
        long itemId = getItemId(r4);
        if (this.mFragments.containsKey(itemId)) {
            return;
        }
        Fragment fragmentCreateFragment = createFragment(r4);
    ...
    public final Parcelable saveState() {
        ...
        for (int r1 = 0; r1 < this.mSavedStates.size(); r1++) {
            long jKeyAt2 = this.mSavedStates.keyAt(r1);
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        void updateFragmentMaxLifecycle(boolean z) {
            ...
            if ((itemId != this.mPrimaryItemId || z) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                ...
                for (int r2 = 0; r2 < FragmentStateAdapter.this.mFragments.size(); r2++) {
                    long jKeyAt = FragmentStateAdapter.this.mFragments.keyAt(r2);
                    Fragment fragmentValueAt = FragmentStateAdapter.this.mFragments.valueAt(r2);
    ...
    private static abstract class DataSetChangeObserver extends RecyclerView.AdapterDataObserver {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public final void onItemRangeChanged(int r1, int r2, Object obj) {
            onChanged();
        }
