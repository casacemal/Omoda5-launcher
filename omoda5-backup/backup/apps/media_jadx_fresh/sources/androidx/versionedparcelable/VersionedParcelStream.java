...
class VersionedParcelStream extends VersionedParcel {
    ...
    private VersionedParcelStream(InputStream inputStream, OutputStream outputStream, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
        ...
        this.mMasterInput = inputStream != null ? new DataInputStream(new FilterInputStream(inputStream) { // from class: androidx.versionedparcelable.VersionedParcelStream.1
            ...
            public int read(byte[] bArr, int r4, int r5) throws IOException {
                ...
                if (r3 > 0) {
                    VersionedParcelStream.this.mCount += r3;
                }
                return r3;
            }
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public boolean readField(int r5) throws IOException {
        while (this.mFieldId != r5) {
            try {
                if (String.valueOf(this.mFieldId).compareTo(String.valueOf(r5)) > 0) {
                    return false;
                }
                ...
                this.mFieldSize = -1;
                int r1 = this.mMasterInput.readInt();
                this.mCount = 0;
                int r3 = r1 & 65535;
                if (r3 == 65535) {
                    r3 = this.mMasterInput.readInt();
                }
                this.mFieldId = (r1 >> 16) & 65535;
                this.mFieldSize = r3;
    ...
    public void setOutputField(int r3) {
        closeField();
        FieldBuffer fieldBuffer = new FieldBuffer(r3, this.mMasterOutput);
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeByteArray(byte[] bArr, int r3, int r4) throws IOException {
        try {
            if (bArr != null) {
                this.mCurrentOutput.writeInt(r4);
                this.mCurrentOutput.write(bArr, r3, r4);
            } else {
                this.mCurrentOutput.writeInt(-1);
            }
        } catch (IOException e) {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeInt(int r1) throws IOException {
        try {
            this.mCurrentOutput.writeInt(r1);
        } catch (IOException e) {
            throw new VersionedParcel.ParcelException(e);
        }
    }
    ...
    public String readString() throws IOException {
        try {
            int r0 = this.mCurrentInput.readInt();
            if (r0 <= 0) {
                return null;
            }
    ...
    private void readObject(int r1, String str, Bundle bundle) {
        switch (r1) {
            case 0:
            ...
            case 14:
                ...
                return;
            default:
                throw new RuntimeException("Unknown type " + r1);
        }
    }
    ...
    private static class FieldBuffer {
        ...
        FieldBuffer(int r3, DataOutputStream dataOutputStream) {
            this.mFieldId = r3;
