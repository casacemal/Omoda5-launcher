...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int r11, int r12, int r13) {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int r5, int r6, int r7) {
        ...
        this.mDrawerImage = ContextCompat.getDrawable(activity, r5);
    ...
    public void setHomeAsUpIndicator(int r2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        setHomeAsUpIndicator(r2 != 0 ? ContextCompat.getDrawable(this.mActivity, r2) : null);
    }
    ...
    private void setActionBarUpIndicator(Drawable drawable, int r8) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
            delegate.setActionBarUpIndicator(drawable, r8);
            return;
        }
        if (Build.VERSION.SDK_INT >= 18) {
            ActionBar actionBar = this.mActivity.getActionBar();
        ...
        if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null) {
            try {
                ...
                this.mSetIndicatorInfo.mSetHomeActionContentDescription.invoke(actionBar2, Integer.valueOf(r8));
                return;
            } catch (Exception e) {
    ...
    private void setActionBarDescription(int r4) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
            delegate.setActionBarDescription(r4);
            return;
        }
        if (Build.VERSION.SDK_INT >= 18) {
            ActionBar actionBar = this.mActivity.getActionBar();
            if (actionBar != null) {
                actionBar.setHomeActionContentDescription(r4);
                return;
            }
            return;
        }
        ...
        if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null) {
            try {
                ActionBar actionBar2 = this.mActivity.getActionBar();
                this.mSetIndicatorInfo.mSetHomeActionContentDescription.invoke(actionBar2, Integer.valueOf(r4));
    ...
    private class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.translate((-this.mOffset) * fWidth * this.mPosition * r1, 0.0f);
