...
public abstract class VolumeProviderCompat {
    ...
    public VolumeProviderCompat(int r1, int r2, int r3) {
        this.mControlType = r1;
        this.mMaxVolume = r2;
        this.mCurrentVolume = r3;
    }
    ...
    public final void setCurrentVolume(int r4) {
        this.mCurrentVolume = r4;
        Object volumeProvider = getVolumeProvider();
        if (volumeProvider != null && Build.VERSION.SDK_INT >= 21) {
            VolumeProviderCompatApi21.setCurrentVolume(volumeProvider, r4);
        }
    ...
    public Object getVolumeProvider() {
        if (this.mVolumeProviderObj == null && Build.VERSION.SDK_INT >= 21) {
            this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new VolumeProviderCompatApi21.Delegate() { // from class: androidx.media.VolumeProviderCompat.1
                ...
                public void onSetVolumeTo(int r1) {
                    VolumeProviderCompat.this.onSetVolumeTo(r1);
                }

                @Override // androidx.media.VolumeProviderCompatApi21.Delegate
                public void onAdjustVolume(int r1) {
                    VolumeProviderCompat.this.onAdjustVolume(r1);
                }
            });
        }
