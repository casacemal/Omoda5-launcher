...
public final class MediaSessionManager {
    ...
    public static final class RemoteUserInfo {
        ...
        public RemoteUserInfo(String str, int r4, int r5) {
            if (Build.VERSION.SDK_INT >= 28) {
                this.mImpl = new MediaSessionManagerImplApi28.RemoteUserInfoImplApi28(str, r4, r5);
            } else {
                this.mImpl = new MediaSessionManagerImplBase.RemoteUserInfoImplBase(str, r4, r5);
            }
        }
