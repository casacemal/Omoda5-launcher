...
class MediaBrowserServiceCompatApi26 {
    ...
    static class ResultWrapper {
        ...
        public void sendResult(List<Parcel> list, int r4) throws IllegalAccessException, IllegalArgumentException {
            try {
                MediaBrowserServiceCompatApi26.sResultFlags.setInt(this.mResultObj, r4);
