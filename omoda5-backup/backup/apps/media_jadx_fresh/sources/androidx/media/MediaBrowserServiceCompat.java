...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public abstract BrowserRoot onGetRoot(String str, int r2, Bundle bundle);
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        public void notifyChildrenChanged(final MediaSessionManager.RemoteUserInfo remoteUserInfo, final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplBase.3
                @Override // java.lang.Runnable
                public void run() {
                    for (int r0 = 0; r0 < MediaBrowserServiceCompat.this.mConnections.size(); r0++) {
                        ConnectionRecord connectionRecordValueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(r0);
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int r13, Bundle bundle) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            Bundle extras;
            ...
            MediaBrowserServiceCompat.this.mCurConnection = MediaBrowserServiceCompat.this.new ConnectionRecord(str, -1, r13, bundle, null);
            BrowserRoot browserRootOnGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str, r13, bundle);
    ...
    private class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        ConnectionRecord(String str, int r3, int r4, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = r3;
            this.uid = r4;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, r3, r4);
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(final String str, final int r11, final int r12, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (!MediaBrowserServiceCompat.this.isValidPackage(str, r12)) {
                throw new IllegalArgumentException("Package/uid mismatch: uid=" + r12 + " package=" + str);
            }
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                ...
                public void run() throws RemoteException {
                    ...
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, r11, r12, bundle, serviceCallbacks);
                    MediaBrowserServiceCompat.this.mCurConnection = connectionRecord;
                    connectionRecord.root = MediaBrowserServiceCompat.this.onGetRoot(str, r12, bundle);
                    MediaBrowserServiceCompat.this.mCurConnection = null;
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int r12, final int r13, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                ...
                public void run() throws RemoteException {
                    IBinder iBinderAsBinder = serviceCallbacks.asBinder();
                    MediaBrowserServiceCompat.this.mConnections.remove(iBinderAsBinder);
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(str, r12, r13, bundle, serviceCallbacks);
                    MediaBrowserServiceCompat.this.mConnections.put(iBinderAsBinder, connectionRecord);
                    try {
                        iBinderAsBinder.linkToDeath(connectionRecord, 0);
                    } catch (RemoteException unused) {
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int r2, Bundle bundle) throws RemoteException {
            Message messageObtain = Message.obtain();
            messageObtain.what = r2;
    ...
    boolean isValidPackage(String str, int r5) {
        if (str == null) {
            return false;
        }
    ...
    List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> list, Bundle bundle) {
        ...
        int r2 = bundle.getInt(MediaBrowserCompat.EXTRA_PAGE, -1);
        int r4 = bundle.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1);
        if (r2 == -1 && r4 == -1) {
            return list;
        }
        int r0 = r4 * r2;
        int size = r0 + r4;
        if (r2 < 0 || r4 < 1 || r0 >= list.size()) {
