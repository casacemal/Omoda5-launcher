...
class MediaBrowserServiceCompatApi21 {
    ...
    public interface ServiceCompatProxy {
        BrowserRoot onGetRoot(String str, int r2, Bundle bundle);
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserService {
        ...
        public MediaBrowserService.BrowserRoot onGetRoot(String str, int r4, Bundle bundle) {
            MediaSessionCompat.ensureClassLoader(bundle);
            BrowserRoot browserRootOnGetRoot = this.mServiceProxy.onGetRoot(str, r4, bundle == null ? null : new Bundle(bundle));
