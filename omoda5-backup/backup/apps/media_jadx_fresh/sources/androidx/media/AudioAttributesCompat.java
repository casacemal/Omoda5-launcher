...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static class Builder {
        ...
        public AudioAttributesCompat build() {
            ...
            if (!AudioAttributesCompat.sForceLegacyBehavior && Build.VERSION.SDK_INT >= 21) {
                ...
                int r1 = this.mLegacyStream;
                if (r1 != -1) {
                    usage.setLegacyStreamType(r1);
                }
        ...
        public Builder setUsage(int r3) {
            switch (r3) {
                case 0:
                case 1:
                case 2:
        ...
        public Builder setContentType(int r2) {
            if (r2 == 0 || r2 == 1 || r2 == 2 || r2 == 3 || r2 == 4) {
                this.mContentType = r2;
            } else {
                this.mUsage = 0;
            }
            return this;
        ...
        public Builder setFlags(int r2) {
            this.mFlags = (r2 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        public Builder setLegacyStreamType(int r3) {
            if (r3 == 10) {
                throw new IllegalArgumentException("STREAM_ACCESSIBILITY is not a legacy stream type that was used for audio playback");
            }
            this.mLegacyStream = r3;
            return Build.VERSION.SDK_INT >= 21 ? setInternalLegacyStreamType(r3) : this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        Builder setInternalLegacyStreamType(int r4) {
            switch (r4) {
                case 0:
                    this.mContentType = 1;
                    break;
                ...
                case 10:
                    ...
                    break;
                default:
                    Log.e(AudioAttributesCompat.TAG, "Invalid stream type " + r4 + " for AudioAttributesCompat");
                    break;
            }
            this.mUsage = AudioAttributesCompat.usageForStreamType(r4);
            return this;
        }
    }
    ...
    static String usageToString(int r2) {
        switch (r2) {
            case 0:
    ...
    static int toVolumeStreamType(boolean z, int r4, int r5) {
        if ((r4 & 1) == 1) {
            return z ? 1 : 7;
        }
        if ((r4 & 4) == 4) {
