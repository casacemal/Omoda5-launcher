...
public class ResolutionAnchor extends ResolutionNode {
    ...
    String sType(int r1) {
        return r1 == 1 ? "DIRECT" : r1 == 2 ? "CENTER" : r1 == 3 ? "MATCH" : r1 == 4 ? "CHAIN" : r1 == 5 ? "BARRIER" : "UNCONNECTED";
    }
    ...
    public void dependsOn(int r1, ResolutionAnchor resolutionAnchor, int r3) {
        this.type = r1;
    ...
    public void dependsOn(ResolutionAnchor resolutionAnchor, int r2) {
        this.target = resolutionAnchor;
        this.offset = r2;
        resolutionAnchor.addDependent(this);
    }

    public void dependsOn(ResolutionAnchor resolutionAnchor, int r2, ResolutionDimension resolutionDimension) {
        this.target = resolutionAnchor;
        resolutionAnchor.addDependent(this);
        this.dimension = resolutionDimension;
        this.dimensionMultiplier = r2;
    ...
    public void setOpposite(ResolutionAnchor resolutionAnchor, int r2, ResolutionDimension resolutionDimension) {
        this.opposite = resolutionAnchor;
        this.oppositeDimension = resolutionDimension;
        this.oppositeDimensionMultiplier = r2;
    }
