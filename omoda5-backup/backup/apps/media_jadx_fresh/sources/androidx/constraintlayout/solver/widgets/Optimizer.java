...
public class Optimizer {
    ...
    static void checkMatchParent(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ConstraintWidget constraintWidget) {
        if (constraintWidgetContainer.mListDimensionBehaviors[0] != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && constraintWidget.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            int r0 = constraintWidget.mLeft.mMargin;
            ...
            constraintWidget.setHorizontalDimension(r0, width);
        }
        ...
        int r02 = constraintWidget.mTop.mMargin;
        int height = constraintWidgetContainer.getHeight() - constraintWidget.mBottom.mMargin;
        constraintWidget.mTop.mSolverVariable = linearSystem.createObjectVariable(constraintWidget.mTop);
        constraintWidget.mBottom.mSolverVariable = linearSystem.createObjectVariable(constraintWidget.mBottom);
        linearSystem.addEquality(constraintWidget.mTop.mSolverVariable, r02);
        linearSystem.addEquality(constraintWidget.mBottom.mSolverVariable, height);
        if (constraintWidget.mBaselineDistance > 0 || constraintWidget.getVisibility() == 8) {
            constraintWidget.mBaseline.mSolverVariable = linearSystem.createObjectVariable(constraintWidget.mBaseline);
            linearSystem.addEquality(constraintWidget.mBaseline.mSolverVariable, constraintWidget.mBaselineDistance + r02);
        }
        constraintWidget.mVerticalResolution = 2;
        constraintWidget.setVerticalDimension(r02, height);
    }

    private static boolean optimizableMatchConstraint(ConstraintWidget constraintWidget, int r4) {
        if (constraintWidget.mListDimensionBehaviors[r4] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            return false;
        }
        if (constraintWidget.mDimensionRatio != 0.0f) {
            if (constraintWidget.mListDimensionBehaviors[r4 != 0 ? (char) 0 : (char) 1] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            }
            return false;
        }
        if (r4 == 0) {
    ...
    static void analyze(int r16, ConstraintWidget constraintWidget) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:191:0x0327 A[PHI: r7
      0x0327: PHI (r7v26 float) = (r7v22 float), (r7v20 float) binds: [B:199:0x037f, B:189:0x0324] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    static void setOptimizedWidget(ConstraintWidget constraintWidget, int r5, int r6) {
        int r0 = r5 * 2;
        int r1 = r0 + 1;
        constraintWidget.mListAnchors[r0].getResolutionNode().resolvedTarget = constraintWidget.getParent().mLeft.getResolutionNode();
        constraintWidget.mListAnchors[r0].getResolutionNode().resolvedOffset = r6;
        constraintWidget.mListAnchors[r0].getResolutionNode().state = 1;
        constraintWidget.mListAnchors[r1].getResolutionNode().resolvedTarget = constraintWidget.mListAnchors[r0].getResolutionNode();
        constraintWidget.mListAnchors[r1].getResolutionNode().resolvedOffset = constraintWidget.getLength(r5);
        constraintWidget.mListAnchors[r1].getResolutionNode().state = 1;
    }
}
