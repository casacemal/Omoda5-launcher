...
public class ArrayRow implements LinearSystem.Row {
    ...
    */
    ...
    ArrayRow createRowDefinition(SolverVariable solverVariable, int r2) {
    ...
    public ArrayRow createRowEquals(SolverVariable solverVariable, int r3) {
        if (r3 < 0) {
            this.constantValue = r3 * (-1);
            this.variables.put(solverVariable, 1.0f);
        } else {
            this.constantValue = r3;
            this.variables.put(solverVariable, -1.0f);
        }
        return this;
    }

    public ArrayRow createRowEquals(SolverVariable solverVariable, SolverVariable solverVariable2, int r5) {
        boolean z = false;
        if (r5 != 0) {
            if (r5 < 0) {
                r5 *= -1;
    ...
    ArrayRow addSingleError(SolverVariable solverVariable, int r3) {
        this.variables.put(solverVariable, r3);
        return this;
    }
    ...
    public ArrayRow createRowGreaterThan(SolverVariable solverVariable, int r2, SolverVariable solverVariable2) {
        this.constantValue = r2;
        this.variables.put(solverVariable, -1.0f);
        return this;
    }
    ...
    public ArrayRow createRowEqualDimension(float f, float f2, float f3, SolverVariable solverVariable, int r8, SolverVariable solverVariable2, int r10, SolverVariable solverVariable3, int r12, SolverVariable solverVariable4, int r14) {
        if (f2 == 0.0f || f == f3) {
            this.constantValue = ((-r8) - r10) + r12 + r14;
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, -1.0f);
            this.variables.put(solverVariable4, 1.0f);
            this.variables.put(solverVariable3, -1.0f);
            ...
            float f4 = (f / f2) / (f3 / f2);
            this.constantValue = ((-r8) - r10) + (r12 * f4) + (r14 * f4);
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, -1.0f);
            this.variables.put(solverVariable4, f4);
            this.variables.put(solverVariable3, -f4);
    ...
    ArrayRow createRowCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int r8, float f, SolverVariable solverVariable3, SolverVariable solverVariable4, int r12) {
        ...
        if (f == 0.5f) {
            ...
            this.variables.put(solverVariable4, 1.0f);
            if (r8 > 0 || r12 > 0) {
                this.constantValue = (-r8) + r12;
            }
        } else if (f <= 0.0f) {
            this.variables.put(solverVariable, -1.0f);
            this.variables.put(solverVariable2, 1.0f);
            this.constantValue = r8;
        } else if (f >= 1.0f) {
            this.variables.put(solverVariable3, -1.0f);
            this.variables.put(solverVariable4, 1.0f);
            this.constantValue = r12;
        } else {
            float f2 = 1.0f - f;
            ...
            if (r8 > 0 || r12 > 0) {
                this.constantValue = ((-r8) * f2) + (r12 * f);
            }
        }
        return this;
    }

    public ArrayRow addError(LinearSystem linearSystem, int r5) {
        this.variables.put(linearSystem.createErrorVariable(r5, "ep"), 1.0f);
        this.variables.put(linearSystem.createErrorVariable(r5, "em"), -1.0f);
        return this;
    }
    ...
    public void initFromRow(LinearSystem.Row row) {
        if (row instanceof ArrayRow) {
            ...
            this.variable = null;
            this.variables.clear();
            for (int r0 = 0; r0 < arrayRow.variables.currentSize; r0++) {
                this.variables.add(arrayRow.variables.getVariable(r0), arrayRow.variables.getVariableValue(r0), true);
            }
        }
    }
