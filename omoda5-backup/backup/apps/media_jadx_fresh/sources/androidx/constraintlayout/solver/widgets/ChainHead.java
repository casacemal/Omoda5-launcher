...
public class ChainHead {
    ...
    private static boolean isMatchConstraintEqualityCandidate(ConstraintWidget constraintWidget, int r3) {
        return constraintWidget.getVisibility() != 8 && constraintWidget.mListDimensionBehaviors[r3] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (constraintWidget.mResolvedMatchConstraintDefault[r3] == 0 || constraintWidget.mResolvedMatchConstraintDefault[r3] == 3);
    }

    private void defineChainProperties() {
        int r0 = this.mOrientation * 2;
        ...
        while (!z2) {
            ...
            ConstraintAnchor constraintAnchor = constraintWidget.mListAnchors[r0 + 1].mTarget;
            if (constraintAnchor != null) {
                ConstraintWidget constraintWidget5 = constraintAnchor.mOwner;
                if (constraintWidget5.mListAnchors[r0].mTarget != null && constraintWidget5.mListAnchors[r0].mTarget.mOwner == constraintWidget) {
