...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    private static final int ITEM_LAYOUT = C0105R.layout.abc_popup_menu_item_layout;
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int r7, int r8, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0105R.dimen.abc_config_prefDialogWidth));
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0105R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    public void setHorizontalOffset(int r1) {
        this.mPopup.setHorizontalOffset(r1);
    }

    @Override // androidx.appcompat.view.menu.MenuPopup
    public void setVerticalOffset(int r1) {
        this.mPopup.setVerticalOffset(r1);
    }
