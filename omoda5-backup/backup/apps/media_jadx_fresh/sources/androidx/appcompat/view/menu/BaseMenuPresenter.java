...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    public BaseMenuPresenter(Context context, int r2, int r3) {
    ...
    public void updateMenuView(boolean z) {
        ...
        if (menuBuilder != null) {
            ...
            for (int r3 = 0; r3 < size; r3++) {
                ...
                if (shouldIncludeItem(r4, menuItemImpl)) {
        ...
        while (r1 < viewGroup.getChildCount()) {
            if (!filterLeftoverView(viewGroup, r1)) {
                r1++;
            }
        }
    }

    protected void addItemView(View view, int r3) {
        ViewGroup viewGroup = (ViewGroup) view.getParent();
        if (viewGroup != null) {
            viewGroup.removeView(view);
        }
        ((ViewGroup) this.mMenuView).addView(view, r3);
    }

    protected boolean filterLeftoverView(ViewGroup viewGroup, int r2) {
