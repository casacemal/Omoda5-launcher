...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0105R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(Context context, View view, int r4, int r5, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0105R.dimen.abc_config_prefDialogWidth));
    ...
    private int getNextMenuPosition(int r6) {
        ...
        return this.mLastPosition == 1 ? (r1[0] + listView.getWidth()) + r6 > rect.right ? 0 : 1 : r1[0] - r6 < 0 ? 1 : 0;
    }
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        int width = measureIndividualMenuWidth(menuAdapter, null, this.mContext, this.mMenuMaxWidth);
        ...
        menuPopupWindowCreatePopupWindow.setContentWidth(width);
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            int nextMenuPosition = getNextMenuPosition(width);
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                int[] r82 = new int[2];
                viewFindParentViewForSubmenu.getLocationOnScreen(r82);
                if ((this.mDropDownGravity & 7) == 5) {
                    r10[0] = r10[0] + this.mAnchorView.getWidth();
                    r82[0] = r82[0] + viewFindParentViewForSubmenu.getWidth();
                }
                r12 = r82[0] - r10[0];
                r8 = r82[1] - r10[1];
            }
            if ((this.mDropDownGravity & 5) == 5) {
                if (!z) {
                    width = viewFindParentViewForSubmenu.getWidth();
                    r122 = r12 - width;
                }
                r122 = r12 + width;
            } else {
            ...
            menuPopupWindowCreatePopupWindow.setHorizontalOffset(r122);
            menuPopupWindowCreatePopupWindow.setOverlapAnchor(true);
            menuPopupWindowCreatePopupWindow.setVerticalOffset(r8);
        } else {
            if (this.mHasXOffset) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(C0105R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    private MenuItem findMenuItemForSubmenu(MenuBuilder menuBuilder, MenuBuilder menuBuilder2) {
        ...
        for (int r0 = 0; r0 < size; r0++) {
            MenuItem item = menuBuilder.getItem(r0);
    ...
    private View findParentViewForSubmenu(CascadingMenuInfo cascadingMenuInfo, MenuBuilder menuBuilder) {
        ...
        while (true) {
            ...
            if (menuItemFindMenuItemForSubmenu == menuAdapter.getItem(r2)) {
                break;
            }
            r2++;
        }
        if (r2 != -1 && (firstVisiblePosition = (r2 + headersCount) - listView.getFirstVisiblePosition()) >= 0 && firstVisiblePosition < listView.getChildCount()) {
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
        int r0 = findIndexOfAddedMenu(menuBuilder);
        if (r0 < 0) {
            return;
        }
        int r1 = r0 + 1;
        ...
        CascadingMenuInfo cascadingMenuInfoRemove = this.mShowingMenus.remove(r0);
