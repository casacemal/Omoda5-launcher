...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0105R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0105R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int r12) {
        this(context, menuBuilder, view, z, r12, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int r6, int r7) {
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0105R.dimen.abc_cascading_menus_min_smallest_width)) {
    ...
    private void showPopup(int r3, int r4, boolean z, boolean z2) {
        MenuPopup popup = getPopup();
        popup.setShowTitle(z2);
        if (z) {
            if ((GravityCompat.getAbsoluteGravity(this.mDropDownGravity, ViewCompat.getLayoutDirection(this.mAnchorView)) & 7) == 5) {
                r3 -= this.mAnchorView.getWidth();
            }
            popup.setHorizontalOffset(r3);
            popup.setVerticalOffset(r4);
            int r2 = (int) ((this.mContext.getResources().getDisplayMetrics().density * 48.0f) / 2.0f);
            popup.setEpicenterBounds(new Rect(r3 - r2, r4 - r2, r3 + r2, r4 + r2));
        }
        popup.show();
    }
