...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    MenuItemImpl(MenuBuilder menuBuilder, int r4, int r5, int r6, int r7, CharSequence charSequence, int r9) {
    ...
    public MenuItem setAlphabeticShortcut(char c, int r3) {
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    public MenuItem setNumericShortcut(char c, int r3) {
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    public MenuItem setShortcut(char c, char c2, int r3, int r4) {
        this.mShortcutNumericChar = c;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(r3);
        this.mShortcutAlphabeticChar = Character.toLowerCase(c2);
    ...
    String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0105R.string.abc_prepend_shortcut_label));
        }
        int r5 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, r5, 65536, resources.getString(C0105R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, r5, 4096, resources.getString(C0105R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, r5, 2, resources.getString(C0105R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, r5, 1, resources.getString(C0105R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, r5, 4, resources.getString(C0105R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, r5, 8, resources.getString(C0105R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            sb.append(resources.getString(C0105R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(C0105R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut == ' ') {
            sb.append(resources.getString(C0105R.string.abc_menu_space_shortcut_label));
        } else {
            sb.append(shortcut);
        }
        return sb.toString();
    ...
    private static void appendModifier(StringBuilder sb, int r1, int r2, String str) {
        if ((r1 & r2) == r2) {
            sb.append(str);
        }
    }
    ...
    public SupportMenuItem setActionView(int r4) {
        ...
        setActionView(LayoutInflater.from(context).inflate(r4, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
