...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int r6) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0105R.styleable.ActionMenuItemView, r6, 0);
        this.mMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0105R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return r0 >= 480 || (r0 >= 640 && configuration.screenHeightDp >= 480) || configuration.orientation == 2;
    }
    ...
    protected void onMeasure(int r6, int r7) {
        ...
        if (zHasText && (r1 = this.mSavedPaddingLeft) >= 0) {
