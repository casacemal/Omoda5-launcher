...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        ListMenuPresenter listMenuPresenter = new ListMenuPresenter(builder.getContext(), C0105R.layout.abc_list_menu_item_layout);
    ...
    public boolean onKey(DialogInterface dialogInterface, int r4, KeyEvent keyEvent) {
        ...
        return this.mMenu.performShortcut(r4, keyEvent, 0);
    }
    ...
    public void onClick(DialogInterface dialogInterface, int r2) {
        this.mMenu.performItemAction((MenuItemImpl) this.mPresenter.getAdapter().getItem(r2), 0);
    }
}
