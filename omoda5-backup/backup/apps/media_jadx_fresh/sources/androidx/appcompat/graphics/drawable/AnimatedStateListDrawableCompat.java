...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public /* bridge */ /* synthetic */ void addState(int[] r1, Drawable drawable) {
        super.addState(r1, drawable);
    }
    ...
    public static AnimatedStateListDrawableCompat create(Context context, int r7, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
    ...
    public void inflate(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0134R.styleable.AnimatedStateListDrawableCompat);
        setVisible(typedArrayObtainAttributes.getBoolean(C0134R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    public void addState(int[] r2, Drawable drawable, int r4) {
        if (drawable == null) {
            throw new IllegalArgumentException("Drawable must not be null");
        }
        this.mState.addStateSet(r2, drawable, r4);
        onStateChange(getState());
    }

    public <T extends Drawable & Animatable> void addTransition(int r1, int r2, T t, boolean z) {
        if (t == null) {
            throw new IllegalArgumentException("Transition drawable must not be null");
        }
        this.mState.addTransition(r1, r2, t, z);
    }
    ...
    protected boolean onStateChange(int[] r3) {
        ...
        boolean z = r0 != getCurrentIndex() && (selectTransition(r0) || selectDrawable(r0));
    ...
    private static class AnimatableTransition extends Transition {
        ...
        /* renamed from: mA */
        private final Animatable f21mA;

        AnimatableTransition(Animatable animatable) {
            super();
            this.f21mA = animatable;
        }
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.setVariablePadding(typedArray.getBoolean(C0134R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.mVariablePadding));
        animatedStateListState.setConstantSize(typedArray.getBoolean(C0134R.styleable.AnimatedStateListDrawableCompat_android_constantSize, animatedStateListState.mConstantSize));
        animatedStateListState.setEnterFadeDuration(typedArray.getInt(C0134R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, animatedStateListState.mEnterFadeDuration));
        animatedStateListState.setExitFadeDuration(typedArray.getInt(C0134R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, animatedStateListState.mExitFadeDuration));
        setDither(typedArray.getBoolean(C0134R.styleable.AnimatedStateListDrawableCompat_android_dither, animatedStateListState.mDither));
    }
    ...
    private int parseTransition(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0134R.styleable.AnimatedStateListDrawableTransition);
        int resourceId = typedArrayObtainAttributes.getResourceId(C0134R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int resourceId2 = typedArrayObtainAttributes.getResourceId(C0134R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        int resourceId3 = typedArrayObtainAttributes.getResourceId(C0134R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        Drawable drawable = resourceId3 > 0 ? ResourceManagerInternal.get().getDrawable(context, resourceId3) : null;
        boolean z = typedArrayObtainAttributes.getBoolean(C0134R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        typedArrayObtainAttributes.recycle();
        if (drawable == null) {
            do {
    ...
    private int parseItem(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0134R.styleable.AnimatedStateListDrawableItem);
        int resourceId = typedArrayObtainAttributes.getResourceId(C0134R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        int resourceId2 = typedArrayObtainAttributes.getResourceId(C0134R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
        Drawable drawable = resourceId2 > 0 ? ResourceManagerInternal.get().getDrawable(context, resourceId2) : null;
        typedArrayObtainAttributes.recycle();
        int[] r0 = extractStateSet(attributeSet);
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
            } while (next == 4);
        ...
        return this.mState.addStateSet(r0, drawable, resourceId);
    }
    ...
    static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        void mutate() {
            this.mTransitions = this.mTransitions.m38clone();
            this.mStateIds = this.mStateIds.m39clone();
        }

        int addTransition(int r10, int r11, Drawable drawable, boolean z) {
            ...
            if (z) {
                this.mTransitions.append(generateTransitionKey(r11, r10), Long.valueOf(REVERSED_BIT | j2 | j));
            }
            return r12;
        }

        int addStateSet(int[] r1, Drawable drawable, int r3) {
            int r12 = super.addStateSet(r1, drawable);
        ...
        int indexOfKeyframe(int[] r1) {
            ...
            return r12 >= 0 ? r12 : super.indexOfStateSet(StateSet.WILD_CARD);
        }

        int getKeyframeIdAt(int r2) {
            if (r2 < 0) {
                return 0;
            }
            return this.mStateIds.get(r2, 0).intValue();
        }

        int indexOfTransition(int r3, int r4) {
            return (int) this.mTransitions.get(generateTransitionKey(r3, r4), -1L).longValue();
        }

        boolean isTransitionReversed(int r3, int r4) {
            return (this.mTransitions.get(generateTransitionKey(r3, r4), -1L).longValue() & REVERSED_BIT) != 0;
        }

        boolean transitionHasReversibleFlag(int r3, int r4) {
            return (this.mTransitions.get(generateTransitionKey(r3, r4), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f) {
            int r5 = (int) ((f * this.mTotalDuration) + 0.5f);
            int r0 = this.mFrames;
            int[] r1 = this.mFrameTimes;
            int r2 = 0;
            ...
            return (r2 / r0) + (r2 < r0 ? r5 / this.mTotalDuration : 0.0f);
        }
    }
}
