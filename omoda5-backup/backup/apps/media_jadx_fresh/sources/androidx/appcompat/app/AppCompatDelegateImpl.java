...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public void attachBaseContext(Context context) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        applyDayNight(false);
    ...
    public <T extends View> T findViewById(int r1) {
        ensureSubDecor();
        return (T) this.mWindow.findViewById(r1);
    }
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C0105R.styleable.AppCompatTheme);
        if (!typedArrayObtainStyledAttributes.hasValue(C0105R.styleable.AppCompatTheme_windowActionBar)) {
            typedArrayObtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (typedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = typedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.AppCompatTheme_android_windowIsFloating, false);
        typedArrayObtainStyledAttributes.recycle();
        ensureWindow();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C0105R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0105R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0105R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0105R.id.decor_content_parent);
            ...
            if (this.mOverlayActionMode) {
                viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C0105R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C0105R.layout.abc_screen_simple, (ViewGroup) null);
            }
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(viewGroup, new OnApplyWindowInsetsListener() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.3
                    ...
                    public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
                        ...
                        int r3 = AppCompatDelegateImpl.this.updateStatusGuard(systemWindowInsetTop);
                        if (systemWindowInsetTop != r3) {
                            windowInsetsCompat = windowInsetsCompat.replaceSystemWindowInsets(windowInsetsCompat.getSystemWindowInsetLeft(), r3, windowInsetsCompat.getSystemWindowInsetRight(), windowInsetsCompat.getSystemWindowInsetBottom());
                        }
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C0105R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0105R.id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C0105R.styleable.AppCompatTheme);
        typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (typedArrayObtainStyledAttributes.hasValue(C0105R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0105R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0105R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0105R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            typedArrayObtainStyledAttributes.getValue(C0105R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    public boolean requestWindowFeature(int r5) {
        ...
        if (this.mWindowNoTitle && r52 == 108) {
            return false;
        }
        if (this.mHasActionBar && r52 == 1) {
            this.mHasActionBar = false;
        }
        if (r52 == 1) {
    ...
    public boolean hasWindowFeature(int r5) {
        ...
        if (r0 == 1) {
            ...
            z = r0 != 109 ? false : this.mOverlayActionBar;
        }
        return z || this.mWindow.hasFeature(r5);
    }
    ...
    void onPanelClosed(int r3) {
        ...
        if (r3 == 0) {
            PanelFeatureState panelState = getPanelState(r3, true);
    ...
    void onMenuOpened(int r2) {
        ActionBar supportActionBar;
        if (r2 != 108 || (supportActionBar = getSupportActionBar()) == null) {
            return;
        }
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    theme.resolveAttribute(C0105R.attr.actionBarTheme, typedValue, true);
                    if (typedValue.resourceId != 0) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(contextThemeWrapper, (AttributeSet) null, C0105R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = popupWindow;
                    PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    contextThemeWrapper.getTheme().resolveAttribute(C0105R.attr.actionBarSize, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0105R.id.action_mode_bar_stub);
    ...
    boolean onKeyShortcut(int r4, KeyEvent keyEvent) {
        ActionBar supportActionBar = getSupportActionBar();
        if (supportActionBar != null && supportActionBar.onKeyShortcut(r4, keyEvent)) {
            return true;
        }
    ...
    boolean onKeyUp(int r4, KeyEvent keyEvent) {
        if (r4 == 4) {
    ...
    boolean onKeyDown(int r4, KeyEvent keyEvent) {
        if (r4 == 4) {
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0105R.styleable.AppCompatTheme).getString(C0105R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(r6, -2, panelFeatureState.f15x, panelFeatureState.f16y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            r6 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(r6, -2, panelFeatureState.f15x, panelFeatureState.f16y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                themeNewTheme.setTo(theme);
                themeNewTheme.applyStyle(typedValue.resourceId, true);
                themeNewTheme.resolveAttribute(C0105R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0105R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
    ...
    private boolean onKeyDownPanel(int r2, KeyEvent keyEvent) {
        if (keyEvent.getRepeatCount() != 0) {
            return false;
        }
        PanelFeatureState panelState = getPanelState(r2, true);
        if (panelState.isOpen) {
            return false;
        }
    ...
    */
    ...
    void callOnPanelClosed(int r3, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
        ...
        if ((panelFeatureState == null || panelFeatureState.isOpen) && !this.mIsDestroyed) {
            this.mAppCompatWindowCallback.getWrapped().onPanelClosed(r3, menu);
        }
    }
    ...
    PanelFeatureState findMenuPanel(Menu menu) {
        ...
        for (int r0 = 0; r0 < length; r0++) {
            PanelFeatureState panelFeatureState = panelFeatureStateArr[r0];
    ...
    protected PanelFeatureState getPanelState(int r4, boolean z) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
        if (panelFeatureStateArr == null || panelFeatureStateArr.length <= r4) {
            PanelFeatureState[] panelFeatureStateArr2 = new PanelFeatureState[r4 + 1];
        ...
        PanelFeatureState panelFeatureState = panelFeatureStateArr[r4];
        if (panelFeatureState != null) {
            return panelFeatureState;
        }
        PanelFeatureState panelFeatureState2 = new PanelFeatureState(r4);
        panelFeatureStateArr[r4] = panelFeatureState2;
        return panelFeatureState2;
    }

    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int r4, KeyEvent keyEvent, int r6) {
        boolean zPerformShortcut = false;
        if (keyEvent.isSystem()) {
            return false;
        }
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && panelFeatureState.menu != null) {
            zPerformShortcut = panelFeatureState.menu.performShortcut(r4, keyEvent, r6);
        }
        if (zPerformShortcut && (r6 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
    ...
    private void invalidatePanelMenu(int r3) {
        this.mInvalidatePanelMenuFeatures = (1 << r3) | this.mInvalidatePanelMenuFeatures;
        if (this.mInvalidatePanelMenuPosted) {
            return;
        }
    ...
    void doInvalidatePanelMenu(int r5) {
        ...
        PanelFeatureState panelState2 = getPanelState(r5, true);
        ...
        panelState2.refreshDecorView = true;
        if ((r5 != 108 && r5 != 0) || this.mDecorContentParent == null || (panelState = getPanelState(0, false)) == null) {
            return;
        }
        panelState.isPrepared = false;
    ...
    int updateStatusGuard(int r9) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        boolean z;
        boolean z2;
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? r9 : 0)) {
                    marginLayoutParams.topMargin = r9;
                    View view = this.mStatusGuard;
                    if (view == null) {
                        View view2 = new View(this.mContext);
                        this.mStatusGuard = view2;
                        view2.setBackgroundColor(this.mContext.getResources().getColor(C0105R.color.abc_input_method_navigation_guard));
                        this.mSubDecor.addView(this.mStatusGuard, -1, new ViewGroup.LayoutParams(-1, r9));
                    } else {
                        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
                        if (layoutParams.height != r9) {
    ...
    private int sanitizeWindowFeatureId(int r2) {
        if (r2 == 8) {
    ...
    private boolean applyDayNight(boolean z) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        ...
        int r0 = calculateNightMode();
        boolean zUpdateForNightMode = updateForNightMode(mapNightMode(r0), z);
        if (r0 == 0) {
    ...
    private int calculateNightMode() {
        int r1 = this.mLocalNightMode;
        return r1 != -100 ? r1 : getDefaultNightMode();
    }

    private boolean updateForNightMode(int r9, boolean z) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        int r0 = this.mContext.getApplicationContext().getResources().getConfiguration().uiMode & 48;
        boolean z2 = true;
        int r2 = r9 != 1 ? r9 != 2 ? r0 : 32 : 16;
        boolean zIsActivityManifestHandlingUiMode = isActivityManifestHandlingUiMode();
        boolean z3 = false;
        if ((sAlwaysOverrideConfiguration || r2 != r0) && !zIsActivityManifestHandlingUiMode && Build.VERSION.SDK_INT >= 17 && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
            Configuration configuration = new Configuration();
            configuration.uiMode = (configuration.uiMode & (-49)) | r2;
            try {
        ...
        int r02 = this.mContext.getResources().getConfiguration().uiMode & 48;
        if (!z3 && r02 != r2 && z && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached && (Build.VERSION.SDK_INT >= 17 || this.mCreated)) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
        ...
        if (z3 || r02 == r2) {
            ...
            updateResourcesConfigurationForNightMode(r2, zIsActivityManifestHandlingUiMode);
        }
        if (z2) {
            Object obj2 = this.mHost;
            if (obj2 instanceof AppCompatActivity) {
                ((AppCompatActivity) obj2).onNightModeChanged(r9);
            }
        }
        return z2;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void updateResourcesConfigurationForNightMode(int r4, boolean z) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Resources resources = this.mContext.getResources();
        Configuration configuration = new Configuration(resources.getConfiguration());
        configuration.uiMode = r4 | (resources.getConfiguration().uiMode & (-49));
        resources.updateConfiguration(configuration, null);
        if (Build.VERSION.SDK_INT < 26) {
            ResourcesFlusher.flush(resources);
        }
        int r42 = this.mThemeResId;
        if (r42 != 0) {
            this.mContext.setTheme(r42);
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            themeNewTheme.resolveAttribute(C0105R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                themeNewTheme.applyStyle(typedValue.resourceId, true);
            }
            themeNewTheme.resolveAttribute(C0105R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                themeNewTheme.applyStyle(typedValue.resourceId, true);
            } else {
                themeNewTheme.applyStyle(C0105R.style.Theme_AppCompat_CompactMenu, true);
            }
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(themeNewTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray typedArrayObtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0105R.styleable.AppCompatTheme);
            this.background = typedArrayObtainStyledAttributes.getResourceId(C0105R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = typedArrayObtainStyledAttributes.getResourceId(C0105R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0105R.layout.abc_list_menu_item_layout);
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onMenuOpened(int r1, Menu menu) {
            ...
            AppCompatDelegateImpl.this.onMenuOpened(r1);
            return true;
        }
        ...
        public void onPanelClosed(int r1, Menu menu) {
            ...
            AppCompatDelegateImpl.this.onPanelClosed(r1);
        }
        ...
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int r3) {
            if (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && r3 == 0) {
                return startAsSupportActionMode(callback);
            }
            return super.onWindowStartingActionMode(callback, r3);
        }
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int r6) {
            ...
            if (panelState != null && panelState.menu != null) {
                super.onProvideKeyboardShortcuts(list, panelState.menu, r6);
            } else {
    ...
    private class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        AutoBatteryNightModeManager(Context context) {
            super();
            this.mPowerManager = (PowerManager) context.getSystemService(Car.POWER_SERVICE);
        }
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0105R.attr.homeAsUpIndicator});
        ...
        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public void setActionBarUpIndicator(Drawable drawable, int r2) {
            ActionBar supportActionBar = AppCompatDelegateImpl.this.getSupportActionBar();
            if (supportActionBar != null) {
                supportActionBar.setHomeAsUpIndicator(drawable);
                supportActionBar.setHomeActionContentDescription(r2);
            }
        }

        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public void setActionBarDescription(int r1) {
            ActionBar supportActionBar = AppCompatDelegateImpl.this.getSupportActionBar();
            if (supportActionBar != null) {
                supportActionBar.setHomeActionContentDescription(r1);
            }
        }
    }
}
