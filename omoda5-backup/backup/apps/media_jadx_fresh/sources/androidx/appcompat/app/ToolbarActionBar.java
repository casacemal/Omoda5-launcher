...
class ToolbarActionBar extends ActionBar {
    ...
    public void setTitle(int r2) {
        ...
        decorToolbar.setTitle(r2 != 0 ? decorToolbar.getContext().getText(r2) : null);
    }
    ...
    public void setSubtitle(int r2) {
        DecorToolbar decorToolbar = this.mDecorToolbar;
        decorToolbar.setSubtitle(r2 != 0 ? decorToolbar.getContext().getText(r2) : null);
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setDisplayOptions(int r2, int r3) {
        this.mDecorToolbar.setDisplayOptions((r2 & r3) | ((~r3) & this.mDecorToolbar.getDisplayOptions()));
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int r2) {
        throw new UnsupportedOperationException("Tabs are not supported in toolbar action bars");
    }

    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int r2, boolean z) {
        throw new UnsupportedOperationException("Tabs are not supported in toolbar action bars");
    }
    ...
    private class ToolbarCallbackWrapper extends WindowCallbackWrapper {
        ...
        public View onCreatePanelView(int r1) {
            ...
            return super.onCreatePanelView(r1);
        }
    }
