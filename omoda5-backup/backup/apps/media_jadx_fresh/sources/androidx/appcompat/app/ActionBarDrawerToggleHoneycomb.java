...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarUpIndicator(Activity activity, Drawable drawable, int r8) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                ...
                setIndicatorInfo.setHomeActionContentDescription.invoke(actionBar, Integer.valueOf(r8));
            } catch (Exception e) {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo setIndicatorInfo, Activity activity, int r5) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                android.app.ActionBar actionBar = activity.getActionBar();
                setIndicatorInfo.setHomeActionContentDescription.invoke(actionBar, Integer.valueOf(r5));
