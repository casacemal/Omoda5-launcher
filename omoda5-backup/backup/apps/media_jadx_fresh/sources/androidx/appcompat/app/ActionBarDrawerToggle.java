...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public interface Delegate {
        ...
        void setActionBarUpIndicator(Drawable drawable, int r2);
    }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int r10, int r11) {
        this(activity, null, drawerLayout, null, r10, r11);
    }

    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar, int r11, int r12) {
        this(activity, toolbar, drawerLayout, null, r11, r12);
    }

    /* JADX WARN: Multi-variable type inference failed */
    ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, int r6, int r7) {
    ...
    public void setHomeAsUpIndicator(int r2) {
        setHomeAsUpIndicator(r2 != 0 ? this.mDrawerLayout.getResources().getDrawable(r2) : null);
    }
    ...
    void setActionBarUpIndicator(Drawable drawable, int r4) {
        if (!this.mWarnedForDisplayHomeAsUp && !this.mActivityImpl.isNavigationVisible()) {
            Log.w("ActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon is not visible. You may need to call actionbar.setDisplayHomeAsUpEnabled(true);");
            this.mWarnedForDisplayHomeAsUp = true;
        }
        this.mActivityImpl.setActionBarUpIndicator(drawable, r4);
    }

    void setActionBarDescription(int r1) {
        this.mActivityImpl.setActionBarDescription(r1);
    }
    ...
    private static class FrameworkActionBarDelegate implements Delegate {
        ...
        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public void setActionBarUpIndicator(Drawable drawable, int r5) {
            android.app.ActionBar actionBar = this.mActivity.getActionBar();
            if (actionBar != null) {
                if (Build.VERSION.SDK_INT >= 18) {
                    ...
                    this.mSetIndicatorInfo = ActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(this.mActivity, drawable, r5);
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public void setActionBarUpIndicator(Drawable drawable, int r3) {
        ...
        public void setActionBarDescription(int r1) {
            if (r1 == 0) {
                ...
                this.mToolbar.setNavigationContentDescription(r1);
            }
        }
