...
public abstract class ActionBar {
    ...
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int r1, long j);
    }
    ...
    public static abstract class Tab {
        ...
        public abstract Tab setContentDescription(int r1);
        ...
        public abstract Tab setIcon(int r1);
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int r2);

    @Deprecated
    public abstract void addTab(Tab tab, int r2, boolean z);
    ...
    public boolean onKeyShortcut(int r1, KeyEvent keyEvent) {
        return false;
    }
    ...
    public void setHideOffset(int r1) {
        if (r1 != 0) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0105R.styleable.ActionBarLayout);
            this.gravity = typedArrayObtainStyledAttributes.getInt(C0105R.styleable.ActionBarLayout_android_layout_gravity, 0);
