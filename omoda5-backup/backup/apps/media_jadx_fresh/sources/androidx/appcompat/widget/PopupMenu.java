...
public class PopupMenu {
    ...
    public PopupMenu(Context context, View view, int r9) {
        this(context, view, r9, C0105R.attr.popupMenuStyle, 0);
    }

    public PopupMenu(Context context, View view, int r12, int r13, int r14) {
        ...
        MenuPopupHelper menuPopupHelper = new MenuPopupHelper(context, this.mMenu, view, false, r13, r14);
        this.mPopup = menuPopupHelper;
        menuPopupHelper.setGravity(r12);
