...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int r13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0105R.styleable.ActivityChooserView, r13, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0105R.styleable.ActivityChooserView, attributeSet, typedArrayObtainStyledAttributes, r13, 0);
        }
        this.mInitialActivityCount = typedArrayObtainStyledAttributes.getInt(C0105R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        typedArrayObtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0105R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks();
        View viewFindViewById = findViewById(C0105R.id.activity_chooser_view_content);
        this.mActivityChooserContent = viewFindViewById;
        this.mActivityChooserContentBackground = viewFindViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0105R.id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0105R.id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0105R.id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0105R.id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0105R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void setExpandActivityOverflowButtonContentDescription(int r2) {
        this.mExpandActivityOverflowButtonImage.setContentDescription(getContext().getString(r2));
    }
    ...
    void showPopupUnchecked(int r6) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (r6 != Integer.MAX_VALUE && activityCount > r6 + r0) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0105R.string.abc_activitychooserview_choose_application));
    ...
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int r3, long j) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            int itemViewType = ((ActivityChooserViewAdapter) adapterView.getAdapter()).getItemViewType(r3);
            if (itemViewType != 0) {
                if (itemViewType == 1) {
            ...
            if (ActivityChooserView.this.mIsSelectingDefaultActivity) {
                if (r3 > 0) {
                    ActivityChooserView.this.mAdapter.getDataModel().setDefaultActivity(r3);
                    return;
                }
                return;
            }
            ...
            Intent intentChooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(r3);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int r2) {
            return (this.mShowFooterView && r2 == getCount() - 1) ? 1 : 0;
        }
        ...
        public int getCount() {
            ...
            int r0 = Math.min(activityCount, this.mMaxActivityCount);
            return this.mShowFooterView ? r0 + 1 : r0;
        }
        ...
        public View getView(int r6, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    View viewInflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0105R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    viewInflate.setId(1);
                    ((TextView) viewInflate.findViewById(C0105R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0105R.string.abc_activity_chooser_view_see_all));
                    return viewInflate;
                }
                throw new IllegalArgumentException();
            }
            if (view == null || view.getId() != C0105R.id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0105R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            ...
            ((TextView) view.findViewById(C0105R.id.title)).setText(resolveInfo.loadLabel(packageManager));
            if (this.mShowDefaultActivity && r6 == 0 && this.mHighlightDefaultActivity) {
