...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0105R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    protected void onWindowVisibilityChanged(int r1) {
        ...
        this.mWindowVisibility = r1;
        ActionBarVisibilityCallback actionBarVisibilityCallback = this.mActionBarVisibilityCallback;
        if (actionBarVisibilityCallback != null) {
            actionBarVisibilityCallback.onWindowVisibilityChanged(r1);
        }
    }
    ...
    protected void onMeasure(int r14, int r15) {
        ...
        int r1 = Math.max(0, this.mActionBarTop.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
        int r0 = Math.max(0, this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
        ...
        int r12 = Math.max(r1, this.mContent.getMeasuredWidth() + layoutParams2.leftMargin + layoutParams2.rightMargin);
        int r02 = Math.max(r0, this.mContent.getMeasuredHeight() + layoutParams2.topMargin + layoutParams2.bottomMargin);
        int r2 = View.combineMeasuredStates(r3, this.mContent.getMeasuredState());
        setMeasuredDimension(View.resolveSizeAndState(Math.max(r12 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), r14, r2), View.resolveSizeAndState(Math.max(r02 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), r15, r2 << 16));
    }
    ...
    protected void onLayout(boolean z, int r6, int r7, int r8, int r9) {
        ...
        for (int r82 = 0; r82 < childCount; r82++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int r3 = layoutParams.leftMargin + paddingLeft;
                int r0 = layoutParams.topMargin + paddingTop;
    ...
    @Override // androidx.core.view.NestedScrollingParent2
    public void onStopNestedScroll(View view, int r2) {
        if (r2 == 0) {
    ...
    @Override // androidx.core.view.NestedScrollingParent2
    public void onNestedPreScroll(View view, int r2, int r3, int[] r4, int r5) {
        if (r5 == 0) {
    ...
    public void onNestedScrollAccepted(View view, View view2, int r4) {
        this.mParentHelper.onNestedScrollAccepted(view, view2, r4);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0105R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0105R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0105R.id.action_bar));
        }
    }
    ...
    public void setActionBarHideOffset(int r2) {
        haltActionBarHideOffsetAnimations();
        this.mActionBarTop.setTranslationY(-Math.max(0, Math.min(r2, this.mActionBarTop.getHeight())));
    }
