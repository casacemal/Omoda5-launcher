...
class DropDownListView extends ListView {
    ...
    DropDownListView(Context context, boolean z) throws NoSuchFieldException {
        super(context, null, C0105R.attr.dropDownListViewStyle);
    ...
    public int lookForSelectablePosition(int r4, boolean z) {
        int r3;
        ...
        if (adapter != null && !isInTouchMode()) {
            ...
            if (!getAdapter().areAllItemsEnabled()) {
                if (z) {
                    r3 = Math.max(0, r4);
                    while (r3 < count && !adapter.isEnabled(r3)) {
                        r3++;
                    }
                } else {
                    r3 = Math.min(r4, count - 1);
                    while (r3 >= 0 && !adapter.isEnabled(r3)) {
                        r3--;
                    }
                }
                if (r3 < 0 || r3 >= count) {
    ...
    public int measureHeightOfChildrenCompat(int r11, int r12, int r13, int r14, int r15) {
        ...
        while (r4 < count) {
            ...
            if (layoutParams.height > 0) {
                r8 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
            } else {
                r8 = View.MeasureSpec.makeMeasureSpec(0, 0);
            }
            view.measure(r11, r8);
            view.forceLayout();
            if (r4 > 0) {
    ...
    */
    ...
    private void clickPressedItem(View view, int r4) {
    ...
    private void positionSelectorLikeTouchCompat(int r1, View view, float f, float f2) throws IllegalAccessException, IllegalArgumentException {
        positionSelectorLikeFocusCompat(r1, view);
        Drawable selector = getSelector();
        if (selector == null || r1 == -1) {
            return;
        }
        DrawableCompat.setHotspot(selector, f, f2);
    }

    private void positionSelectorLikeFocusCompat(int r5, View view) throws IllegalAccessException, IllegalArgumentException {
        Drawable selector = getSelector();
        boolean z = (selector == null || r5 == -1) ? false : true;
        if (z) {
            selector.setVisible(false, false);
        }
        positionSelectorCompat(r5, view);
        if (z) {
    ...
    private void setPressedItem(View view, int r8, float f, float f2) throws IllegalAccessException, IllegalArgumentException {
        View childAt;
        ...
        positionSelectorLikeTouchCompat(r8, view, f, f2);
