...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView {
    ...
    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0105R.attr.radioButtonStyle);
    }

    public AppCompatRadioButton(Context context, AttributeSet attributeSet, int r3) {
        ...
        appCompatCompoundButtonHelper.loadFromAttributes(attributeSet, r3);
    ...
    @Override // android.widget.CompoundButton
    public void setButtonDrawable(int r2) throws NoSuchFieldException {
