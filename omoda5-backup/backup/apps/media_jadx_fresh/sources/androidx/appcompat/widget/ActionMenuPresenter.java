...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0105R.layout.abc_action_menu_layout, C0105R.layout.abc_action_menu_item_layout);
    ...
    public void setWidthLimit(int r1, boolean z) {
        this.mWidthLimit = r1;
    ...
    @Override // androidx.appcompat.view.menu.BaseMenuPresenter
    public boolean shouldIncludeItem(int r1, MenuItemImpl menuItemImpl) {
    ...
    public void updateMenuView(boolean z) {
        ...
        if (this.mMenu != null) {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                ActionProvider supportActionProvider = actionItems.get(r2).getSupportActionProvider();
    ...
    @Override // androidx.appcompat.view.menu.BaseMenuPresenter
    public boolean filterLeftoverView(ViewGroup viewGroup, int r4) {
        if (viewGroup.getChildAt(r4) == this.mOverflowButton) {
            return false;
        }
        return super.filterLeftoverView(viewGroup, r4);
    }
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        while (true) {
            ...
            MenuItem item = subMenuBuilder.getItem(r3);
    ...
    public boolean flagActionItems() {
        ...
        for (int r9 = 0; r9 < size; r9++) {
            MenuItemImpl menuItemImpl = visibleItems.get(r9);
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || r12 + r112 > r5)) {
            r5--;
        }
        int r52 = r5 - r112;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            int r102 = actionMenuPresenter.mMinCellSize;
            r11 = r6 / r102;
        ...
        int r14 = 0;
        while (r122 < size) {
            MenuItemImpl menuItemImpl2 = visibleItems.get(r122);
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = actionMenuPresenter.getItemView(menuItemImpl2, view, viewGroup);
                if (actionMenuPresenter.mStrictWidthLimit) {
                    r11 -= ActionMenuView.measureChildForCells(itemView, r10, r11, r7, r3);
                } else {
                    itemView.measure(r7, r7);
                }
                ...
                boolean z4 = (r52 > 0 || z3) && r6 > 0 && (!actionMenuPresenter.mStrictWidthLimit || r11 > 0);
                boolean z5 = z4;
                r17 = size;
                if (z4) {
                    View itemView2 = actionMenuPresenter.getItemView(menuItemImpl2, null, viewGroup);
                    if (actionMenuPresenter.mStrictWidthLimit) {
                        int r19 = ActionMenuView.measureChildForCells(itemView2, r10, r11, r7, 0);
                        r11 -= r19;
                        if (r19 == 0) {
                            z5 = false;
                        }
                    } else {
                        itemView2.measure(r7, r7);
                    }
                    boolean z6 = z5;
                    ...
                    z4 = z6 & (!actionMenuPresenter.mStrictWidthLimit ? r6 + r14 <= 0 : r6 < 0);
                }
                if (z4 && groupId2 != 0) {
                    ...
                    for (int r4 = 0; r4 < r122; r4++) {
                        MenuItemImpl menuItemImpl3 = visibleItems.get(r4);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0105R.attr.actionOverflowButtonStyle);
        ...
        protected boolean setFrame(int r4, int r5, int r6, int r7) {
            boolean frame = super.setFrame(r4, r5, r6, r7);
            ...
            if (drawable != null && background != null) {
                ...
                DrawableCompat.setHotspotBounds(background, paddingLeft - r0, paddingTop - r0, paddingLeft + r0, paddingTop + r0);
            }
            return frame;
        }
    }
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0105R.attr.actionOverflowMenuStyle);
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0105R.attr.actionOverflowMenuStyle);
