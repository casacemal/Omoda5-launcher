...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0105R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0105R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0105R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getIcon1(Cursor cursor) throws NumberFormatException, IOException {
        ...
        Drawable drawableFromResourceValue = getDrawableFromResourceValue(cursor.getString(r0));
    ...
    private Drawable getIcon2(Cursor cursor) {
        ...
        return getDrawableFromResourceValue(cursor.getString(r0));
    }

    private void setViewDrawable(ImageView imageView, Drawable drawable, int r3) {
    ...
    private Drawable getDrawableFromResourceValue(String str) throws NumberFormatException, IOException {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + "/" + r1;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, r1);
    ...
    private static String getStringOrNull(Cursor cursor, int r3) {
        if (r3 == -1) {
            return null;
        }
        try {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int r12) {
