    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                if (motionEvent.getAction() != 10 && (r3 = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) != -1 && (r32 = r3 - headersCount) >= 0 && r32 < menuAdapter.getCount()) {
                    item = menuAdapter.getItem(r32);
                }
