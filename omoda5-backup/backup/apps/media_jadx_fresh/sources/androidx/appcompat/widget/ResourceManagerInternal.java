...
public final class ResourceManagerInternal {
    ...
    synchronized Drawable getDrawable(Context context, int r3, boolean z) {
        ...
        drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, r3);
        if (drawableLoadDrawableFromDelegates == null) {
            drawableLoadDrawableFromDelegates = createDrawableIfNeeded(context, r3);
        }
        if (drawableLoadDrawableFromDelegates == null) {
            drawableLoadDrawableFromDelegates = ContextCompat.getDrawable(context, r3);
        }
        if (drawableLoadDrawableFromDelegates != null) {
            drawableLoadDrawableFromDelegates = tintDrawable(context, r3, z, drawableLoadDrawableFromDelegates);
        }
        if (drawableLoadDrawableFromDelegates != null) {
    ...
    private Drawable createDrawableIfNeeded(Context context, int r6) throws Resources.NotFoundException {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int r12) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    synchronized Drawable onDrawableLoadedFromResources(Context context, VectorEnabledTintResources vectorEnabledTintResources, int r4) {
        Drawable drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, r4);
        if (drawableLoadDrawableFromDelegates == null) {
            drawableLoadDrawableFromDelegates = vectorEnabledTintResources.superGetDrawable(r4);
        }
        if (drawableLoadDrawableFromDelegates == null) {
            return null;
        }
        return tintDrawable(context, r4, false, drawableLoadDrawableFromDelegates);
    }

    boolean tintDrawableUsingColorFilter(Context context, int r2, Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        return resourceManagerHooks != null && resourceManagerHooks.tintDrawableUsingColorFilter(context, r2, drawable);
    }
    ...
    PorterDuff.Mode getTintMode(int r1) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if (resourceManagerHooks == null) {
            return null;
        }
        return resourceManagerHooks.getTintModeForDrawableRes(r1);
    }
    ...
    synchronized ColorStateList getTintList(Context context, int r3) {
        ...
        if (tintListFromCache == null) {
            tintListFromCache = this.mHooks == null ? null : this.mHooks.getTintListForDrawableRes(context, r3);
            if (tintListFromCache != null) {
    ...
    private ColorStateList getTintListFromCache(Context context, int r3) {
        SparseArrayCompat<ColorStateList> sparseArrayCompat;
        WeakHashMap<Context, SparseArrayCompat<ColorStateList>> weakHashMap = this.mTintLists;
        if (weakHashMap == null || (sparseArrayCompat = weakHashMap.get(context)) == null) {
            return null;
        }
        return sparseArrayCompat.get(r3);
    }

    private void addTintListToCache(Context context, int r3, ColorStateList colorStateList) {
        ...
        sparseArrayCompat.append(r3, colorStateList);
    }
    ...
    static void tintDrawable(Drawable drawable, TintInfo tintInfo, int[] r4) {
    ...
    public static synchronized PorterDuffColorFilter getPorterDuffColorFilter(int r3, PorterDuff.Mode mode) {
        ...
        porterDuffColorFilter = COLOR_FILTER_CACHE.get(r3, mode);
        if (porterDuffColorFilter == null) {
            porterDuffColorFilter = new PorterDuffColorFilter(r3, mode);
            COLOR_FILTER_CACHE.put(r3, mode, porterDuffColorFilter);
        }
    ...
    private void checkVectorDrawableSetup(Context context) {
        ...
        Drawable drawable = getDrawable(context, C0134R.drawable.abc_vector_test);
