...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int r4) {
        this(context, null, C0105R.attr.spinnerStyle, r4);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0105R.attr.spinnerStyle);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet, int r4) {
        this(context, attributeSet, r4, -1);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet, int r9, int r10) {
    ...
    */
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) throws java.lang.Throwable {
        /*
            ...
            r0.<init>()
            r6.mTempRect = r0
            int[] r0 = androidx.appcompat.C0105R.styleable.Spinner
            r1 = 0
            ...
            goto L34
        L22:
            int r11 = androidx.appcompat.C0105R.styleable.Spinner_popupTheme
        ...
        L6c:
            ...
            r10.<init>(r3, r8, r9)
            android.content.Context r3 = r6.mPopupContext
            int[] r4 = androidx.appcompat.C0105R.styleable.Spinner
            ...
            int r3 = androidx.appcompat.C0105R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension(r3, r4)
            r6.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0105R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r3 = r1.getDrawable(r3)
            r10.setBackgroundDrawable(r3)
            int r3 = androidx.appcompat.C0105R.styleable.Spinner_android_prompt
        ...
        La3:
            ...
            r10.<init>()
            r6.mPopup = r10
            int r1 = androidx.appcompat.C0105R.styleable.Spinner_android_prompt
            java.lang.String r1 = r0.getString(r1)
            r10.setPromptText(r1)
        Lb3:
            int r10 = androidx.appcompat.C0105R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r10 = r0.getTextArray(r10)
            if (r10 == 0) goto Lcb
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r7, r3, r10)
            int r7 = androidx.appcompat.C0105R.layout.support_simple_spinner_dropdown_item
    ...
    public void setDropDownVerticalOffset(int r3) {
        SpinnerPopup spinnerPopup = this.mPopup;
        if (spinnerPopup != null) {
            spinnerPopup.setVerticalOffset(r3);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    public void setDropDownHorizontalOffset(int r3) {
        SpinnerPopup spinnerPopup = this.mPopup;
        if (spinnerPopup != null) {
            spinnerPopup.setHorizontalOriginalOffset(r3);
            this.mPopup.setHorizontalOffset(r3);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    int compatMeasureContentWidth(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        return r32 + this.mTempRect.left + this.mTempRect.right;
    }
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public Object getItem(int r1) {
            ...
            return spinnerAdapter.getItem(r1);
        }
        ...
        public long getItemId(int r1) {
            ...
            return spinnerAdapter.getItemId(r1);
        }
        ...
        public View getDropDownView(int r1, View view, ViewGroup viewGroup) {
            SpinnerAdapter spinnerAdapter = this.mAdapter;
            if (spinnerAdapter == null) {
                return null;
            }
            return spinnerAdapter.getDropDownView(r1, view, viewGroup);
        }
        ...
        public boolean isEnabled(int r1) {
            ListAdapter listAdapter = this.mListAdapter;
            if (listAdapter != null) {
                return listAdapter.isEnabled(r1);
            }
            return true;
        }
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int r4, int r5) {
            ...
            if (Build.VERSION.SDK_INT >= 17) {
                listView.setTextDirection(r4);
                listView.setTextAlignment(r5);
            }
            this.mPopup.show();
        }
        ...
        public void onClick(DialogInterface dialogInterface, int r5) {
            AppCompatSpinner.this.setSelection(r5);
            if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                AppCompatSpinner.this.performItemClick(null, r5, this.mListAdapter.getItemId(r5));
            }
            dismiss();
        }
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int r4) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.AppCompatSpinner.DropdownPopup.1
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int r3, long j) {
                    AppCompatSpinner.this.setSelection(r3);
                    if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                        AppCompatSpinner.this.performItemClick(view, r3, DropdownPopup.this.mAdapter.getItemId(r3));
                    }
        ...
        void computeContentWidth() {
            ...
            if (background != null) {
                ...
                r1 = ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? AppCompatSpinner.this.mTempRect.right : -AppCompatSpinner.this.mTempRect.left;
            } else {
            ...
            if (AppCompatSpinner.this.mDropDownWidth == -2) {
                int r4 = AppCompatSpinner.this.compatMeasureContentWidth((SpinnerAdapter) this.mAdapter, getBackground());
                int r5 = (AppCompatSpinner.this.getContext().getResources().getDisplayMetrics().widthPixels - AppCompatSpinner.this.mTempRect.left) - AppCompatSpinner.this.mTempRect.right;
                if (r4 > r5) {
                    r4 = r5;
                }
                setContentWidth(Math.max(r4, (width - paddingLeft) - paddingRight));
            ...
            if (ViewUtils.isLayoutRtl(AppCompatSpinner.this)) {
                horizontalOriginalOffset = r1 + (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset());
            } else {
                horizontalOriginalOffset = r1 + paddingLeft + getHorizontalOriginalOffset();
            }
            setHorizontalOffset(horizontalOriginalOffset);
        }

        @Override // androidx.appcompat.widget.AppCompatSpinner.SpinnerPopup
        public void show(int r5, int r6) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ViewTreeObserver viewTreeObserver;
            ...
            if (Build.VERSION.SDK_INT >= 17) {
                listView.setTextDirection(r5);
                listView.setTextAlignment(r6);
            }
