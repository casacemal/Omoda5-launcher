...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0105R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attributeSet, int r6) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int r5, KeyEvent keyEvent) {
                ...
                if (SearchView.this.mSearchSrcTextView.isPopupShowing() && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
                    return SearchView.this.onSuggestionsKey(view, r5, keyEvent);
                }
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || r5 != 66) {
                    return false;
                }
        ...
        this.mOnItemClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int r3, long j) {
                SearchView.this.onItemClicked(r3, 0, null);
            }
        };
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0105R.styleable.SearchView, r6, 0);
        LayoutInflater.from(context).inflate(tintTypedArrayObtainStyledAttributes.getResourceId(C0105R.styleable.SearchView_layout, C0105R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0105R.id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0105R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0105R.id.search_plate);
        this.mSubmitArea = findViewById(C0105R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0105R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0105R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0105R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0105R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0105R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0105R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = tintTypedArrayObtainStyledAttributes.getResourceId(C0105R.styleable.SearchView_suggestionRowLayout, C0105R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = tintTypedArrayObtainStyledAttributes.getResourceId(C0105R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(tintTypedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0105R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0105R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0105R.styleable.SearchView_queryHint);
        int r4 = tintTypedArrayObtainStyledAttributes.getInt(C0105R.styleable.SearchView_android_imeOptions, -1);
        if (r4 != -1) {
            setImeOptions(r4);
        }
        int r42 = tintTypedArrayObtainStyledAttributes.getInt(C0105R.styleable.SearchView_android_inputType, -1);
        if (r42 != -1) {
            setInputType(r42);
        }
        setFocusable(tintTypedArrayObtainStyledAttributes.getBoolean(C0105R.styleable.SearchView_android_focusable, true));
        ...
        if (viewFindViewById != null) {
            viewFindViewById.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.appcompat.widget.SearchView.4
                ...
                public void onLayoutChange(View view, int r2, int r3, int r43, int r5, int r62, int r7, int r8, int r9) {
    ...
    public void setImeOptions(int r1) {
        this.mSearchSrcTextView.setImeOptions(r1);
    }
    ...
    public void setInputType(int r1) {
        this.mSearchSrcTextView.setInputType(r1);
    }
    ...
    public boolean requestFocus(int r3, Rect rect) {
        ...
        if (!isIconified()) {
            boolean zRequestFocus = this.mSearchSrcTextView.requestFocus(r3, rect);
            if (zRequestFocus) {
    ...
    protected void onMeasure(int r4, int r5) {
        ...
        } else if (mode == 1073741824 && (r0 = this.mMaxWidth) > 0) {
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0105R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0105R.dimen.abc_search_view_preferred_height);
    }
    ...
    void updateFocusedState() {
        int[] r0 = this.mSearchSrcTextView.hasFocus() ? FOCUSED_STATE_SET : EMPTY_STATE_SET;
    ...
    boolean onSuggestionsKey(View view, int r3, KeyEvent keyEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (r3 == 66 || r3 == 84 || r3 == 61) {
                return onItemClicked(this.mSearchSrcTextView.getListSelection(), 0, null);
            }
            if (r3 == 21 || r3 == 22) {
                this.mSearchSrcTextView.setSelection(r3 == 21 ? 0 : this.mSearchSrcTextView.length());
                this.mSearchSrcTextView.setListSelection(0);
                this.mSearchSrcTextView.clearListSelection();
                HIDDEN_METHOD_INVOKER.ensureImeVisible(this.mSearchSrcTextView, true);
                return true;
            }
            if (r3 != 19 || this.mSearchSrcTextView.getListSelection() == 0) {
                return false;
            }
        }
        return false;
    ...
    private void updateVoiceButton(boolean z) {
        ...
        this.mVoiceButton.setVisibility(r1);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0105R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0105R.dimen.abc_dropdownitem_text_padding_left) : 0;
            this.mSearchSrcTextView.getDropDownBackground().getPadding(rect);
            if (zIsLayoutRtl) {
                r0 = -rect.left;
            } else {
                r0 = paddingLeft - (rect.left + dimensionPixelSize);
            }
            this.mSearchSrcTextView.setDropDownHorizontalOffset(r0);
            this.mSearchSrcTextView.setDropDownWidth((((this.mDropDownAnchor.getWidth() + rect.left) + rect.right) + dimensionPixelSize) - paddingLeft);
        }
    }

    boolean onItemClicked(int r1, int r2, String str) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionClick(r1)) {
            return false;
        }
    ...
    boolean onItemSelected(int r2) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionSelect(r2)) {
            return false;
        }
    ...
    private boolean launchSuggestion(int r2, int r3, String str) {
        Cursor cursor = this.mSuggestionsAdapter.getCursor();
        if (cursor == null || !cursor.moveToPosition(r2)) {
            return false;
        }
        launchIntent(createIntentFromSuggestion(cursor, r3, str));
        return true;
    }
    ...
    void launchQuerySearch(int r8, String str, String str2) {
        getContext().startActivity(createIntent("android.intent.action.SEARCH", null, null, str2, r8, str));
    }

    private Intent createIntent(String str, Uri uri, String str2, String str3, int r6, String str4) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int r10, String str) {
        int position;
        String columnString;
        try {
            ...
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), r10, str);
        } catch (RuntimeException e) {
            try {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            int r1 = configuration.screenHeightDp;
            if (r0 < 960 || r1 < 720 || configuration.orientation != 2) {
                return r0 < 600 ? (r0 < 640 || r1 < 480) ? Opcodes.IF_ICMPNE : Opcodes.CHECKCAST : Opcodes.CHECKCAST;
            }
            return 256;
        }
