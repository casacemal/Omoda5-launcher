...
class ActivityChooserModel extends DataSetObservable {
    ...
    public ResolveInfo getActivity(int r2) {
        ResolveInfo resolveInfo;
        synchronized (this.mInstanceLock) {
            ensureConsistentState();
            resolveInfo = this.mActivities.get(r2).resolveInfo;
        }
        return resolveInfo;
    }
    ...
    public int getActivityIndex(ResolveInfo resolveInfo) {
        synchronized (this.mInstanceLock) {
            ...
            for (int r2 = 0; r2 < size; r2++) {
                if (list.get(r2).resolveInfo == resolveInfo) {
                    return r2;
                }
            }
            return -1;
    ...
    public Intent chooseActivity(int r7) {
        synchronized (this.mInstanceLock) {
            ...
            ensureConsistentState();
            ActivityResolveInfo activityResolveInfo = this.mActivities.get(r7);
    ...
    public void setDefaultActivity(int r6) {
        synchronized (this.mInstanceLock) {
            ensureConsistentState();
            ActivityResolveInfo activityResolveInfo = this.mActivities.get(r6);
    ...
    public void setHistoryMaxSize(int r3) {
        synchronized (this.mInstanceLock) {
            if (this.mHistoryMaxSize == r3) {
                return;
            }
            this.mHistoryMaxSize = r3;
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            this.mActivities.add(new ActivityResolveInfo(listQueryIntentActivities.get(r1)));
        }
        return true;
    }
    ...
    public static final class HistoricalRecord {
        ...
        public int hashCode() {
            ...
            long j = this.time;
            return ((((r0 + 31) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + Float.floatToIntBits(this.weight);
        }
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> list, List<HistoricalRecord> list2) {
            ...
            for (int r0 = 0; r0 < size; r0++) {
                ActivityResolveInfo activityResolveInfo = list.get(r0);
