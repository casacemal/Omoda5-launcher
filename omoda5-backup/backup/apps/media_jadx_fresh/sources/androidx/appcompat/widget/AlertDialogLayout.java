...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    protected void onMeasure(int r2, int r3) {
        if (tryOnMeasure(r2, r3)) {
            return;
        }
        super.onMeasure(r2, r3);
    }

    private boolean tryOnMeasure(int r17, int r18) throws NoSuchFieldException {
        int r4;
        int r13;
        int measuredHeight;
        int measuredHeight2;
        ...
        for (int r8 = 0; r8 < childCount; r8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0105R.id.topPanel) {
                    view = childAt;
                } else if (id == C0105R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != C0105R.id.contentPanel && id != C0105R.id.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(r17, 0);
            r13 = resolveMinimumHeight(view2);
