...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int r7, int r8) {
        ...
        int r82 = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, 1073741824);
        if (!z && this.mAllowCollapse) {
            this.mTabLayout.measure(0, r82);
            if (this.mTabLayout.getMeasuredWidth() > View.MeasureSpec.getSize(r7)) {
                performCollapse();
            } else {
                performExpand();
            }
    ...
    public void setTabSelected(int r6) {
        ...
        int r2 = 0;
        while (r2 < childCount) {
            View childAt = this.mTabLayout.getChildAt(r2);
            boolean z = r2 == r6;
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0105R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0105R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int r5) {
        ...
        if (r5 == 0) {
            ...
            viewPropertyAnimatorAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha, r5));
        ...
        viewPropertyAnimatorAlpha2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha2, r5));
        viewPropertyAnimatorAlpha2.start();
    }

    public void animateToTab(int r2) {
        final View childAt = this.mTabLayout.getChildAt(r2);
        Runnable runnable = this.mTabSelector;
        if (runnable != null) {
            removeCallbacks(runnable);
        }
    ...
    public void addTab(ActionBar.Tab tab, int r7, boolean z) {
        TabView tabViewCreateTabView = createTabView(tab, false);
        this.mTabLayout.addView(tabViewCreateTabView, r7, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            super(context, null, C0105R.attr.actionBarTabStyle);
            int[] r4 = {R.attr.background};
            this.BG_ATTRS = r4;
            this.mTab = tab;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, r4, C0105R.attr.actionBarTabStyle, 0);
        ...
        public void onMeasure(int r2, int r3) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, 1073741824), r3);
        }
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0105R.attr.actionBarTabTextStyle);
    ...
    private class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int r1) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(r1)).getTab();
        }

        @Override // android.widget.Adapter
        public View getView(int r1, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(r1), true);
            }
            ((TabView) view).bindTab((ActionBar.Tab) getItem(r1));
            return view;
        }
    }
    ...
    private class TabClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            for (int r2 = 0; r2 < childCount; r2++) {
                View childAt = ScrollingTabContainerView.this.mTabLayout.getChildAt(r2);
    ...
    protected class VisibilityAnimListener extends AnimatorListenerAdapter {
        ...
        public VisibilityAnimListener withFinalVisibility(ViewPropertyAnimator viewPropertyAnimator, int r2) {
