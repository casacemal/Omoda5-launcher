...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0105R.styleable.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0105R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0105R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(C0105R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0105R.id.action_bar);
        this.mContextView = findViewById(C0105R.id.action_context_bar);
    }
    ...
    public void onMeasure(int r4, int r5) {
        ...
        int r0;
        if (this.mActionBarView == null && View.MeasureSpec.getMode(r5) == Integer.MIN_VALUE && (r0 = this.mHeight) >= 0) {
            r5 = View.MeasureSpec.makeMeasureSpec(Math.min(r0, View.MeasureSpec.getSize(r5)), Integer.MIN_VALUE);
        }
        super.onMeasure(r4, r5);
        if (this.mActionBarView == null) {
            return;
        }
        int mode = View.MeasureSpec.getMode(r5);
        View view = this.mTabContainer;
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min(measuredHeightWithMargins + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(r5) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
    }
