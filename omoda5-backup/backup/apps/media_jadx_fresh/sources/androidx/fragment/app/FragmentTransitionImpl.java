...
public abstract class FragmentTransitionImpl {
    ...
    protected void getBoundsOnScreen(View view, Rect rect) {
        ...
        rect.set(r5[0], r5[1], r5[0] + view.getWidth(), r5[1] + view.getHeight());
    }
            ...
            if (transitionName != null) {
                ...
                while (true) {
                    ...
                    if (str.equals(arrayList3.get(r5))) {
                        ViewCompat.setTransitionName(arrayList2.get(r5), transitionName);
                        break;
                    }
                    r5++;
                }
        ...
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            ...
            public void run() {
                for (int r0 = 0; r0 < size; r0++) {
                    ViewCompat.setTransitionName((View) arrayList2.get(r0), (String) arrayList3.get(r0));
                    ViewCompat.setTransitionName((View) arrayList.get(r0), (String) arrayList4.get(r0));
                }
            }
        });
    }
        ...
        if (view.getVisibility() == 0) {
            if (view instanceof ViewGroup) {
                ...
                for (int r1 = 0; r1 < childCount; r1++) {
                    captureTransitioningViews(arrayList, viewGroup.getChildAt(r1));
                }
                return;
            }
            arrayList.add(view);
    ...
    void findNamedViews(Map<String, View> map, View view) {
        if (view.getVisibility() == 0) {
            ...
            if (view instanceof ViewGroup) {
                ...
                int childCount = viewGroup.getChildCount();
                for (int r1 = 0; r1 < childCount; r1++) {
                    findNamedViews(map, viewGroup.getChildAt(r1));
                }
            }
        }
    }
    ...
    void setNameOverridesOrdered(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.2
            ...
            public void run() {
                int size = arrayList.size();
                for (int r1 = 0; r1 < size; r1++) {
                    View view2 = (View) arrayList.get(r1);
                    String transitionName = ViewCompat.getTransitionName(view2);
                    if (transitionName != null) {
    ...
    private static boolean containedBeforeIndex(List<View> list, View view, int r5) {
