...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int r9, long j) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, r9, j);
        }
    };

    public void onListItemClick(ListView listView, View view, int r3, long j) {
    }
