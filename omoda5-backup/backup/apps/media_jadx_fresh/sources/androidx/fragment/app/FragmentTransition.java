...
class FragmentTransition {
    ...
    static void startTransitions(FragmentManager fragmentManager, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int r19, int r20, boolean z, Callback callback) {
        if (fragmentManager.mCurState < 1) {
            return;
        }
        SparseArray sparseArray = new SparseArray();
        for (int r0 = r19; r0 < r20; r0++) {
            BackStackRecord backStackRecord = arrayList.get(r0);
            if (arrayList2.get(r0).booleanValue()) {
        ...
        if (sparseArray.size() != 0) {
            ...
            for (int r14 = 0; r14 < size; r14++) {
                int r1 = sparseArray.keyAt(r14);
                ArrayMap<String, String> arrayMapCalculateNameOverrides = calculateNameOverrides(r1, arrayList, arrayList2, r19, r20);
                FragmentContainerTransition fragmentContainerTransition = (FragmentContainerTransition) sparseArray.valueAt(r14);
                if (z) {
                    configureTransitionsReordered(fragmentManager, r1, fragmentContainerTransition, view, arrayMapCalculateNameOverrides, callback);
                } else {
                    configureTransitionsOrdered(fragmentManager, r1, fragmentContainerTransition, view, arrayMapCalculateNameOverrides, callback);
                }
            }
        }
    }

    private static ArrayMap<String, String> calculateNameOverrides(int r9, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int r12, int r13) {
        ArrayList<String> arrayList3;
        ArrayList<String> arrayList4;
        ArrayMap<String, String> arrayMap = new ArrayMap<>();
        for (int r132 = r13 - 1; r132 >= r12; r132--) {
            BackStackRecord backStackRecord = arrayList.get(r132);
            if (backStackRecord.interactsWith(r9)) {
    ...
    private static void configureTransitionsReordered(FragmentManager fragmentManager, int r18, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, final Callback callback) {
        Fragment fragment;
        final Fragment fragment2;
        FragmentTransitionImpl fragmentTransitionImplChooseImpl;
        Object obj;
        ViewGroup viewGroup = fragmentManager.mContainer.onHasView() ? (ViewGroup) fragmentManager.mContainer.onFindViewById(r18) : null;
    ...
    private static void configureTransitionsOrdered(FragmentManager fragmentManager, int r20, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, final Callback callback) {
        Fragment fragment;
        final Fragment fragment2;
        FragmentTransitionImpl fragmentTransitionImplChooseImpl;
        Object obj;
        ViewGroup viewGroup = fragmentManager.mContainer.onHasView() ? (ViewGroup) fragmentManager.mContainer.onFindViewById(r20) : null;
        if (viewGroup == null || (fragmentTransitionImplChooseImpl = chooseImpl((fragment2 = fragmentContainerTransition.firstOut), (fragment = fragmentContainerTransition.lastIn))) == null) {
            return;
        }
        boolean z = fragmentContainerTransition.lastInIsPop;
    ...
    private static boolean canHandleAll(FragmentTransitionImpl fragmentTransitionImpl, List<Object> list) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            if (!fragmentTransitionImpl.canHandle(list.get(r2))) {
                return false;
            }
        }
        return true;
    ...
    private static String findKeyForValue(ArrayMap<String, String> arrayMap, String str) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            if (str.equals(arrayMap.valueAt(r1))) {
                return arrayMap.keyAt(r1);
            }
        }
        return null;
    }
    ...
    static void callSharedElementStartEnd(Fragment fragment, Fragment fragment2, boolean z, ArrayMap<String, View> arrayMap, boolean z2) {
        ...
        if (enterTransitionCallback != null) {
            ...
            for (int r0 = 0; r0 < size; r0++) {
                arrayList2.add(arrayMap.keyAt(r0));
                arrayList.add(arrayMap.valueAt(r0));
            }
            if (z2) {
    ...
    static void setViewVisibility(ArrayList<View> arrayList, int r3) {
        if (arrayList == null) {
            return;
        }
        for (int size = arrayList.size() - 1; size >= 0; size--) {
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            addToFirstInLastOut(backStackRecord, backStackRecord.mOps.get(r2), sparseArray, false, z);
        }
    }
    ...
    */
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r8, androidx.fragment.app.FragmentTransaction.C0285Op r9, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r10, boolean r11, boolean r12) {
        /*
    ...
    private static FragmentContainerTransition ensureContainer(FragmentContainerTransition fragmentContainerTransition, SparseArray<FragmentContainerTransition> sparseArray, int r2) {
        if (fragmentContainerTransition != null) {
            return fragmentContainerTransition;
        }
        FragmentContainerTransition fragmentContainerTransition2 = new FragmentContainerTransition();
        sparseArray.put(r2, fragmentContainerTransition2);
