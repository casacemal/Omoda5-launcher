...
import com.chery.libvr.bean.params.ParamsValue;
...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(r1);
            switch (c0285Op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0285Op.mFragment);
            if (z) {
                if (c0285Op.mEnterAnim != 0 || c0285Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0285Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0285Op.mExitAnim));
                }
                if (c0285Op.mPopEnterAnim != 0 || c0285Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0285Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0285Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    void doAddOp(int r1, Fragment fragment, String str, int r4) {
    ...
    void bumpBackStackNesting(int r8) {
        if (this.mAddToBackStack) {
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v(TAG, "Bump nesting in " + this + " by " + r8);
            }
            int size = this.mOps.size();
            for (int r3 = 0; r3 < size; r3++) {
                FragmentTransaction.C0285Op c0285Op = this.mOps.get(r3);
                if (c0285Op.mFragment != null) {
                    c0285Op.mFragment.mBackStackNesting += r8;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v(TAG, "Bump nesting of " + c0285Op.mFragment + " to " + c0285Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    boolean interactsWith(int r6) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(r2);
            int r3 = c0285Op.mFragment != null ? c0285Op.mFragment.mContainerId : 0;
            if (r3 != 0 && r3 == r6) {
                return true;
            }
        }
    ...
    boolean interactsWith(ArrayList<BackStackRecord> arrayList, int r12, int r13) {
        if (r13 == r12) {
            return false;
        }
        int size = this.mOps.size();
        ...
        for (int r3 = 0; r3 < size; r3++) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(r3);
            int r4 = c0285Op.mFragment != null ? c0285Op.mFragment.mContainerId : 0;
            if (r4 != 0 && r4 != r2) {
                for (int r22 = r12; r22 < r13; r22++) {
                    BackStackRecord backStackRecord = arrayList.get(r22);
                    int size2 = backStackRecord.mOps.size();
                    for (int r7 = 0; r7 < size2; r7++) {
                        FragmentTransaction.C0285Op c0285Op2 = backStackRecord.mOps.get(r7);
                        if ((c0285Op2.mFragment != null ? c0285Op2.mFragment.mContainerId : 0) == r4) {
                            return true;
                        }
                    }
                }
    ...
    void executeOps() {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(r2);
            Fragment fragment = c0285Op.mFragment;
            if (fragment != null) {
                fragment.setNextTransition(this.mTransition);
            }
            switch (c0285Op.mCmd) {
                case 1:
                    fragment.setNextAnim(c0285Op.mEnterAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0285Op.mCmd);
                case 3:
                    fragment.setNextAnim(c0285Op.mExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0285Op.mCurrentMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0285Op.mCmd != 1 && fragment != null) {
    ...
    void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(size);
            Fragment fragment = c0285Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0285Op.mCmd) {
                case 1:
                    fragment.setNextAnim(c0285Op.mPopExitAnim);
                ...
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0285Op.mCmd);
                case 3:
                    fragment.setNextAnim(c0285Op.mPopEnterAnim);
                    this.mManager.addFragment(fragment);
                    break;
                case 4:
                    fragment.setNextAnim(c0285Op.mPopEnterAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0285Op.mOldMaxState);
                    break;
            }
            if (!this.mReorderingAllowed && c0285Op.mCmd != 3 && fragment != null) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    */
    androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0285Op) r5
            int r6 = r5.mCmd
            r7 = 0
            r8 = 1
            if (r6 == r8) goto Lb4
    ...
    */
    androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0285Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
    ...
    boolean isPostponed() {
        for (int r1 = 0; r1 < this.mOps.size(); r1++) {
            if (isFragmentPostponed(this.mOps.get(r1))) {
                return true;
            }
        }
        return false;
    ...
    void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener onStartEnterTransitionListener) {
        for (int r0 = 0; r0 < this.mOps.size(); r0++) {
            FragmentTransaction.C0285Op c0285Op = this.mOps.get(r0);
            if (isFragmentPostponed(c0285Op)) {
                c0285Op.mFragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
            }
        }
    }

    private static boolean isFragmentPostponed(FragmentTransaction.C0285Op c0285Op) {
        Fragment fragment = c0285Op.mFragment;
