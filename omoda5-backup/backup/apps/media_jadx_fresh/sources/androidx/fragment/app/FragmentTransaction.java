...
public abstract class FragmentTransaction {
    ...
    static final class C0285Op {
        ...
        C0285Op(int r1, Fragment fragment) {
            this.mCmd = r1;
        ...
        C0285Op(int r1, Fragment fragment, Lifecycle.State state) {
            this.mCmd = r1;
            this.mFragment = fragment;
    ...
    void addOp(C0285Op c0285Op) {
        this.mOps.add(c0285Op);
        c0285Op.mEnterAnim = this.mEnterAnim;
        c0285Op.mExitAnim = this.mExitAnim;
        c0285Op.mPopEnterAnim = this.mPopEnterAnim;
        c0285Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    void doAddOp(int r4, Fragment fragment, String str, int r7) {
        ...
        if (r4 != 0) {
            ...
            if (fragment.mFragmentId != 0 && fragment.mFragmentId != r4) {
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0285Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0285Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0285Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0285Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0285Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0285Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0285Op(10, fragment, state));
        return this;
    }
