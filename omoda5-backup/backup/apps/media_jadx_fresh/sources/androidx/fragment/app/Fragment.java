...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    public final CharSequence getText(int r1) {
        return getResources().getText(r1);
    }

    public final String getString(int r1) {
        return getResources().getString(r1);
    }

    public final String getString(int r1, Object... objArr) {
        return getResources().getString(r1, objArr);
    }
    ...
    public void startActivityForResult(Intent intent, int r3, Bundle bundle) {
        ...
        fragmentHostCallback.onStartActivityFromFragment(this, intent, r3, bundle);
    }

    public void startIntentSenderForResult(IntentSender intentSender, int r11, Intent intent, int r13, int r14, int r15, Bundle bundle) throws IntentSender.SendIntentException {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            throw new IllegalStateException("Fragment " + this + " not attached to Activity");
        }
        fragmentHostCallback.onStartIntentSenderFromFragment(this, intentSender, r11, intent, r13, r14, r15, bundle);
    }

    public final void requestPermissions(String[] strArr, int r3) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            throw new IllegalStateException("Fragment " + this + " not attached to Activity");
        }
        fragmentHostCallback.onRequestPermissionsFromFragment(this, strArr, r3);
    }
    ...
    void performAttach() {
        this.mChildFragmentManager.attachController(this.mHost, new FragmentContainer() { // from class: androidx.fragment.app.Fragment.4
            ...
            public View onFindViewById(int r3) {
                if (Fragment.this.mView == null) {
                    throw new IllegalStateException("Fragment " + this + " does not have a view");
                }
                return Fragment.this.mView.findViewById(r3);
            }
    ...
    void setStateAfterAnimating(int r1) {
        ensureAnimationInfo().mStateAfterAnimating = r1;
    }
