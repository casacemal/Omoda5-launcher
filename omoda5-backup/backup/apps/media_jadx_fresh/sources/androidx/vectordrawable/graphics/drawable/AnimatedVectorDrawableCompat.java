...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int r7) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
            AnimatedVectorDrawableCompat animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat(context);
            animatedVectorDrawableCompat.mDelegateDrawable = ResourcesCompat.getDrawable(context.getResources(), r7, context.getTheme());
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int r0 = 0; r0 < size; r0++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(r0);
