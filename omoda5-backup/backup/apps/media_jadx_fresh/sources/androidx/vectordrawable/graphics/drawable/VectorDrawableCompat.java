...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int r1 = Math.min(2048, (int) (this.mTmpBounds.width() * fAbs));
        int r3 = Math.min(2048, (int) (this.mTmpBounds.height() * fAbs2));
        if (r1 <= 0 || r3 <= 0) {
            return;
        }
        int r4 = canvas.save();
        ...
        this.mVectorState.createCachedBitmapIfNeeded(r1, r3);
        if (!this.mAllowCaching) {
            this.mVectorState.updateCachedBitmap(r1, r3);
    ...
    private static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public void updateCachedBitmap(int r3, int r4) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), r3, r4, null);
        }
        ...
        public boolean onStateChanged(int[] r2) {
            boolean zOnStateChanged = this.mVPathRenderer.onStateChanged(r2);
    ...
    private static class VPathRenderer {
        ...
        public boolean onStateChanged(int[] r1) {
            return this.mRootGroup.onStateChanged(r1);
        }
    }
    ...
    private static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] r4) {
            ...
            for (int r0 = 0; r0 < this.mChildren.size(); r0++) {
                zOnStateChanged |= this.mChildren.get(r0).onStateChanged(r4);
            }
            return zOnStateChanged;
        }
    }
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int r1 = 0; r1 < pathDataNodeArr.length; r1++) {
                ...
                for (float f : pathDataNodeArr[r1].mParams) {
                    str = str + f + ",";
                }
            }
            return str;
    ...
    private static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int r1, Paint.Cap cap) {
            ...
            if (r1 != 1) {
                return r1 != 2 ? cap : Paint.Cap.SQUARE;
            }
        ...
        private Paint.Join getStrokeLineJoin(int r1, Paint.Join join) {
            ...
            if (r1 != 1) {
                return r1 != 2 ? join : Paint.Join.BEVEL;
            }
        ...
        @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VObject
        public boolean onStateChanged(int[] r2) {
            return this.mStrokeColor.onStateChanged(r2) | this.mFillColor.onStateChanged(r2);
        }
        ...
        void setFillColor(int r1) {
            this.mFillColor.setColor(r1);
        }
