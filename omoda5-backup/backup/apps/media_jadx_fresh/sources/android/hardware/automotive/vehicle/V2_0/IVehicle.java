...
public interface IVehicle extends IBase {
    ...
    public interface getCallback {
        void onValues(int r1, VehiclePropValue vehiclePropValue);
    }

    @FunctionalInterface
    public interface getPropConfigsCallback {
        void onValues(int r1, ArrayList<VehiclePropConfig> arrayList);
    }
    ...
    int unsubscribe(IVehicleCallback iVehicleCallback, int r2) throws RemoteException;
    ...
    static IVehicle asInterface(IHwBinder iHwBinder) {
        ...
        if (iHwInterfaceQueryLocalInterface != null && (iHwInterfaceQueryLocalInterface instanceof IVehicle)) {
            return (IVehicle) iHwInterfaceQueryLocalInterface;
        }
    ...
    public static final class Proxy implements IVehicle {
        ...
        public void get(VehiclePropValue vehiclePropValue, getCallback getcallback) throws RemoteException {
            ...
            try {
                ...
                getcallback.onValues(int32, vehiclePropValue2);
            } finally {
                hwParcel2.release();
            }
        }
        ...
        @Override // android.hardware.automotive.vehicle.V2_0.IVehicle
        public int unsubscribe(IVehicleCallback iVehicleCallback, int r4) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IVehicle.kInterfaceName);
            hwParcel.writeStrongBinder(iVehicleCallback == null ? null : iVehicleCallback.asBinder());
    ...
    public static abstract class Stub extends HwBinder implements IVehicle {
        ...
        public void onTransact(int r7, HwParcel hwParcel, final HwParcel hwParcel2, int r10) throws RemoteException {
            switch (r7) {
                case 1:
                    if ((r10 & 1) != 0) {
                ...
                case 2:
                    if (((r10 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        getPropConfigs(hwParcel.readInt32Vector(), new getPropConfigsCallback() { // from class: android.hardware.automotive.vehicle.V2_0.IVehicle.Stub.1
                            ...
                            public void onValues(int r3, ArrayList<VehiclePropConfig> arrayList) {
                                hwParcel2.writeStatus(0);
                                hwParcel2.writeInt32(r3);
                ...
                case 3:
                    if (((r10 & 1) != 0 ? 1 : 0) != 0) {
                        ...
                        get(vehiclePropValue, new getCallback() { // from class: android.hardware.automotive.vehicle.V2_0.IVehicle.Stub.2
                            ...
                            public void onValues(int r3, VehiclePropValue vehiclePropValue2) {
                                hwParcel2.writeStatus(0);
                                hwParcel2.writeInt32(r3);
                ...
                case 4:
                    ...
                    int r6 = set(vehiclePropValue2);
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(r6);
                    hwParcel2.send();
                    return;
                case 5:
                    if ((r10 & 1) != 0) {
                    ...
                    hwParcel.enforceInterface(IVehicle.kInterfaceName);
                    int r62 = subscribe(IVehicleCallback.asInterface(hwParcel.readStrongBinder()), SubscribeOptions.readVectorFromParcel(hwParcel));
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(r62);
                    hwParcel2.send();
                    return;
                case 6:
                    if ((r10 & 1) != 0) {
                    ...
                    hwParcel.enforceInterface(IVehicle.kInterfaceName);
                    int r63 = unsubscribe(IVehicleCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32());
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(r63);
                    hwParcel2.send();
                    return;
                case 7:
                    if ((r10 & 1) != 0) {
                    ...
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeString(strDebugDump);
                    hwParcel2.send();
                    return;
                default:
                    switch (r7) {
