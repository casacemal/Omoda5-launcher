...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Parcelable.Creator<PlaybackStateCompat> CREATOR = new Parcelable.Creator<PlaybackStateCompat>() { // from class: android.support.v4.media.session.PlaybackStateCompat.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public PlaybackStateCompat[] newArray(int r1) {
    ...
    PlaybackStateCompat(int r4, long j, long j2, float f, long j3, int r12, CharSequence charSequence, long j4, List<CustomAction> list, long j5, Bundle bundle) {
        this.mState = r4;
        this.mPosition = j;
    ...
    public static final class CustomAction implements Parcelable {
        public static final Parcelable.Creator<CustomAction> CREATOR = new Parcelable.Creator<CustomAction>() { // from class: android.support.v4.media.session.PlaybackStateCompat.CustomAction.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public CustomAction[] newArray(int r1) {
        ...
        CustomAction(String str, CharSequence charSequence, int r3, Bundle bundle) {
            this.mAction = str;
        ...
        public static final class Builder {
            ...
            public Builder(String str, CharSequence charSequence, int r4) {
    ...
    public static final class Builder {
        ...
        public Builder setState(int r8, long j, float f) {
            return setState(r8, j, f, SystemClock.elapsedRealtime());
        }

        public Builder setState(int r1, long j, float f, long j2) {
            this.mState = r1;
            this.mPosition = j;
            this.mUpdateTime = j2;
            this.mRate = f;
        ...
        public Builder addCustomAction(String str, String str2, int r5) {
            return addCustomAction(new CustomAction(str, str2, r5, null));
        }
        ...
        public Builder setErrorMessage(int r1, CharSequence charSequence) {
            this.mErrorCode = r1;
            this.mErrorMessage = charSequence;
            return this;
        }
