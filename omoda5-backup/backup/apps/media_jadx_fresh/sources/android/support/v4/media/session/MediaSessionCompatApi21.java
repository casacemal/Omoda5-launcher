...
class MediaSessionCompatApi21 {
    ...
    public static void setFlags(Object obj, int r1) {
        ((MediaSession) obj).setFlags(r1);
    }

    public static void setPlaybackToLocal(Object obj, int r2) {
        AudioAttributes.Builder builder = new AudioAttributes.Builder();
        builder.setLegacyStreamType(r2);
