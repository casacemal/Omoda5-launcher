...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Parcelable.Creator<MediaItem> CREATOR = new Parcelable.Creator<MediaItem>() { // from class: android.support.v4.media.MediaBrowserCompat.MediaItem.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public MediaItem[] newArray(int r1) {
        ...
        public MediaItem(MediaDescriptionCompat mediaDescriptionCompat, int r3) {
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            public void onChildrenLoaded(String str, List<?> list) {
                ...
                for (int r2 = 0; r2 < callbacks.size(); r2++) {
                    Bundle bundle = optionsList.get(r2);
                    if (bundle == null) {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void disconnect() {
            ...
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.2
                ...
                public void run() {
                    ...
                    int r0 = MediaBrowserImplBase.this.mState;
                    MediaBrowserImplBase.this.forceCloseConnection();
                    if (r0 != 0) {
                        MediaBrowserImplBase.this.mState = r0;
                    }
                    if (MediaBrowserCompat.DEBUG) {
            ...
            if (isCurrent(messenger, "onConnect")) {
                ...
                try {
                    for (Map.Entry<String, Subscription> entry : this.mSubscriptions.entrySet()) {
                        ...
                        for (int r0 = 0; r0 < callbacks.size(); r0++) {
                            this.mServiceBinderWrapper.addSubscription(key, callbacks.get(r0).mToken, optionsList.get(r0), this.mCallbacksMessenger);
                        }
                    }
                } catch (RemoteException unused) {
        ...
        private static String getStateLabel(int r2) {
            if (r2 == 0) {
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            int r3;
            if (this.mCallbacksMessenger == messenger && (r3 = this.mState) != 0 && r3 != 1) {
                return true;
            }
            int r32 = this.mState;
            if (r32 == 0 || r32 == 1) {
    ...
    private static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int r0 = 0; r0 < this.mOptionsList.size(); r0++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(r0), bundle)) {
                    return this.mCallbacks.get(r0);
                }
            }
            return null;
        }
        ...
        public void putCallback(Bundle bundle, SubscriptionCallback subscriptionCallback) {
            for (int r0 = 0; r0 < this.mOptionsList.size(); r0++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(r0), bundle)) {
                    this.mCallbacks.set(r0, subscriptionCallback);
                    return;
                }
            }
    ...
    private static class ServiceBinderWrapper {
        ...
        private void sendRequest(int r2, Bundle bundle, Messenger messenger) throws RemoteException {
    ...
    private static class ItemReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int r2, Bundle bundle) {
            MediaSessionCompat.ensureClassLoader(bundle);
            if (r2 != 0 || bundle == null || !bundle.containsKey(MediaBrowserServiceCompat.KEY_MEDIA_ITEM)) {
    ...
    private static class SearchResultReceiver extends ResultReceiver {
        ...
        @Override // android.support.v4.os.ResultReceiver
        protected void onReceiveResult(int r4, Bundle bundle) {
            MediaSessionCompat.ensureClassLoader(bundle);
            if (r4 != 0 || bundle == null || !bundle.containsKey(MediaBrowserServiceCompat.KEY_SEARCH_RESULTS)) {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int r3, Bundle bundle) {
            ...
            Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + r3 + " (extras=" + this.mExtras + ", resultData=" + bundle + ")");
        }
    }
}
