...
class PlaybackStateCompatApi21 {
    ...
    public static Object newInstance(int r8, long j, long j2, float f, long j3, CharSequence charSequence, long j4, List<Object> list, long j5) {
        PlaybackState.Builder builder = new PlaybackState.Builder();
        builder.setState(r8, j, f, j4);
    ...
    static final class CustomAction {
        ...
        public static Object newInstance(String str, CharSequence charSequence, int r3, Bundle bundle) {
            PlaybackState.CustomAction.Builder builder = new PlaybackState.CustomAction.Builder(str, charSequence, r3);
