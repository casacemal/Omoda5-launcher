...
public final class RatingCompat implements Parcelable {
    public static final Parcelable.Creator<RatingCompat> CREATOR = new Parcelable.Creator<RatingCompat>() { // from class: android.support.v4.media.RatingCompat.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public RatingCompat[] newArray(int r1) {
    ...
    RatingCompat(int r1, float f) {
        this.mRatingStyle = r1;
        this.mRatingValue = f;
    }
    ...
    public static RatingCompat newUnratedRating(int r2) {
        switch (r2) {
            case 1:
            case 2:
            case 3:
            ...
            case 5:
            case 6:
                return new RatingCompat(r2, RATING_NOT_RATED);
            default:
                return null;
        }
    }
    ...
    public static RatingCompat newStarRating(int r4, float f) {
        float f2;
        if (r4 == 3) {
            f2 = 3.0f;
        } else if (r4 == 4) {
            ...
            if (r4 != 5) {
                Log.e(TAG, "Invalid rating style (" + r4 + ") for a star rating");
                return null;
            }
            f2 = 5.0f;
        }
    ...
    public float getStarRating() {
        int r0 = this.mRatingStyle;
        return ((r0 == 3 || r0 == 4 || r0 == 5) && isRated()) ? this.mRatingValue : RATING_NOT_RATED;
    }
        ...
        if (this.mRatingObj == null && Build.VERSION.SDK_INT >= 19) {
            if (isRated()) {
                ...
                switch (r0) {
                    ...
                    case 4:
                    case 5:
                        this.mRatingObj = Rating.newStarRating(r0, getStarRating());
                        break;
                    case 6:
