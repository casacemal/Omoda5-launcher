...
class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int r1, int r2, int r3, int r4, int r5);
    ...
    public static void setVolumeTo(Object obj, int r1, int r2) {
        ((MediaController) obj).setVolumeTo(r1, r2);
    }

    public static void adjustVolume(Object obj, int r1, int r2) {
        ((MediaController) obj).adjustVolume(r1, r2);
    }
