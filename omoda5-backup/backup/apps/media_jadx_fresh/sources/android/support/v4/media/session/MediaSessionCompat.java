...
public class MediaSessionCompat {
    ...
    interface MediaSessionImpl {
        ...
        void setPlaybackToLocal(int r1);
        ...
        void setRatingType(int r1);

        void setRepeatMode(int r1);

        void setSessionActivity(PendingIntent pendingIntent);

        void setShuffleMode(int r1);
    }
    ...
    public void setFlags(int r1) {
        this.mImpl.setFlags(r1);
    }

    public void setPlaybackToLocal(int r1) {
        this.mImpl.setPlaybackToLocal(r1);
    }
    ...
    public void setRatingType(int r1) {
        this.mImpl.setRatingType(r1);
    }
    ...
    public void setRepeatMode(int r1) {
        this.mImpl.setRepeatMode(r1);
    }

    public void setShuffleMode(int r1) {
        this.mImpl.setShuffleMode(r1);
    }
    ...
    public static abstract class Callback {
        ...
        public void onAddQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int r2) {
        }
        ...
        @Deprecated
        public void onRemoveQueueItemAt(int r1) {
        }
        ...
        public void onSetRepeatMode(int r1) {
        }

        public void onSetShuffleMode(int r1) {
        }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM_AT)) {
                        ...
                        int r6 = bundle.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                        if (r6 >= 0 && r6 < mediaSessionImplApi212.mQueue.size()) {
                            queueItem = mediaSessionImplApi212.mQueue.get(r6);
                        }
                        if (queueItem != null) {
    ...
    public static final class Token implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int r4) {
            if (Build.VERSION.SDK_INT >= 21) {
                parcel.writeParcelable((Parcelable) this.mInner, r4);
            } else {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Parcelable.Creator<QueueItem> CREATOR = new Parcelable.Creator<QueueItem>() { // from class: android.support.v4.media.session.MediaSessionCompat.QueueItem.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public QueueItem[] newArray(int r1) {
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        public static final Parcelable.Creator<ResultReceiverWrapper> CREATOR = new Parcelable.Creator<ResultReceiverWrapper>() { // from class: android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public ResultReceiverWrapper[] newArray(int r1) {
        ...
        public void writeToParcel(Parcel parcel, int r2) {
            this.mResultReceiver.writeToParcel(parcel, r2);
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int getRccStateFromState(int r1) {
            switch (r1) {
                case 0:
                    return 0;
                case 1:
        ...
        void postToHandler(int r3, int r4, int r5, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                if (this.mHandler != null) {
                    Message messageObtainMessage = this.mHandler.obtainMessage(r3, r4, r5, obj);
                    Bundle bundle2 = new Bundle();
        ...
        public void setPlaybackToLocal(int r7) {
            ...
            this.mLocalStream = r7;
            this.mVolumeType = 1;
            int r1 = this.mVolumeType;
            int r2 = this.mLocalStream;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(r1, r2, 2, this.mAudioManager.getStreamMaxVolume(r2), this.mAudioManager.getStreamVolume(this.mLocalStream)));
        }
        ...
        public void setShuffleMode(int r2) {
            if (this.mShuffleMode != r2) {
                this.mShuffleMode = r2;
                sendShuffleMode(r2);
            }
        }
        ...
        void adjustVolume(int r3, int r4) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.onAdjustVolume(r3);
                    return;
                }
                return;
            }
            this.mAudioManager.adjustStreamVolume(this.mLocalStream, r3, r4);
        }

        void setVolumeTo(int r3, int r4) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.onSetVolumeTo(r3);
                    return;
                }
                return;
            }
            this.mAudioManager.setStreamVolume(this.mLocalStream, r3, r4);
        }

        void sendVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onVolumeInfoChanged(parcelableVolumeInfo);
        ...
        private void sendSessionDestroyed() {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onSessionDestroyed();
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendEvent(String str, Bundle bundle) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onEvent(str, bundle);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendState(PlaybackStateCompat playbackStateCompat) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onPlaybackStateChanged(playbackStateCompat);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendMetadata(MediaMetadataCompat mediaMetadataCompat) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onMetadataChanged(mediaMetadataCompat);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendQueue(List<QueueItem> list) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onQueueChanged(list);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendQueueTitle(CharSequence charSequence) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onQueueTitleChanged(charSequence);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendCaptioningEnabled(boolean z) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onCaptioningEnabledChanged(z);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendRepeatMode(int r3) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onRepeatModeChanged(r3);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int r3) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onShuffleModeChanged(r3);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendExtras(Bundle bundle) {
            for (int r0 = this.mControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(r0)).onExtrasChanged(bundle);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                int r5;
                synchronized (MediaSessionImplBase.this.mLock) {
                    r3 = MediaSessionImplBase.this.mVolumeType;
                    r4 = MediaSessionImplBase.this.mLocalStream;
                    ...
                    if (r3 == 2) {
                        ...
                        int streamMaxVolume = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(r4);
                        streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(r4);
                        r6 = streamMaxVolume;
                        r5 = 2;
                    }
                }
                return new ParcelableVolumeInfo(r3, r4, r5, r6, streamVolume);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int r1, int r2, String str) {
                MediaSessionImplBase.this.adjustVolume(r1, r2);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int r1, int r2, String str) {
                MediaSessionImplBase.this.setVolumeTo(r1, r2);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setRepeatMode(int r2) throws RemoteException {
                postToHandler(23, r2);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setShuffleMode(int r2) throws RemoteException {
                postToHandler(30, r2);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int r3) {
                postToHandler(26, mediaDescriptionCompat, r3);
            }
            ...
            void postToHandler(int r7) {
                MediaSessionImplBase.this.postToHandler(r7, 0, 0, null, null);
            }

            void postToHandler(int r7, int r8) {
                MediaSessionImplBase.this.postToHandler(r7, r8, 0, null, null);
            }

            void postToHandler(int r7, Object obj) {
                MediaSessionImplBase.this.postToHandler(r7, 0, 0, obj, null);
            }

            void postToHandler(int r7, Object obj, int r9) {
                MediaSessionImplBase.this.postToHandler(r7, r9, 0, obj, null);
            }

            void postToHandler(int r7, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(r7, 0, 0, obj, bundle);
            }
        }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ...
                this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi19.1
                    ...
                    public void onMetadataUpdate(int r7, Object obj) {
                        if (r7 == 268435457 && (obj instanceof Rating)) {
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int r1) {
            MediaSessionCompatApi21.setFlags(this.mSessionObj, r1);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(int r1) {
            MediaSessionCompatApi21.setPlaybackToLocal(this.mSessionObj, r1);
        }
        ...
        public void sendSessionEvent(String str, Bundle bundle) {
            if (Build.VERSION.SDK_INT < 23) {
                for (int r0 = this.mExtraControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(r0)).onEvent(str, bundle);
                    } catch (RemoteException unused) {
                    }
                }
        ...
        public void setPlaybackState(PlaybackStateCompat playbackStateCompat) {
            ...
            for (int r0 = this.mExtraControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                try {
                    ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(r0)).onPlaybackStateChanged(playbackStateCompat);
                } catch (RemoteException unused) {
                }
            }
            this.mExtraControllerCallbacks.finishBroadcast();
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRatingType(int r3) {
            if (Build.VERSION.SDK_INT < 22) {
                this.mRatingType = r3;
            } else {
                MediaSessionCompatApi22.setRatingType(this.mSessionObj, r3);
            }
        }
        ...
        public void setCaptioningEnabled(boolean z) {
            if (this.mCaptioningEnabled != z) {
                ...
                for (int r0 = this.mExtraControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(r0)).onCaptioningEnabledChanged(z);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setRepeatMode(int r3) {
            if (this.mRepeatMode != r3) {
                this.mRepeatMode = r3;
                for (int r0 = this.mExtraControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(r0)).onRepeatModeChanged(r3);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int r3) {
            if (this.mShuffleMode != r3) {
                this.mShuffleMode = r3;
                for (int r0 = this.mExtraControllerCallbacks.beginBroadcast() - 1; r0 >= 0; r0--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(r0)).onShuffleModeChanged(r3);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setRepeatMode(int r1) throws RemoteException {
                throw new AssertionError();
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setShuffleMode(int r1) throws RemoteException {
                throw new AssertionError();
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int r2) {
                throw new AssertionError();
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void removeQueueItemAt(int r1) {
                throw new AssertionError();
            }
