...
public final class MediaControllerCompat {
    ...
    interface MediaControllerImpl {
        ...
        void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int r2);

        void adjustVolume(int r1, int r2);
        ...
        void setVolumeTo(int r1, int r2);
    ...
    static void validateCustomAction(String str, Bundle bundle) {
        ...
        int r1 = str.hashCode();
        if (r1 != -1348483723) {
            if (r1 == 503011406 && str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
                c = 1;
            }
    ...
    public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int r2) {
        this.mImpl.addQueueItem(mediaDescriptionCompat, r2);
    }
    ...
    public void removeQueueItemAt(int r3) {
        ...
        if (queue == null || r3 < 0 || r3 >= queue.size() || (queueItem = queue.get(r3)) == null) {
            return;
        }
    ...
    public void setVolumeTo(int r1, int r2) {
        this.mImpl.setVolumeTo(r1, r2);
    }

    public void adjustVolume(int r1, int r2) {
        this.mImpl.adjustVolume(r1, r2);
    }
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public void onShuffleModeChanged(int r1) {
        }
        ...
        void postToHandler(int r1, Object obj, Bundle bundle) {
            MessageHandler messageHandler = this.mHandler;
            if (messageHandler != null) {
                Message messageObtainMessage = messageHandler.obtainMessage(r1, obj);
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            @Override // android.support.v4.media.session.MediaControllerCompatApi21.Callback
            public void onAudioInfoChanged(int r8, int r9, int r10, int r11, int r12) {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(r8, r9, r10, r11, r12));
                }
            }
        }
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onRepeatModeChanged(int r3) throws RemoteException {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(9, Integer.valueOf(r3), null);
                }
            }

            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onShuffleModeChanged(int r3) throws RemoteException {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(12, Integer.valueOf(r3), null);
                }
            }
    ...
    public static abstract class TransportControls {
        ...
        public abstract void setRepeatMode(int r1);

        public abstract void setShuffleMode(int r1);
    ...
    public static final class PlaybackInfo {
        ...
        PlaybackInfo(int r1, int r2, int r3, int r4, int r5) {
            this.mPlaybackType = r1;
            this.mAudioStream = r2;
            this.mVolumeControl = r3;
            this.mMaxVolume = r4;
            this.mCurrentVolume = r5;
        }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int r6) {
            try {
                if ((this.mBinder.getFlags() & 4) == 0) {
                    throw new UnsupportedOperationException("This session doesn't support queue management operations");
                }
                this.mBinder.addQueueItemAt(mediaDescriptionCompat, r6);
            } catch (RemoteException e) {
        ...
        public void setVolumeTo(int r2, int r3) {
            try {
                this.mBinder.setVolumeTo(r2, r3, null);
            } catch (RemoteException e) {
        ...
        public void adjustVolume(int r2, int r3) {
            try {
                this.mBinder.adjustVolume(r2, r3, null);
            } catch (RemoteException e) {
    ...
    static class TransportControlsBase extends TransportControls {
        ...
        public void setShuffleMode(int r2) {
            try {
                this.mBinder.setShuffleMode(r2);
            } catch (RemoteException e) {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int r6) {
            ...
            Bundle bundle = new Bundle();
            bundle.putParcelable(MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION, mediaDescriptionCompat);
            bundle.putInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, r6);
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int r1, int r2) {
            MediaControllerCompatApi21.setVolumeTo(this.mControllerObj, r1, r2);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void adjustVolume(int r1, int r2) {
            MediaControllerCompatApi21.adjustVolume(this.mControllerObj, r1, r2);
        }
        ...
        private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int r3, Bundle bundle) {
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void setRepeatMode(int r3) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE, r3);
        ...
        public void setShuffleMode(int r3) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE, r3);
