...
.method public delta(Landroid/car/storagemonitoring/IoStatsEntry;)Landroid/car/storagemonitoring/UidIoRecord;
    ...
    iget-object v0, v1, Landroid/car/storagemonitoring/IoStatsEntry;->background:Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    const-string v1, "cannot calculate delta between different user IDs"
...
.method public delta(Landroid/car/storagemonitoring/UidIoRecord;)Landroid/car/storagemonitoring/UidIoRecord;
    ...
    iget v3, v1, Landroid/car/storagemonitoring/UidIoRecord;->uid:I
    ...
    iget-wide v8, v1, Landroid/car/storagemonitoring/UidIoRecord;->foreground_rchar:J

    sub-long/2addr v6, v8

    iget-wide v8, v0, Landroid/car/storagemonitoring/UidIoRecord;->foreground_wchar:J

    iget-wide v10, v1, Landroid/car/storagemonitoring/UidIoRecord;->foreground_wchar:J

    sub-long/2addr v8, v10

    iget-wide v10, v0, Landroid/car/storagemonitoring/UidIoRecord;->foreground_read_bytes:J

    iget-wide v12, v1, Landroid/car/storagemonitoring/UidIoRecord;->foreground_read_bytes:J

    sub-long/2addr v10, v12

    iget-wide v12, v0, Landroid/car/storagemonitoring/UidIoRecord;->foreground_write_bytes:J

    iget-wide v14, v1, Landroid/car/storagemonitoring/UidIoRecord;->foreground_write_bytes:J
    ...
    iget-wide v2, v1, Landroid/car/storagemonitoring/UidIoRecord;->foreground_fsync:J
    ...
    iget-wide v4, v1, Landroid/car/storagemonitoring/UidIoRecord;->background_wchar:J

    sub-long v18, v2, v4

    iget-wide v2, v0, Landroid/car/storagemonitoring/UidIoRecord;->background_read_bytes:J

    iget-wide v4, v1, Landroid/car/storagemonitoring/UidIoRecord;->background_read_bytes:J

    sub-long v20, v2, v4

    iget-wide v2, v0, Landroid/car/storagemonitoring/UidIoRecord;->background_write_bytes:J

    iget-wide v4, v1, Landroid/car/storagemonitoring/UidIoRecord;->background_write_bytes:J

    sub-long v22, v2, v4

    iget-wide v2, v0, Landroid/car/storagemonitoring/UidIoRecord;->background_fsync:J

    iget-wide v0, v1, Landroid/car/storagemonitoring/UidIoRecord;->background_fsync:J
