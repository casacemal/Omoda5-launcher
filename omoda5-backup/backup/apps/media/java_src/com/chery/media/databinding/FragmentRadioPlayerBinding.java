...
public final class FragmentRadioPlayerBinding implements ViewBinding {
    ...
    private FragmentRadioPlayerBinding(ConstraintLayout constraintLayout, ArcScaleView arcScaleView, MediaPlayerLayoutBinding mediaPlayerLayoutBinding, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, ImageView imageView7, ImageView imageView8, LinearLayout linearLayout, RecycleViewSb recycleViewSb, SeekBar seekBar, TextView textView, TextView textView2, TextView textView3, View view, View view2, View view3, View view4, View view5) {
    ...
    public static FragmentRadioPlayerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_radio_player, viewGroup, false);
        if (z) {
