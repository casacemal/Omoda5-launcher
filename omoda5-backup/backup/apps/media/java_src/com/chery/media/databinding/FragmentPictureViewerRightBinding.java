...
public final class FragmentPictureViewerRightBinding implements ViewBinding {
    ...
    public static FragmentPictureViewerRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentPictureViewerRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_picture_viewer_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentPictureViewerRightBinding bind(View view) {
                                                ...
                                                if (imageView8 != null) {
                                                    ...
                                                    if (textView != null) {
                                                        ...
                                                        if (hackyViewPager != null) {
                                                            return new FragmentPictureViewerRightBinding((ConstraintLayout) view, constraintLayout, constraintLayout2, picturePlayerCoverLayoutBindingBind, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, textView, hackyViewPager);
                                                        }
                                                    }
                                                }
                                            }
