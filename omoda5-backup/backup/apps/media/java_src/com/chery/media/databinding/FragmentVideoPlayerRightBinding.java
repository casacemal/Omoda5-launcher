...
public final class FragmentVideoPlayerRightBinding implements ViewBinding {
    ...
    public static FragmentVideoPlayerRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentVideoPlayerRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_video_player_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentVideoPlayerRightBinding bind(View view) {
