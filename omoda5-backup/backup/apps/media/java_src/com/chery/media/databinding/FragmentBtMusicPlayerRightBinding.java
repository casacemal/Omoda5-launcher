...
public final class FragmentBtMusicPlayerRightBinding implements ViewBinding {
    ...
    private FragmentBtMusicPlayerRightBinding(ConstraintLayout constraintLayout, MediaPlayerLayoutBinding mediaPlayerLayoutBinding, MediaPlayerTimeBarLayoutBinding mediaPlayerTimeBarLayoutBinding, ImageButton imageButton, ImageView imageView, ImageView imageView2, ImageView imageView3, TextView textView, TextView textView2, TextView textView3) {
    ...
    public static FragmentBtMusicPlayerRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentBtMusicPlayerRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_bt_music_player_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentBtMusicPlayerRightBinding bind(View view) {
                            ...
                            if (imageView3 != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            return new FragmentBtMusicPlayerRightBinding((ConstraintLayout) view, mediaPlayerLayoutBindingBind, mediaPlayerTimeBarLayoutBindingBind, imageButton, imageView, imageView2, imageView3, textView, textView2, textView3);
                                        }
                                    }
                                }
                            }
