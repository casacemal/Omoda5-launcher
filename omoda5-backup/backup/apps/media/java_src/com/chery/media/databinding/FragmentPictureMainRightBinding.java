...
public final class FragmentPictureMainRightBinding implements ViewBinding {
    ...
    public static FragmentPictureMainRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentPictureMainRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_picture_main_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentPictureMainRightBinding bind(View view) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (textView3 != null) {
                                                                        ...
                                                                        if (textView4 != null) {
                                                                            ...
                                                                            if (textView5 != null) {
                                                                                return new FragmentPictureMainRightBinding((ConstraintLayout) view, constraintLayout, constraintLayout2, constraintLayout3, constraintLayout4, imageView, imageView2, imageView3, imageView4, linearLayout, relativeLayout, recycleViewSb, recycleViewSb2, seekBar, textView, textView2, textView3, textView4, textView5);
                                                                            }
                                                                        }
                                                                    }
                                                                }
