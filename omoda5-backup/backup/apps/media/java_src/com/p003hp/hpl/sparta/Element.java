...
public class Element extends Node {
    ...
    protected int computeHashCode() {
        int r0 = this.tagName_.hashCode();
        Hashtable hashtable = this.attributes_;
        if (hashtable != null) {
            Enumeration enumerationKeys = hashtable.keys();
            while (enumerationKeys.hasMoreElements()) {
                String str = (String) enumerationKeys.nextElement();
                r0 = (((r0 * 31) + str.hashCode()) * 31) + ((String) this.attributes_.get(str)).hashCode();
            }
        }
        for (Node nextSibling = this.firstChild_; nextSibling != null; nextSibling = nextSibling.getNextSibling()) {
            r0 = (r0 * 31) + nextSibling.hashCode();
        }
        return r0;
    }
    ...
    public boolean xpathEnsure(String str) throws ParseException {
        ...
        try {
            ...
            for (int r1 = 0; r1 < r32; r1++) {
                stepArr[r1] = (Step) steps2.nextElement();
            }
