...
import com.p003hp.hpl.sparta.xpath.BooleanExprVisitor;
import com.p003hp.hpl.sparta.xpath.ElementTest;
import com.p003hp.hpl.sparta.xpath.NodeTest;
...
public abstract class Node {
    ...
    protected static void htmlEncode(Writer writer, String str) throws IOException {
        ...
        for (int r1 = 0; r1 < length; r1++) {
            ...
            if (string != null) {
                writer.write(str, r2, r1 - r2);
                writer.write(string);
                r2 = r1 + 1;
            }
        }
        if (r2 < length) {
            writer.write(str, r2, length - r2);
        }
    }
    ...
    public boolean xpathSetStrings(String str, String str2) throws ParseException {
        try {
            int r1 = str.lastIndexOf(47);
            int r2 = r1 + 1;
            if (!str.substring(r2).equals("text()") && str.charAt(r2) != '@') {
                StringBuffer stringBuffer = new StringBuffer();
                ...
                stringBuffer.append(str.charAt(r2));
                stringBuffer.append("'");
                throw new ParseException(stringBuffer.toString());
            }
            boolean z = false;
            String strSubstring = str.substring(0, r1);
            if (str.charAt(r2) == '@') {
                String strSubstring2 = str.substring(r1 + 2);
            ...
            while (enumerationXpathSelectElements2.hasMoreElements()) {
                ...
                if (vector.size() == 0) {
                    ...
                    int r5 = 0;
                    while (r5 < vector.size()) {
                        element2.removeChild((Text) vector.elementAt(r5));
                        r5++;
                        zHasMoreElements = true;
                    }
                }
