...
public class ASMSerializerFactory implements Opcodes {
    ...
    static final String ObjectSerializer_desc = ParamsPosition.f236L + ObjectSerializer + ";";
    static final String SerializeWriter = ASMUtils.type(SerializeWriter.class);
    static final String SerializeWriter_desc = ParamsPosition.f236L + SerializeWriter + ";";
    static final String JavaBeanSerializer = ASMUtils.type(JavaBeanSerializer.class);
    static final String JavaBeanSerializer_desc = ParamsPosition.f236L + ASMUtils.type(JavaBeanSerializer.class) + ";";
    ...
    static class Context {
        ...
        public int getFieldOrinal(String str) {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                if (this.getters[r1].name.equals(str)) {
                    return r1;
                }
            }
            return -1;
    ...
    public JavaBeanSerializer createJavaBeanSerializer(SerializeBeanInfo serializeBeanInfo) throws Exception {
        ...
        int r22 = 0;
        while (r22 < length) {
            FieldInfo fieldInfo3 = fieldInfoArr3[r22];
        ...
        int r23 = 0;
        while (r23 < fieldInfoArr3.length) {
            FieldInfo fieldInfo4 = fieldInfoArr3[r23];
            if (fieldInfo4.fieldClass.isPrimitive()) {
                ...
                methodWriter.visitVarInsn(r13, 0);
                if (fieldInfo4.method != null) {
                    ...
                    classWriter = classWriter2;
                    methodWriter.visitVarInsn(r13, 0);
                    methodWriter.visitLdcInsn(Integer.valueOf(r23));
                    c2 = 183;
    ...
    private void generateWriteAsArray(Class<?> cls, MethodVisitor methodVisitor, FieldInfo[] fieldInfoArr, Context context) throws Exception {
        ...
        int r62 = 0;
        while (r62 < length) {
            int r82 = r62 == length + (-1) ? 93 : 44;
            FieldInfo fieldInfo = fieldInfoArr2[r62];
            ...
            if (cls3 == Byte.TYPE || cls3 == Short.TYPE || cls3 == Integer.TYPE) {
                ...
                c2 = 16;
                methodVisitor.visitVarInsn(16, r4);
                ...
                if (cls3 == Long.TYPE) {
                    ...
                    r10 = Opcodes.INVOKEVIRTUAL;
                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str10, "writeLong", "(J)V");
                    methodVisitor.visitVarInsn(16, r82);
                    ...
                    r10 = Opcodes.INVOKEVIRTUAL;
                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str11, "writeFloat", "(FZ)V");
                    methodVisitor.visitVarInsn(16, r82);
                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "write", str9);
                    ...
                    r10 = Opcodes.INVOKEVIRTUAL;
                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str12, "writeDouble", "(DZ)V");
                    methodVisitor.visitVarInsn(16, r82);
                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "write", str9);
                } else {
                    if (cls3 == Boolean.TYPE) {
                        ...
                        if (cls3.isEnum()) {
                            ...
                            if (cls2 == String.class && context.writeDirect) {
                                ...
                                if (cls2 == null || !Modifier.isPublic(cls2.getModifiers())) {
                                    ...
                                    if (context.writeDirect) {
                                        ...
                                        String str16 = JavaBeanSerializer;
                                        ...
                                        sb2.append(str2);
                                        label5 = label15;
                                        methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str16, "writeAsArrayNonContext", sb2.toString());
                                ...
                                str5 = str14;
                                r7 = Opcodes.INVOKEVIRTUAL;
                                methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str17, "write", str5);
                                methodVisitor.visitLabel(label7);
                            }
                            methodVisitor.visitVarInsn(r5, context.var(str));
                            methodVisitor.visitVarInsn(r6, r21);
                            methodVisitor.visitMethodInsn(r7, SerializeWriter, "write", str5);
                            aSMSerializerFactory = this;
                            str3 = str5;
                            z = false;
                            c = 25;
                            ...
                            methodVisitor.visitVarInsn(25, context.var(str18));
                            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "writeNull", "()V");
                            ...
                            if (format != null) {
                                ...
                                r8 = Opcodes.INVOKEVIRTUAL;
                                methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str20, "writeWithFormat", "(Ljava/lang/Object;Ljava/lang/String;)V");
                            } else {
                                methodVisitor.visitVarInsn(25, Context.fieldName);
                                if ((fieldInfo.fieldType instanceof Class) && ((Class) fieldInfo.fieldType).isPrimitive()) {
                                    ...
                                    r8 = Opcodes.INVOKEVIRTUAL;
                                    methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str21, str4, "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                                    methodVisitor.visitLabel(label20);
                                    methodVisitor.visitLabel(label18);
                                    str = str18;
                                    c = 25;
                                    methodVisitor.visitVarInsn(25, context.var(str));
                                    methodVisitor.visitVarInsn(16, r42);
                                    str3 = str19;
                                    methodVisitor.visitMethodInsn(r8, SerializeWriter, "write", str3);
                                    aSMSerializerFactory = this;
                                }
                            }
                            z = false;
    ...
    private void generateWriteMethod(Class<?> cls, MethodVisitor methodVisitor, FieldInfo[] fieldInfoArr, Context context) throws Exception {
        ...
        if (context.writeDirect) {
            ...
            while (r12 < length2) {
                int r22 = length2;
                if (fieldInfoArr2[r12].method != null) {
                    z = true;
                }
                r12++;
                length2 = r22;
        ...
        if (z2 || !context.writeDirect) {
            ...
            methodVisitor.visitVarInsn(25, 4);
            methodVisitor.visitVarInsn(25, 2);
            methodVisitor.visitMethodInsn(r8, "java/lang/Object", "getClass", "()Ljava/lang/Class;");
            methodVisitor.visitJumpInsn(Opcodes.IF_ACMPEQ, label8);
            methodVisitor.visitLabel(label9);
            methodVisitor.visitVarInsn(25, context.var("out"));
            methodVisitor.visitVarInsn(16, 123);
            methodVisitor.visitMethodInsn(r8, SerializeWriter, "write", "(I)V");
            methodVisitor.visitVarInsn(25, 0);
            methodVisitor.visitVarInsn(25, 1);
        ...
        int r15 = 0;
        while (r15 < length) {
            FieldInfo fieldInfo = fieldInfoArr2[r15];
            Class<?> cls3 = fieldInfo.fieldClass;
            methodVisitor.visitLdcInsn(fieldInfo.name);
            methodVisitor.visitVarInsn(58, Context.fieldName);
            if (cls3 == Byte.TYPE || cls3 == Short.TYPE || cls3 == Integer.TYPE) {
    ...
    private void _int(Class<?> cls, MethodVisitor methodVisitor, FieldInfo fieldInfo, Context context, int r7, char c) {
        Label label = new Label();
        _nameApply(methodVisitor, fieldInfo, context, label);
        _get(methodVisitor, context, fieldInfo);
        methodVisitor.visitVarInsn(54, r7);
        _filters(methodVisitor, fieldInfo, context, label);
        methodVisitor.visitVarInsn(25, context.var("out"));
        methodVisitor.visitVarInsn(21, context.var("seperator"));
        methodVisitor.visitVarInsn(25, Context.fieldName);
        methodVisitor.visitVarInsn(21, r7);
    ...
    private void _list(Class<?> cls, MethodVisitor methodVisitor, FieldInfo fieldInfo, Context context) {
        ...
        if (collectionItemType == String.class && context.writeDirect) {
            ...
            r6 = Opcodes.INVOKEVIRTUAL;
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str4, str, "(I)V");
        }
        methodVisitor.visitVarInsn(r4, r2);
        methodVisitor.visitMethodInsn(r6, JSONSerializer, "popContext", "()V");
        methodVisitor.visitLabel(label);
        _seperator(methodVisitor, context);
        methodVisitor.visitLabel(label11);
        methodVisitor.visitLabel(label9);
