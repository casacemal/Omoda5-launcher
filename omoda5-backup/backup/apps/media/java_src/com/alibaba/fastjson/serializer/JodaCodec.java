...
public class JodaCodec implements ObjectSerializer, ContextObjectSerializer, ObjectDeserializer {
    ...
    /* JADX WARN: Type inference failed for: r4v3, types: [T, org.joda.time.LocalDateTime] */
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj, String str, int r8) {
        ...
        if (jSONLexer.token() == 4) {
            ...
            if (type == Instant.class) {
                ...
                int r4 = 0;
                while (true) {
                    if (r4 >= strStringVal.length()) {
                        z = true;
                        break;
                    }
                    char cCharAt = strStringVal.charAt(r4);
        ...
        if (jSONLexer.token() == 2) {
            ...
            ?? r42 = (T) new LocalDateTime(jLongValue, DateTimeZone.forTimeZone(timeZone));
            if (type == LocalDateTime.class) {
                return r42;
            }
            if (type == LocalDate.class) {
                return (T) r42.toLocalDate();
            }
            if (type == LocalTime.class) {
                return (T) r42.toLocalTime();
            }
            if (type == Instant.class) {
    ...
    */
                    ...
                    if (cCharAt == '-' && cCharAt2 == '-') {
                        ...
                        if (cCharAt == '/' && cCharAt2 == '/') {
                            ...
                            if (cCharAt8 == '/' && cCharAt10 == '/') {
                                int r8 = ((cCharAt9 - '0') * 10) + (cCharAt - '0');
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r6) throws IOException {
        ...
        if (type == LocalDateTime.class) {
            ...
            if (dateFormatPattern == null) {
                if ((mask & r6) != 0 || jSONSerializer.isEnabled(SerializerFeature.UseISO8601DateFormat)) {
