...
public class ParserConfig {
    ...
    public static final boolean AUTO_SUPPORT = ParamsResValue.RainState.RAIN.equals(IOUtils.getStringProperty(AUTOTYPE_SUPPORT_PROPERTY));
    public static final String SAFE_MODE_PROPERTY = "fastjson.parser.safeMode";
    public static final boolean SAFE_MODE = ParamsResValue.RainState.RAIN.equals(IOUtils.getStringProperty(SAFE_MODE_PROPERTY));

    public interface AutoTypeCheckHandler {
        Class<?> handler(String str, Class<?> cls, int r3);
    }
    ...
    private ParserConfig(ASMDeserializerFactory aSMDeserializerFactory, ClassLoader classLoader, boolean z) {
        ...
        while (true) {
            ...
            jArr[r2] = TypeUtils.fnv1a_64(strArr[r2]);
            r2++;
        }
        Arrays.sort(jArr);
    ...
    public ObjectDeserializer getDeserializer(Class<?> cls, Type type) {
        ...
        if (!guavaError && strReplace.startsWith("com.google.common.collect.")) {
            try {
                ...
                for (int r73 = 0; r73 < 5; r73++) {
                    String str5 = strArr5[r73];
    ...
    */
    public java.lang.Class<?> checkAutoType(java.lang.String r24, java.lang.Class<?> r25, int r26) throws java.lang.Throwable {
        /*
