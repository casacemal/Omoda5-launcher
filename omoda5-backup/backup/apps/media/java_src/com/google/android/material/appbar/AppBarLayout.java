...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.appBarLayoutStyle);
    }

    public AppBarLayout(Context context, AttributeSet attributeSet, int r13) throws IllegalAccessException, Resources.NotFoundException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, r13, C1199R.style.Widget_Design_AppBarLayout);
        }
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.AppBarLayout, r13, C1199R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, typedArrayObtainStyledAttributes.getDrawable(C1199R.styleable.AppBarLayout_android_background));
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.AppBarLayout_expanded)) {
            setExpanded(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(typedArrayObtainStyledAttributes.getDrawable(C1199R.styleable.AppBarLayout_statusBarForeground));
    ...
    public void setStatusBarForegroundColor(int r2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        setStatusBarForeground(new ColorDrawable(r2));
    }

    public void setStatusBarForegroundResource(int r2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    protected void onLayout(boolean z, int r2, int r3, int r4, int r5) {
        ...
        while (true) {
            ...
            if (((LayoutParams) getChildAt(r42).getLayoutParams()).getScrollInterpolator() != null) {
    ...
    public final int getTotalScrollRange() {
        ...
        int r02 = Math.max(0, minimumHeight);
        this.totalScrollRange = r02;
        return r02;
    }
    ...
    protected int[] onCreateDrawableState(int r4) {
        ...
        r0[0] = this.liftable ? C1199R.attr.state_liftable : -C1199R.attr.state_liftable;
        r0[1] = (this.liftable && this.lifted) ? C1199R.attr.state_lifted : -C1199R.attr.state_lifted;
        r0[2] = this.liftable ? C1199R.attr.state_collapsible : -C1199R.attr.state_collapsible;
        r0[3] = (this.liftable && this.lifted) ? C1199R.attr.state_collapsed : -C1199R.attr.state_collapsed;
        return mergeDrawableStates(r42, r0);
    }
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) throws Resources.NotFoundException {
        float dimension = getResources().getDimension(C1199R.dimen.design_appbar_elevation);
        ...
        valueAnimatorOfFloat.setDuration(getResources().getInteger(C1199R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.scrollFlags = 1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.AppBarLayout_Layout);
            this.scrollFlags = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, typedArrayObtainStyledAttributes.getResourceId(C1199R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        boolean isCollapsible() {
            int r2 = this.scrollFlags;
            return (r2 & 1) == 1 && (r2 & 10) != 0;
        }
    }
    ...
    public static class Behavior extends BaseBehavior<AppBarLayout> {
        ...
        @Override // com.google.android.material.appbar.AppBarLayout.BaseBehavior
        public /* bridge */ /* synthetic */ void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int r4, int r5, int[] r6, int r7) throws Resources.NotFoundException {
        ...
        @Override // com.google.android.material.appbar.AppBarLayout.BaseBehavior
        public /* bridge */ /* synthetic */ void onStopNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int r4) throws Resources.NotFoundException {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, T t, View view, int r10, int r11, int[] r12, int r13) throws Resources.NotFoundException {
            int r102;
            int downNestedPreScrollRange;
            if (r11 != 0) {
                if (r11 < 0) {
                    r102 = -t.getTotalScrollRange();
                    downNestedPreScrollRange = t.getDownNestedPreScrollRange() + r102;
                } else {
                    r102 = -t.getUpNestedPreScrollRange();
                    downNestedPreScrollRange = 0;
                }
                int r4 = r102;
                int r5 = downNestedPreScrollRange;
                if (r4 != r5) {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, T t, View view, int r5) throws Resources.NotFoundException {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, T t, int r5, float f) {
            int height;
            int r0 = Math.abs(getTopBottomOffsetForScrollingSibling() - r5);
            float fAbs = Math.abs(f);
            if (fAbs > 0.0f) {
                height = Math.round((r0 / fAbs) * 1000.0f) * 3;
            } else {
                height = (int) (((r0 / t.getHeight()) + 1.0f) * 150.0f);
            }
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int r6, int r7) {
            ...
            this.offsetAnimator.setDuration(Math.min(r7, MAX_OFFSET_ANIMATION_DURATION));
            this.offsetAnimator.setIntValues(topBottomOffsetForScrollingSibling, r6);
            this.offsetAnimator.start();
        }

        private int getChildIndexOnOffset(T t, int r8) {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    if (topBottomOffsetForScrollingSibling < (minimumHeight + r5) / 2) {
                        r5 = minimumHeight;
                    }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int r10) throws NoSuchFieldException, Resources.NotFoundException {
            int minimumHeight;
            boolean zOnLayoutChild = super.onLayoutChild(coordinatorLayout, (CoordinatorLayout) t, r10);
            ...
            if (r1 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    minimumHeight = ViewCompat.getMinimumHeight(childAt) + t.getTopInset();
                } else {
                    minimumHeight = Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc);
                }
                setHeaderTopBottomOffset(coordinatorLayout, t, r12 + minimumHeight);
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int r11, int r12, int r13) throws NoSuchFieldException, Resources.NotFoundException {
            int topBottomOffsetForScrollingSibling = getTopBottomOffsetForScrollingSibling();
            int r1 = 0;
            if (r12 != 0 && topBottomOffsetForScrollingSibling >= r12 && topBottomOffsetForScrollingSibling <= r13) {
                int r5 = MathUtils.clamp(r11, r12, r13);
                if (topBottomOffsetForScrollingSibling != r5) {
                    int r112 = t.hasChildWithInterpolator() ? interpolateOffset(t, r5) : r5;
                    boolean topAndBottomOffset = setTopAndBottomOffset(r112);
                    r1 = topBottomOffsetForScrollingSibling - r5;
                    this.offsetDelta = r5 - r112;
                    if (!topAndBottomOffset && t.hasChildWithInterpolator()) {
                        coordinatorLayout.dispatchDependentViewsChanged(t);
                    }
                    t.onOffsetChanged(getTopAndBottomOffset());
                    updateAppBarLayoutDrawableState(coordinatorLayout, t, r5, r5 < topBottomOffsetForScrollingSibling ? -1 : 1, false);
                }
            } else {
                this.offsetDelta = 0;
            }
        ...
        private int interpolateOffset(T t, int r9) {
            int r7 = Math.abs(r9);
            int childCount = t.getChildCount();
            int topInset = 0;
            int r2 = 0;
            while (true) {
                ...
                View childAt = t.getChildAt(r2);
                LayoutParams layoutParams = (LayoutParams) childAt.getLayoutParams();
                Interpolator scrollInterpolator = layoutParams.getScrollInterpolator();
                if (r7 < childAt.getTop() || r7 > childAt.getBottom()) {
                    r2++;
                    ...
                    if (topInset > 0) {
                        float f = topInset;
                        return Integer.signum(r9) * (childAt.getTop() + Math.round(f * scrollInterpolator.getInterpolation((r7 - childAt.getTop()) / f)));
                    }
                }
            }
            return r9;
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int r8, int r9, boolean z) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int r0 = 0; r0 < size; r0++) {
                CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) dependents.get(r0).getLayoutParams()).getBehavior();
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int r2 = 0; r2 < childCount; r2++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.firstVisibleChildIndex = r2;
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        float getOverlapRatioForOffset(View view) throws NoSuchFieldException {
            ...
            if (view instanceof AppBarLayout) {
                ...
                if ((downNestedPreScrollRange == 0 || totalScrollRange + appBarLayoutOffset > downNestedPreScrollRange) && (r3 = totalScrollRange - downNestedPreScrollRange) != 0) {
                    return (appBarLayoutOffset / r3) + 1.0f;
                }
            }
            return 0.0f;
        }
