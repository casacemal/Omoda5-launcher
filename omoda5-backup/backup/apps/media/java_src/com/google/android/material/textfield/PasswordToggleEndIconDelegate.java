...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    PasswordToggleEndIconDelegate(TextInputLayout textInputLayout) {
        ...
        this.onEndIconChangedListener = new TextInputLayout.OnEndIconChangedListener() { // from class: com.google.android.material.textfield.PasswordToggleEndIconDelegate.3
            ...
            public void onEndIconChanged(TextInputLayout textInputLayout2, int r2) {
                EditText editText = textInputLayout2.getEditText();
                if (editText == null || r2 != 1) {
                    return;
                }
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C1199R.drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1199R.string.password_toggle_content_description));
