...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f313x = f;
        pathLineOperation.f314y = f2;
    ...
    public void applyToPath(Matrix matrix, Path path) {
        ...
        for (int r1 = 0; r1 < size; r1++) {
            this.operations.get(r1).applyToPath(matrix, path);
        }
    }
    ...
    ShadowCompatOperation createShadowCompatOperation(final Matrix matrix) {
        ...
        return new ShadowCompatOperation() { // from class: com.google.android.material.shape.ShapePath.1
            ...
            public void draw(Matrix matrix2, ShadowRenderer shadowRenderer, int r5, Canvas canvas) {
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    ((ShadowCompatOperation) it.next()).draw(matrix, shadowRenderer, r5, canvas);
                }
            }
        };
    }
    ...
    static abstract class ShadowCompatOperation {
        ...
        public final void draw(ShadowRenderer shadowRenderer, int r3, Canvas canvas) {
            draw(IDENTITY_MATRIX, shadowRenderer, r3, canvas);
        }
    }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int r8, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f314y - this.startY, this.operation.f313x - this.startX), 0.0f);
            Matrix matrix2 = new Matrix(matrix);
            matrix2.preTranslate(this.startX, this.startY);
            matrix2.preRotate(getAngle());
            shadowRenderer.drawEdgeShadow(canvas, matrix2, rectF, r8);
        }

        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f314y - this.startY) / (this.operation.f313x - this.startX)));
        }
    }
    ...
    static class ArcShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int r11, Canvas canvas) {
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f313x, this.f314y);
