...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    */
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 1) {
                ...
                int r0 = motionEvent.findPointerIndex(this.activePointerId);
                if (r0 == -1) {
                    return false;
                }
                int y2 = (int) motionEvent.getY(r0);
                int r2 = this.lastMotionY - y2;
                if (!this.isBeingDragged) {
                    int r3 = Math.abs(r2);
                    int r4 = this.touchSlop;
                    if (r3 > r4) {
                ...
                if (this.isBeingDragged) {
                    this.lastMotionY = y2;
                    scroll(coordinatorLayout, v, r6, getMaxDragOffset(v), 0);
                }
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int r9) {
        return setHeaderTopBottomOffset(coordinatorLayout, v, r9, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int r3, int r4, int r5) {
        int r2;
        int topAndBottomOffset = getTopAndBottomOffset();
        if (r4 == 0 || topAndBottomOffset < r4 || topAndBottomOffset > r5 || topAndBottomOffset == (r2 = MathUtils.clamp(r3, r4, r5))) {
            return 0;
        }
        setTopAndBottomOffset(r2);
        return topAndBottomOffset - r2;
    }
    ...
    final int scroll(CoordinatorLayout coordinatorLayout, V v, int r10, int r11, int r12) {
        return setHeaderTopBottomOffset(coordinatorLayout, v, getTopBottomOffsetForScrollingSibling() - r10, r11, r12);
    }

    final boolean fling(CoordinatorLayout coordinatorLayout, V v, int r16, int r17, float f) {
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f), 0, 0, r16, r17);
