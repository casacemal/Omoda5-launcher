...
public final class DrawableUtils {
    ...
    public static AttributeSet parseDrawableXml(Context context, int r4, CharSequence charSequence) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
