...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1199R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.floatingActionButtonStyle);
    }

    public FloatingActionButton(Context context, AttributeSet attributeSet, int r13) throws Resources.NotFoundException {
        super(ThemeEnforcement.createThemedContext(context, attributeSet, r13, DEF_STYLE_RES), attributeSet, r13);
        this.shadowPadding = new Rect();
        this.touchArea = new Rect();
        Context context2 = getContext();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1199R.styleable.FloatingActionButton, r13, DEF_STYLE_RES, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1199R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.rippleColor = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1199R.styleable.FloatingActionButton_rippleColor);
        this.size = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float dimension3 = typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.FloatingActionButton_useCompatPadding, false);
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1199R.dimen.mtrl_fab_min_touch_target);
        this.maxImageSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.FloatingActionButton_maxImageSize, 0);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1199R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1199R.styleable.FloatingActionButton_hideMotionSpec);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, r13, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build();
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
    ...
    protected void onMeasure(int r3, int r4) {
        ...
        int r32 = Math.min(resolveAdjustedSize(sizeDimension, r3), resolveAdjustedSize(sizeDimension, r4));
        setMeasuredDimension(this.shadowPadding.left + r32 + this.shadowPadding.right, r32 + this.shadowPadding.top + this.shadowPadding.bottom);
    }
    ...
    public void setImageResource(int r2) {
        this.imageHelper.setImageResource(r2);
        onApplySupportImageTint();
    }
    ...
    public void setExpandedComponentIdHint(int r1) {
        this.expandableWidgetHelper.setExpandedComponentIdHint(r1);
    }
    ...
    private int getSizeDimension(int r4) {
        ...
        if (r4 != -1) {
            if (r4 == 1) {
                return resources.getDimensionPixelSize(C1199R.dimen.design_fab_size_mini);
            }
            return resources.getDimensionPixelSize(C1199R.dimen.design_fab_size_normal);
        }
    ...
    public static class Behavior extends BaseBehavior<FloatingActionButton> {
        ...
        @Override // com.google.android.material.floatingactionbutton.FloatingActionButton.BaseBehavior
        public /* bridge */ /* synthetic */ boolean onLayoutChild(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, int r3) {
            return super.onLayoutChild(coordinatorLayout, floatingActionButton, r3);
        }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, int r8) {
            List<View> dependencies = coordinatorLayout.getDependencies(floatingActionButton);
            int size = dependencies.size();
            for (int r2 = 0; r2 < size; r2++) {
                View view = dependencies.get(r2);
                if (view instanceof AppBarLayout) {
            ...
            coordinatorLayout.onLayoutChild(floatingActionButton, r8);
        ...
        private void offsetIfNeeded(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            ...
            if (floatingActionButton.getRight() >= coordinatorLayout.getWidth() - layoutParams.rightMargin) {
                ...
                r1 = floatingActionButton.getLeft() <= layoutParams.leftMargin ? -rect.left : 0;
            }
            ...
            if (r3 != 0) {
                ViewCompat.offsetTopAndBottom(floatingActionButton, r3);
            }
            if (r1 != 0) {
                ViewCompat.offsetLeftAndRight(floatingActionButton, r1);
            }
        }
    }
    ...
    private class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int r3, int r4, int r5, int r6) {
            FloatingActionButton.this.shadowPadding.set(r3, r4, r5, r6);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(r3 + floatingActionButton.imagePadding, r4 + FloatingActionButton.this.imagePadding, r5 + FloatingActionButton.this.imagePadding, r6 + FloatingActionButton.this.imagePadding);
        }
