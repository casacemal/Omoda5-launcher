...
public class RippleDrawableCompat extends Drawable implements Shapeable, TintAwareDrawable {
    ...
    public void setTint(int r1) {
        this.drawableState.delegate.setTint(r1);
    }
    ...
    protected boolean onStateChange(int[] r4) {
        boolean zOnStateChange = super.onStateChange(r4);
        if (this.drawableState.delegate.setState(r4)) {
            zOnStateChange = true;
        }
        boolean zShouldDrawRippleCompat = RippleUtils.shouldDrawRippleCompat(r4);
    ...
    public void setAlpha(int r1) {
        this.drawableState.delegate.setAlpha(r1);
    }
