...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, C1199R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C1199R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C1199R.color.design_fab_shadow_end_color);
    ...
    public void setAlpha(int r2) {
        super.setAlpha(r2);
        this.cornerShadowPaint.setAlpha(r2);
        this.edgeShadowPaint.setAlpha(r2);
    }
    ...
    public boolean getPadding(Rect rect) {
        int r0 = (int) Math.ceil(calculateVerticalPadding(this.rawMaxShadowSize, this.cornerRadius, this.addPaddingForCorners));
        int r3 = (int) Math.ceil(calculateHorizontalPadding(this.rawMaxShadowSize, this.cornerRadius, this.addPaddingForCorners));
