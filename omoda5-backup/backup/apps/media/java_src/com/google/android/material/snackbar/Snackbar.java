...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1199R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int r5) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(viewGroupFindSuitableParent.getContext()) ? C1199R.layout.mtrl_layout_snackbar_include : C1199R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
    ...
    public Snackbar setBackgroundTint(int r4) {
        ...
        if (background != null) {
            ...
            if (Build.VERSION.SDK_INT >= 22) {
                DrawableCompat.setTint(drawableMutate, r4);
            } else {
                drawableMutate.setColorFilter(r4, PorterDuff.Mode.SRC_IN);
            }
        }
        return this;
    }
