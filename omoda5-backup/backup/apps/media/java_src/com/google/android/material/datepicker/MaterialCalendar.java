...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    static <T> MaterialCalendar<T> newInstance(DateSelector<T> dateSelector, int r4, CalendarConstraints calendarConstraints) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) throws Resources.NotFoundException {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            r1 = C1199R.layout.mtrl_calendar_vertical;
            r9 = 1;
        } else {
            r1 = C1199R.layout.mtrl_calendar_horizontal;
            r9 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(r1, viewGroup, false);
        GridView gridView = (GridView) viewInflate.findViewById(C1199R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C1199R.id.mtrl_calendar_months);
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), r9, false) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
            @Override // androidx.recyclerview.widget.LinearLayoutManager
            protected void calculateExtraLayoutSpace(RecyclerView.State state, int[] r4) {
                if (r9 == 0) {
                    r4[0] = MaterialCalendar.this.recyclerView.getWidth();
                    r4[1] = MaterialCalendar.this.recyclerView.getWidth();
                } else {
                    r4[0] = MaterialCalendar.this.recyclerView.getHeight();
                    r4[1] = MaterialCalendar.this.recyclerView.getHeight();
                }
            }
        });
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C1199R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C1199R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C1199R.id.month_navigation_fragment_toggle) != null) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (Pair<Long, Long> pair : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        if (pair.first != null && pair.second != null) {
                            ...
                            int r8 = spanCount;
                            while (r8 <= spanCount2) {
                                View viewFindViewByPosition3 = gridLayoutManager.findViewByPosition(gridLayoutManager.getSpanCount() * r8);
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    int left = r8 == spanCount ? viewFindViewByPosition.getLeft() + (viewFindViewByPosition.getWidth() / 2) : 0;
                                    if (r8 == spanCount2) {
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C1199R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C1199R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C1199R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C1199R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C1199R.id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C1199R.id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C1199R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C1199R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrolled(RecyclerView recyclerView, int r2, int r3) {
                int r1;
                if (r2 < 0) {
                    r1 = MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition();
                } else {
                    r1 = MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                }
                MaterialCalendar.this.current = monthsPagerAdapter.getPageMonth(r1);
                materialButton.setText(monthsPagerAdapter.getPageTitle(r1));
            }
        ...
        materialButton3.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                int r2 = MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition() + 1;
                if (r2 < MaterialCalendar.this.recyclerView.getAdapter().getItemCount()) {
                    MaterialCalendar.this.setCurrentMonth(monthsPagerAdapter.getPageMonth(r2));
                }
            }
        });
        materialButton2.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                int r2 = MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition() - 1;
                if (r2 >= 0) {
                    MaterialCalendar.this.setCurrentMonth(monthsPagerAdapter.getPageMonth(r2));
                }
            }
    ...
    private void postSmoothRecyclerViewScroll(final int r3) {
        this.recyclerView.post(new Runnable() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            @Override // java.lang.Runnable
            public void run() {
                MaterialCalendar.this.recyclerView.smoothScrollToPosition(r3);
            }
        });
    }
