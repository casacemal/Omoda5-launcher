...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0105R.attr.imageButtonStyle);
    }
    ...
    public int[] onCreateDrawableState(int r2) {
        if (this.checked) {
            return mergeDrawableStates(super.onCreateDrawableState(r2 + DRAWABLE_STATE_CHECKED.length), DRAWABLE_STATE_CHECKED);
        }
