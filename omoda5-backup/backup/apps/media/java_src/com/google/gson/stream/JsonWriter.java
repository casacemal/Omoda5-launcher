...
public class JsonWriter implements Closeable, Flushable {
    ...
    static {
        for (int r1 = 0; r1 <= 31; r1++) {
            REPLACEMENT_CHARS[r1] = String.format("\\u%04x", Integer.valueOf(r1));
        }
    ...
    private JsonWriter open(int r1, char c) throws IOException {
        beforeValue();
        push(r1);
        this.out.write(c);
        return this;
    ...
    private JsonWriter close(int r2, int r3, char c) throws IOException {
        int r0 = peek();
        if (r0 != r3 && r0 != r2) {
    ...
    private void replaceTop(int r2) {
        this.stack[this.stackSize - 1] = r2;
    }
    ...
    public JsonWriter value(boolean z) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z ? ParamsResValue.RainState.RAIN : ParamsResValue.RainState.NO_RAIN);
        return this;
    }
    ...
    public JsonWriter value(Boolean bool) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(bool.booleanValue() ? ParamsResValue.RainState.RAIN : ParamsResValue.RainState.NO_RAIN);
        return this;
    }
