...
public final class TypeAdapters {
    ...
    static {
            ...
            */
            public java.util.BitSet read2(com.google.gson.stream.JsonReader r7) throws java.io.IOException {
                ...
                Le:
                    ...
                    if (r0 == r3) goto L75
                    int[] r3 = com.google.gson.internal.bind.TypeAdapters.C144436.$SwitchMap$com$google$gson$stream$JsonToken
                    int r4 = r0.ordinal()
                    r3 = r3[r4]
                    r4 = 1
                    if (r3 == r4) goto L63
                ...
                L75:
                    ...
                    return r6
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C14262.read2(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
            ...
            public void write(JsonWriter jsonWriter, BitSet bitSet) throws IOException {
                ...
                for (int r0 = 0; r0 < length; r0++) {
                    jsonWriter.value(bitSet.get(r0) ? 1L : 0L);
                }
                jsonWriter.endArray();
            }
        }.nullSafe();
        ...
        TypeAdapter<AtomicIntegerArray> typeAdapterNullSafe5 = new TypeAdapter<AtomicIntegerArray>() { // from class: com.google.gson.internal.bind.TypeAdapters.10
            ...
            public AtomicIntegerArray read2(JsonReader jsonReader) throws IOException {
                ...
                for (int r1 = 0; r1 < size; r1++) {
                    atomicIntegerArray.set(r1, ((Integer) arrayList.get(r1)).intValue());
                }
            ...
            public void write(JsonWriter jsonWriter, AtomicIntegerArray atomicIntegerArray) throws IOException {
                ...
                for (int r0 = 0; r0 < length; r0++) {
                    jsonWriter.value(atomicIntegerArray.get(r0));
                }
                jsonWriter.endArray();
            }
        }.nullSafe();
        ...
        TypeAdapter<Number> typeAdapter = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read2(JsonReader jsonReader) throws IOException {
                JsonToken jsonTokenPeek = jsonReader.peek();
                int r0 = C144436.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                if (r0 == 1 || r0 == 3) {
        ...
        TypeAdapter<URI> typeAdapter5 = new TypeAdapter<URI>() { // from class: com.google.gson.internal.bind.TypeAdapters.22
            ...
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, URI r2) throws IOException {
                jsonWriter.value(r2 == null ? null : r2.toASCIIString());
            }
        };
        URI = typeAdapter5;
        ...
        TypeAdapter<UUID> typeAdapter7 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, UUID r2) throws IOException {
                jsonWriter.value(r2 == null ? null : r2.toString());
            }
        };
        UUID = typeAdapter7;
        ...
        TypeAdapter<Calendar> typeAdapter8 = new TypeAdapter<Calendar>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public Calendar read2(JsonReader jsonReader) throws IOException, NumberFormatException {
                ...
                return new GregorianCalendar(r1, r2, r3, r4, r5, r6);
            }
        ...
        TypeAdapter<JsonElement> typeAdapter10 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
            ...
            public JsonElement read2(JsonReader jsonReader) throws IOException {
                switch (C144436.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C144436 {
