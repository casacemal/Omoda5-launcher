...
public class Rotate extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f101ID = "com.bumptech.glide.load.resource.bitmap.Rotate";
    private static final byte[] ID_BYTES = f101ID.getBytes(CHARSET);
    private final int degreesToRotate;

    public Rotate(int r1) {
        this.degreesToRotate = r1;
    }
