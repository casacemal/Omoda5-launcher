...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
    ...
    public HttpUrlFetcher(GlideUrl glideUrl, int r3) {
        this(glideUrl, r3, DEFAULT_CONNECTION_FACTORY);
    }

    HttpUrlFetcher(GlideUrl glideUrl, int r2, HttpUrlConnectionFactory httpUrlConnectionFactory) {
    ...
    private InputStream loadDataWithRedirects(URL url, int r5, URL url2, Map<String, String> map) throws IOException {
        if (r5 >= 5) {
        ...
        cleanup();
        return loadDataWithRedirects(url3, r5 + 1, url, map);
    }
