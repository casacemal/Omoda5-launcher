...
public class UrlLoader implements ModelLoader<URL, InputStream> {
    ...
    @Override // com.bumptech.glide.load.model.ModelLoader
    public ModelLoader.LoadData<InputStream> buildLoadData(URL url, int r3, int r4, Options options) {
        return this.glideUrlLoader.buildLoadData(new GlideUrl(url), r3, r4, options);
    }
