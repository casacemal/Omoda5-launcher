...
public final class FactoryPools {
    ...
    public static <T extends Poolable> Pools.Pool<T> simple(int r1, Factory<T> factory) {
        return build(new Pools.SimplePool(r1), factory);
    }

    public static <T extends Poolable> Pools.Pool<T> threadSafe(int r1, Factory<T> factory) {
        return build(new Pools.SynchronizedPool(r1), factory);
    }
    ...
    public static <T> Pools.Pool<List<T>> threadSafeList(int r2) {
        return build(new Pools.SynchronizedPool(r2), new Factory<List<T>>() { // from class: com.bumptech.glide.util.pool.FactoryPools.2
