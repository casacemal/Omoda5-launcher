...
public final class DataUrlLoader<Model, Data> implements ModelLoader<Model, Data> {
    ...
    public ModelLoader.LoadData<Data> buildLoadData(Model model, int r2, int r3, Options options) {
    ...
    public static final class StreamFactory<Model> implements ModelLoaderFactory<Model, InputStream> {
        private final DataDecoder<InputStream> opener = new DataDecoder<InputStream>() { // from class: com.bumptech.glide.load.model.DataUrlLoader.StreamFactory.1
            ...
            public InputStream decode(String str) {
                ...
                int r3 = str.indexOf(44);
                if (r3 == -1) {
                    throw new IllegalArgumentException("Missing comma in data URL.");
                }
                if (!str.substring(0, r3).endsWith(DataUrlLoader.BASE64_TAG)) {
                    throw new IllegalArgumentException("Not a base64 image data URL.");
                }
                return new ByteArrayInputStream(Base64.decode(str.substring(r3 + 1), 0));
            }
