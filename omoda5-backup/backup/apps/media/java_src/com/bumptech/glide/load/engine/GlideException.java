...
public final class GlideException extends Exception {
    ...
    public void logRootCauses(String str) {
        ...
        while (r1 < size) {
            ...
            sb.append(size);
            sb.append(")");
            Log.i(str, sb.toString(), rootCauses.get(r1));
            r1 = r3;
        }
    }
    ...
    private static final class IndentedAppendable implements Appendable {
        ...
        public Appendable append(CharSequence charSequence, int r5, int r6) throws IOException {
            ...
            if (charSequenceSafeSequence.length() > 0 && charSequenceSafeSequence.charAt(r6 - 1) == '\n') {
                z = true;
            }
            this.printedNewLine = z;
            this.appendable.append(charSequenceSafeSequence, r5, r6);
            return this;
        }
    }
}
