...
class GifFrameLoader {
    ...
    GifFrameLoader(Glide glide, GifDecoder gifDecoder, int r11, int r12, Transformation<Bitmap> transformation, Bitmap bitmap) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder, null, getRequestBuilder(Glide.with(glide.getContext()), r11, r12), transformation, bitmap);
    }
    ...
    static class DelayTarget extends CustomTarget<Bitmap> {
        ...
        DelayTarget(Handler handler, int r2, long j) {
            this.handler = handler;
            this.index = r2;
            this.targetTime = j;
        }
    ...
    private static RequestBuilder<Bitmap> getRequestBuilder(RequestManager requestManager, int r3, int r4) {
        return requestManager.asBitmap().apply((BaseRequestOptions<?>) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).useAnimationPool(true).skipMemoryCache(true).override(r3, r4));
    }
