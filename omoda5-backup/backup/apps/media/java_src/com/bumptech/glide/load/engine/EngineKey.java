...
class EngineKey implements Key {
    ...
    EngineKey(Object obj, Key key, int r3, int r4, Map<Class<?>, Transformation<?>> map, Class<?> cls, Class<?> cls2, Options options) {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            int r0 = this.model.hashCode();
            this.hashCode = r0;
            int r02 = (r0 * 31) + this.signature.hashCode();
            this.hashCode = r02;
            int r03 = (r02 * 31) + this.width;
            this.hashCode = r03;
            int r04 = (r03 * 31) + this.height;
            this.hashCode = r04;
            int r05 = (r04 * 31) + this.transformations.hashCode();
            this.hashCode = r05;
            int r06 = (r05 * 31) + this.resourceClass.hashCode();
            this.hashCode = r06;
            int r07 = (r06 * 31) + this.transcodeClass.hashCode();
            this.hashCode = r07;
            this.hashCode = (r07 * 31) + this.options.hashCode();
        }
