...
public final class GlideExecutor implements ExecutorService {
    ...
    @Deprecated
    public static GlideExecutor newDiskCacheExecutor(int r1, String str, UncaughtThrowableStrategy uncaughtThrowableStrategy) {
        return newDiskCacheBuilder().setThreadCount(r1).setName(str).setUncaughtThrowableStrategy(uncaughtThrowableStrategy).build();
    }
    ...
    @Deprecated
    public static GlideExecutor newSourceExecutor(int r1, String str, UncaughtThrowableStrategy uncaughtThrowableStrategy) {
        return newSourceBuilder().setThreadCount(r1).setName(str).setUncaughtThrowableStrategy(uncaughtThrowableStrategy).build();
    }
    ...
    @Deprecated
    public static GlideExecutor newAnimationExecutor(int r1, UncaughtThrowableStrategy uncaughtThrowableStrategy) {
        return newAnimationBuilder().setThreadCount(r1).setUncaughtThrowableStrategy(uncaughtThrowableStrategy).build();
    }
    ...
    public static final class Builder {
        ...
        public Builder setThreadCount(int r1) {
            this.corePoolSize = r1;
            this.maximumPoolSize = r1;
            return this;
        }
