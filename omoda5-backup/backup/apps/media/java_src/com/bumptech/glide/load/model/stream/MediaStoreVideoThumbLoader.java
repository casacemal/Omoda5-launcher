...
public class MediaStoreVideoThumbLoader implements ModelLoader<Uri, InputStream> {
    ...
    public ModelLoader.LoadData<InputStream> buildLoadData(Uri uri, int r2, int r3, Options options) {
        if (MediaStoreUtil.isThumbnailSize(r2, r3) && isRequestingDefaultFrame(options)) {
