...
import com.bumptech.glide.C0520R;
...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    private static final int VIEW_TAG_ID = C0520R.id.glide_custom_view_target_tag;
    ...
    @Deprecated
    public final CustomViewTarget<T, Z> useTagId(int r1) {
        return this;
    }
    ...
    static final class SizeDeterminer {
        ...
        private boolean isDimensionValid(int r1) {
        ...
        private void notifyCbs(int r2, int r3) {
            Iterator it = new ArrayList(this.cbs).iterator();
            while (it.hasNext()) {
                ((SizeReadyCallback) it.next()).onSizeReady(r2, r3);
            }
        }
        ...
        private boolean isViewStateAndSizeValid(int r1, int r2) {
            return isDimensionValid(r1) && isDimensionValid(r2);
        }
        ...
        private int getTargetDimen(int r3, int r4, int r5) {
            ...
            if (this.view.isLayoutRequested() || r4 != -2) {
                return 0;
            }
