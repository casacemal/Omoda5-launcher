...
final class SizeStrategy implements LruPoolStrategy {
    ...
    @Override // com.bumptech.glide.load.engine.bitmap_recycle.LruPoolStrategy
    public Bitmap get(int r5, int r6, Bitmap.Config config) {
        int bitmapByteSize = Util.getBitmapByteSize(r5, r6, config);
        ...
        if (bitmap != null) {
            bitmap.reconfigure(r5, r6, config);
    ...
    public String logBitmap(int r1, int r2, Bitmap.Config config) {
        return getBitmapString(Util.getBitmapByteSize(r1, r2, config));
    }
    ...
    static String getBitmapString(int r2) {
        return "[" + r2 + "]";
    }
