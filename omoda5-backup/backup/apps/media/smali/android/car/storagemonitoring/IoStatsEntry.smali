...
.method public delta(Landroid/car/storagemonitoring/IoStatsEntry;)Landroid/car/storagemonitoring/IoStatsEntry;
    ...
    iget v3, p0, Landroid/car/storagemonitoring/IoStatsEntry;->uid:I
    ...
    .line 158
    invoke-virtual {v1, v2}, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->delta(Landroid/car/storagemonitoring/IoStatsEntry$Metrics;)Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    invoke-virtual {p0, p1}, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->delta(Landroid/car/storagemonitoring/IoStatsEntry$Metrics;)Landroid/car/storagemonitoring/IoStatsEntry$Metrics;

    move-result-object v7

    move-object v2, v0

    invoke-direct/range {v2 .. v7}, Landroid/car/storagemonitoring/IoStatsEntry;-><init>(IJLandroid/car/storagemonitoring/IoStatsEntry$Metrics;Landroid/car/storagemonitoring/IoStatsEntry$Metrics;)V
    ...
    const-string p1, "cannot calculate delta between different user IDs"
...
.method public representsSameMetrics(Landroid/car/storagemonitoring/UidIoRecord;)Z
    ...
    iget-wide p0, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->fsyncCalls:J
...
.method public writeToJson(Landroid/util/JsonWriter;)V
    ...
    invoke-virtual {p0, p1}, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->writeToJson(Landroid/util/JsonWriter;)V
