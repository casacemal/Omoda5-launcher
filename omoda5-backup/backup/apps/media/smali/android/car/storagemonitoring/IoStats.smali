...
.method public getBackgroundTotals()Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    check-cast v0, Landroid/car/storagemonitoring/IoStatsEntry;

    .line 156
    iget-object v1, v0, Landroid/car/storagemonitoring/IoStatsEntry;->background:Landroid/car/storagemonitoring/IoStatsEntry$Metrics;

    iget-wide v1, v1, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesRead:J
    ...
    iget-wide v1, v1, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWritten:J
    ...
    iget-wide v1, v1, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesReadFromStorage:J
    ...
    iget-wide v1, v1, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWrittenToStorage:J

    add-long/2addr v9, v1

    .line 160
    iget-object v0, v0, Landroid/car/storagemonitoring/IoStatsEntry;->background:Landroid/car/storagemonitoring/IoStatsEntry$Metrics;

    iget-wide v0, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->fsyncCalls:J
...
.method public getForegroundTotals()Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    .line 134
    iget-object v1, v0, Landroid/car/storagemonitoring/IoStatsEntry;->foreground:Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    .line 138
    iget-object v0, v0, Landroid/car/storagemonitoring/IoStatsEntry;->foreground:Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
...
.method public getTotals()Landroid/car/storagemonitoring/IoStatsEntry$Metrics;
    ...
    .line 174
    new-instance v12, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;

    iget-wide v1, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesRead:J

    iget-wide v3, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesRead:J

    add-long v2, v1, v3

    iget-wide v4, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWritten:J

    iget-wide v6, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWritten:J

    add-long/2addr v4, v6

    iget-wide v6, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesReadFromStorage:J

    iget-wide v8, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesReadFromStorage:J

    add-long/2addr v6, v8

    iget-wide v8, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWrittenToStorage:J

    iget-wide v10, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->bytesWrittenToStorage:J

    add-long/2addr v8, v10

    iget-wide v0, v0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->fsyncCalls:J

    iget-wide v10, p0, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;->fsyncCalls:J

    add-long/2addr v10, v0

    move-object v1, v12

    invoke-direct/range {v1 .. v11}, Landroid/car/storagemonitoring/IoStatsEntry$Metrics;-><init>(JJJJJ)V
...
.method public getUserIdStats(I)Landroid/car/storagemonitoring/IoStatsEntry;
    ...
    .line 118
    iget v1, v0, Landroid/car/storagemonitoring/IoStatsEntry;->uid:I
...
.method public writeToJson(Landroid/util/JsonWriter;)V
    ...
    .line 92
    invoke-virtual {v0, p1}, Landroid/car/storagemonitoring/IoStatsEntry;->writeToJson(Landroid/util/JsonWriter;)V
