...
import com.p003hp.hpl.sparta.xpath.AllElementTest;
import com.p003hp.hpl.sparta.xpath.AttrEqualsExpr;
import com.p003hp.hpl.sparta.xpath.AttrExistsExpr;
import com.p003hp.hpl.sparta.xpath.AttrGreaterExpr;
import com.p003hp.hpl.sparta.xpath.AttrLessExpr;
import com.p003hp.hpl.sparta.xpath.AttrNotEqualsExpr;
import com.p003hp.hpl.sparta.xpath.AttrTest;
import com.p003hp.hpl.sparta.xpath.BooleanExpr;
import com.p003hp.hpl.sparta.xpath.ElementTest;
import com.p003hp.hpl.sparta.xpath.ParentNodeTest;
import com.p003hp.hpl.sparta.xpath.PositionEqualsExpr;
import com.p003hp.hpl.sparta.xpath.Step;
import com.p003hp.hpl.sparta.xpath.TextEqualsExpr;
import com.p003hp.hpl.sparta.xpath.TextExistsExpr;
import com.p003hp.hpl.sparta.xpath.TextNotEqualsExpr;
import com.p003hp.hpl.sparta.xpath.TextTest;
import com.p003hp.hpl.sparta.xpath.ThisNodeTest;
import com.p003hp.hpl.sparta.xpath.TrueExpr;
import com.p003hp.hpl.sparta.xpath.Visitor;
...
class XPathVisitor implements Visitor {
    ...
    /* renamed from: com.hp.hpl.sparta.XPathVisitor$1 */
    class C14551 {
    }
    ...
    private static class BooleanStack {
        ...
        /* synthetic */ BooleanStack(C14551 c14551) {
            this();
        }
    ...
    private void accumulateElements(Element element) {
        ...
        for (Node firstChild = element.getFirstChild(); firstChild != null; firstChild = firstChild.getNextSibling()) {
            if (firstChild instanceof Element) {
                r0++;
                this.nodelistRaw_.add(firstChild, r0);
                if (this.multiLevel_) {
        ...
        for (Node firstChild = element.getFirstChild(); firstChild != null; firstChild = firstChild.getNextSibling()) {
            if (firstChild instanceof Element) {
                ...
                if (element2.getTagName() == str) {
                    r0++;
                    this.nodelistRaw_.add(element2, r0);
                }
                if (this.multiLevel_) {
    ...
    @Override // com.p003hp.hpl.sparta.xpath.NodeTestVisitor
    ...
    @Override // com.p003hp.hpl.sparta.xpath.BooleanExprVisitor
    ...
    public void visit(ElementTest elementTest) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            Object objElementAt = vector.elementAt(r2);
