...
public class Retrofit2ConverterFactory extends Converter.Factory {
    ...
    @Deprecated
    public Retrofit2ConverterFactory setParserFeatureValues(int r1) {
        return this;
    }
    ...
    final class RequestBodyConverter<T> implements Converter<T, RequestBody> {
        ...
        public /* bridge */ /* synthetic */ Object convert(Object obj) throws IOException {
            return m44convert((RequestBodyConverter<T>) obj);
        }
        ...
        public RequestBody m44convert(T t) throws IOException {
            try {
