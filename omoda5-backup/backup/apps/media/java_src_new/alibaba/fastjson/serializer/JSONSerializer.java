...
public class JSONSerializer extends SerializeFilterable {
    ...
    public void setContext(SerialContext serialContext, Object obj, Object obj2, int r10) {
        setContext(serialContext, obj, obj2, r10, 0);
    }

    public void setContext(SerialContext serialContext, Object obj, Object obj2, int r11, int r12) {
        if (this.out.disableCircularReferenceDetect) {
            return;
        }
        this.context = new SerialContext(serialContext, obj, obj2, r11, r12);
    ...
    public void println() {
        this.out.write(10);
        for (int r0 = 0; r0 < this.indentCount; r0++) {
    ...
    public final void writeWithFieldName(Object obj, Object obj2, Type type, int r11) {
        try {
            if (obj == null) {
                this.out.writeNull();
            } else {
                getObjectWriter(obj.getClass()).write(this, obj, obj2, type, r11);
            }
        } catch (IOException e) {
            throw new JSONException(e.getMessage(), e);
        }
    ...
    public final void writeWithFormat(Object obj, String str) throws IOException {
        ...
        if (obj instanceof Collection) {
            ...
            this.out.write(91);
            for (int r1 = 0; r1 < collection.size(); r1++) {
                Object next = it.next();
                if (r1 != 0) {
                    this.out.write(44);
                }
