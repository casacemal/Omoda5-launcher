...
public class JSONObjectCodec implements ObjectSerializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r11) throws NoSuchFieldException, IOException {
        ...
        try {
            ...
            mapSerializer.write(jSONSerializer, declaredField.get(obj), obj2, type, r11);
