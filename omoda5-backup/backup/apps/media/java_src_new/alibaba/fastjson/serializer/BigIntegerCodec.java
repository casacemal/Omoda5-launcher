...
public class BigIntegerCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r5) throws IOException {
        ...
        if (string.length() >= 16 && SerializerFeature.isEnabled(r5, serializeWriter.features, SerializerFeature.BrowserCompatible) && (bigInteger.compareTo(LOW) < 0 || bigInteger.compareTo(HIGH) > 0)) {
