...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static boolean FILE_RELATIVE_PATH_SUPPORT = ParamsResValue.RainState.RAIN.equals(IOUtils.getStringProperty("fastjson.deserializer.fileRelativePathSupport"));
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int r9) throws TransformerException, IOException {
        String string;
    ...
    /* JADX WARN: Type inference failed for: r8v35, types: [T, java.text.SimpleDateFormat] */
    @Override // com.alibaba.fastjson.parser.deserializer.ObjectDeserializer
        ...
        if (type == InetSocketAddress.class) {
            ...
            while (true) {
                ...
                if (jSONLexer.token() == 16) {
                    ...
                    return (T) new InetSocketAddress(inetAddress, r6);
                }
            }
        } else {
            ...
            if (type == SimpleDateFormat.class) {
                ?? r82 = (T) new SimpleDateFormat(str, jSONLexer.getLocale());
                r82.setTimeZone(jSONLexer.getTimeZone());
                return r82;
            }
