...
class Util {
    static int getPointerIndex(int r1) {
        return (r1 & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> 8;
    }
    ...
    static /* synthetic */ class C11981 {
        ...
        static {
            ...
            try {
                r0[ImageView.ScaleType.MATRIX.ordinal()] = 1;
    ...
    static boolean isSupportedScaleType(ImageView.ScaleType scaleType) {
        ...
        if (C11981.$SwitchMap$android$widget$ImageView$ScaleType[scaleType.ordinal()] != 1) {
            return true;
        }
