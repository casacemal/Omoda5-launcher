...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int r4, int r5, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !"".equals(str.trim())) {
            ...
            defaultDateTypeAdapter = new DefaultDateTypeAdapter(Date.class, r4, r5);
            DefaultDateTypeAdapter defaultDateTypeAdapter4 = new DefaultDateTypeAdapter(Timestamp.class, r4, r5);
            DefaultDateTypeAdapter defaultDateTypeAdapter5 = new DefaultDateTypeAdapter(java.sql.Date.class, r4, r5);
