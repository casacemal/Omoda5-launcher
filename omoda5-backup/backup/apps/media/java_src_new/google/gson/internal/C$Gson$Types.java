...
public final class C$Gson$Types {
        ...
        if (cls2.isInterface()) {
            ...
            for (int r0 = 0; r0 < length; r0++) {
                ...
                if (cls2.isAssignableFrom(interfaces[r0])) {
                    return getGenericSupertype(cls.getGenericInterfaces()[r0], interfaces[r0], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
    ...
    private static Type resolve(Type type, Class<?> cls, Type type2, Collection<TypeVariable> collection) {
        ...
        if (type2 instanceof ParameterizedType) {
            ...
            for (int r2 = 0; r2 < length; r2++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[r2], collection);
                if (typeResolve4 != actualTypeArguments[r2]) {
                    if (!z) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z = true;
                    }
                    actualTypeArguments[r2] = typeResolve4;
                }
            }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                C$Gson$Preconditions.checkNotNull(this.typeArguments[r1]);
        ...
        public String toString() {
            ...
            for (int r2 = 1; r2 < length; r2++) {
                sb.append(", ");
                sb.append(C$Gson$Types.typeToString(this.typeArguments[r2]));
            }
            sb.append(">");
            return sb.toString();
        }
