...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1199R.style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1199R.attr.bottomAppBarStyle);
    }

    public BottomAppBar(Context context, AttributeSet attributeSet, int r10) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1199R.styleable.BottomAppBar, r10, DEF_STYLE_RES, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1199R.styleable.BottomAppBar_backgroundTint);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1199R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1199R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1199R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.BottomAppBar_hideOnScroll, false);
        typedArrayObtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C1199R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
    ...
    public void setFabAlignmentMode(int r2) {
        maybeAnimateModeChange(r2);
        maybeAnimateMenuView(r2, this.fabAttached);
        this.fabAlignmentMode = r2;
    }
    ...
    public void dispatchAnimationStart() {
        ...
        int r0 = this.animatingModeChangeCounter;
        this.animatingModeChangeCounter = r0 + 1;
        if (r0 != 0 || (arrayList = this.animationListeners) == null) {
            return;
        }
    ...
    public void dispatchAnimationEnd() {
        ArrayList<AnimationListener> arrayList;
        int r0 = this.animatingModeChangeCounter - 1;
        this.animatingModeChangeCounter = r0;
        if (r0 != 0 || (arrayList = this.animationListeners) == null) {
            return;
        }
        Iterator<AnimationListener> it = arrayList.iterator();
    ...
    private void maybeAnimateModeChange(int r4) {
        if (this.fabAlignmentMode == r4 || !ViewCompat.isLaidOut(this)) {
            return;
        }
        ...
        if (this.fabAnimationMode == 1) {
            createFabTranslationXAnimation(r4, arrayList);
        } else {
            createFabDefaultXAnimation(r4, arrayList);
        }
    ...
    protected void createFabDefaultXAnimation(final int r2, List<Animator> list) {
        FloatingActionButton floatingActionButtonFindDependentFab = findDependentFab();
    ...
    private void createFabTranslationXAnimation(int r3, List<Animator> list) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", getFabTranslationX(r3));
        objectAnimatorOfFloat.setDuration(ANIMATION_DURATION);
        list.add(objectAnimatorOfFloat);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int r4, boolean z) {
        if (ViewCompat.isLaidOut(this)) {
            ...
            createMenuViewTranslationAnimation(r4, z, arrayList);
            AnimatorSet animatorSet = new AnimatorSet();
            animatorSet.playTogether(arrayList);
    ...
    private void createMenuViewTranslationAnimation(final int r9, final boolean z, List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        Animator animatorOfFloat = ObjectAnimator.ofFloat(actionMenuView, "alpha", 1.0f);
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, r9, z)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, r9, z);
                }
            });
            AnimatorSet animatorSet = new AnimatorSet();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public float getFabTranslationX(int r3) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(ActionMenuView actionMenuView, int r2, boolean z) {
        actionMenuView.setTranslationX(getActionMenuViewTranslationX(actionMenuView, r2, z));
    }

    protected int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int r10, boolean z) {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public Behavior() {
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int r2, int r3, int r4, int r5, int r6, int r7, int r8, int r9) {
                    ...
                    int r42 = Behavior.this.fabContentRect.height();
                    bottomAppBar.setFabDiameter(r42);
                    CoordinatorLayout.LayoutParams layoutParams = (CoordinatorLayout.LayoutParams) view.getLayoutParams();
                    if (Behavior.this.originalBottomMargin == 0) {
                        layoutParams.bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C1199R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - r42) / 2));
                    }
                }
            };
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int r6) {
            ...
            coordinatorLayout.onLayoutChild(bottomAppBar, r6);
            return super.onLayoutChild(coordinatorLayout, (CoordinatorLayout) bottomAppBar, r6);
        }

        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, View view, View view2, int r6, int r7) {
            return bottomAppBar.getHideOnScroll() && super.onStartNestedScroll(coordinatorLayout, (CoordinatorLayout) bottomAppBar, view, view2, r6, r7);
        }
    }
