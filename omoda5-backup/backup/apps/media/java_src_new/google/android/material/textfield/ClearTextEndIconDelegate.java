...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C1199R.drawable.mtrl_ic_cancel));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1199R.string.clear_text_end_icon_content_description));
