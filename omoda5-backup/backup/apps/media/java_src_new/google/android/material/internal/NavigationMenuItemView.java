...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int r4) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C1199R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C1199R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C1199R.id.design_menu_item_text);
    ...
    @Override // androidx.appcompat.view.menu.MenuView.ItemView
    public void initialize(MenuItemImpl menuItemImpl, int r2) throws Resources.NotFoundException {
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C1199R.id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0105R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) throws Resources.NotFoundException {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable2 = ResourcesCompat.getDrawable(getResources(), C1199R.drawable.navigation_empty_icon, getContext().getTheme());
    ...
    public void setTextAppearance(int r1) {
        TextViewCompat.setTextAppearance(this.textView, r1);
    }
    ...
    public void setIconPadding(int r1) {
        this.textView.setCompoundDrawablePadding(r1);
    }
