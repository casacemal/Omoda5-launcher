...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C1199R.style.Widget_Design_BottomSheet_Modal;
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public void onViewReleased(View view, float f, float f2) {
                ...
                BottomSheetBehavior.this.startSettlingAnimation(view, r2, r8, true);
            }
            ...
            public int clampViewPositionVertical(View view, int r2, int r3) {
                ...
                return MathUtils.clamp(r2, expandedOffset, z ? bottomSheetBehavior.parentHeight : bottomSheetBehavior.collapsedOffset);
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.BottomSheetBehavior_Layout);
        this.shapeThemingEnabled = typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        if (zHasValue) {
            createMaterialShapeDrawable(context, attributeSet, zHasValue, MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1199R.styleable.BottomSheetBehavior_Layout_backgroundTint));
        } else {
            createMaterialShapeDrawable(context, attributeSet, zHasValue);
        }
        createShapeValueAnimator();
        if (Build.VERSION.SDK_INT >= 21) {
            this.elevation = typedArrayObtainStyledAttributes.getDimension(C1199R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        }
        TypedValue typedValuePeekValue = typedArrayObtainStyledAttributes.peekValue(C1199R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (typedValuePeekValue != null && typedValuePeekValue.data == -1) {
            setPeekHeight(typedValuePeekValue.data);
        } else {
            setPeekHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        }
        setHideable(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setFitToContents(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setSaveFlags(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(typedArrayObtainStyledAttributes.getFloat(C1199R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, HIDE_THRESHOLD));
        setExpandedOffset(typedArrayObtainStyledAttributes.getInt(C1199R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int r9) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C1199R.dimen.design_bottom_sheet_peek_height_min);
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V v, View view, int r6) {
        ...
        if (weakReference != null && view == weakReference.get() && this.nestedScrolled) {
            ...
            startSettlingAnimation(v, r0, expandedOffset, false);
            this.nestedScrolled = false;
        }
    }
    ...
    */
    ...
    public void setExpandedOffset(int r1) {
        if (r1 < 0) {
            throw new IllegalArgumentException("offset must be greater than or equal to 0");
        }
        this.expandedOffset = r1;
    }
    ...
    View findScrollingChild(View view) {
        ...
        for (int r0 = 0; r0 < childCount; r0++) {
            View viewFindScrollingChild = findScrollingChild(viewGroup.getChildAt(r0));
    ...
    private void createMaterialShapeDrawable(Context context, AttributeSet attributeSet, boolean z, ColorStateList colorStateList) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attributeSet, C1199R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
    ...
    void settleToState(View view, int r5) {
        ...
        startSettlingAnimation(view, r5, expandedOffset, false);
    }

    void startSettlingAnimation(View view, int r3, int r4, boolean z) {
        boolean zSmoothSlideViewTo;
        if (z) {
            zSmoothSlideViewTo = this.viewDragHelper.settleCapturedViewAt(view.getLeft(), r4);
        } else {
            zSmoothSlideViewTo = this.viewDragHelper.smoothSlideViewTo(view, view.getLeft(), r4);
        }
