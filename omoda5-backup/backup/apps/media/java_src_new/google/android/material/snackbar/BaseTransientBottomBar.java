...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    SnackbarManager.Callback managerCallback = new SnackbarManager.Callback() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.5
        ...
        public void dismiss(int r5) {
            BaseTransientBottomBar.handler.sendMessage(BaseTransientBottomBar.handler.obtainMessage(1, r5, 0, BaseTransientBottomBar.this));
        }
    };
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C1199R.attr.snackbarStyle};
    ...
    private Drawable createThemedBackground() throws Resources.NotFoundException {
        int r0 = MaterialColors.layer(this.view, C1199R.attr.colorSurface, C1199R.attr.colorOnSurface, this.view.getBackgroundOverlayColorAlpha());
        float dimension = this.view.getResources().getDimension(C1199R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1199R.layout.mtrl_layout_snackbar : C1199R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(int r3) {
        View viewFindViewById = this.targetParent.findViewById(r3);
        this.anchorView = viewFindViewById;
        if (viewFindViewById != null) {
            return this;
        }
        throw new IllegalArgumentException("Unable to find anchor view with id: " + r3);
    }
    ...
    protected void dispatchDismiss(int r2) {
        SnackbarManager.getInstance().dismiss(this.managerCallback, r2);
    }
    ...
    public void startSlideInAnimation() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.15
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                int r3 = ((Integer) valueAnimator2.getAnimatedValue()).intValue();
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.offsetTopAndBottom(BaseTransientBottomBar.this.view, r3 - this.previousAnimatedIntValue);
                } else {
                    BaseTransientBottomBar.this.view.setTranslationY(r3);
                }
                this.previousAnimatedIntValue = r3;
            }
        });
        valueAnimator.start();
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1199R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C1199R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1199R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C1199R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1199R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1199R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            typedArrayObtainStyledAttributes.recycle();
