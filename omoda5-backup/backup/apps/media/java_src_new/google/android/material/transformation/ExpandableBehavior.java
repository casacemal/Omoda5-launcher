...
public abstract class ExpandableBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, final View view, int r5) {
        ...
        final int r52 = expandableWidgetFindExpandableWidget.isExpanded() ? 1 : 2;
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.google.android.material.transformation.ExpandableBehavior.1
            ...
            public boolean onPreDraw() {
                ...
                if (ExpandableBehavior.this.currentState == r52) {
    ...
    protected ExpandableWidget findExpandableWidget(CoordinatorLayout coordinatorLayout, View view) {
        ...
        for (int r2 = 0; r2 < size; r2++) {
            View view2 = dependencies.get(r2);
