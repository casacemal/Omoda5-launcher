...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1199R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int r13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1199R.styleable.ExtendedFloatingActionButton, r13, DEF_STYLE_RES, new int[0]);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C1199R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C1199R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec motionSpecCreateFromAttribute3 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C1199R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec motionSpecCreateFromAttribute4 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C1199R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
        ...
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context, attributeSet, r13, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build());
    }
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1199R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = typedArrayObtainStyledAttributes.getBoolean(C1199R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, ExtendedFloatingActionButton extendedFloatingActionButton, int r8) {
            ...
            coordinatorLayout.onLayoutChild(extendedFloatingActionButton, r8);
        ...
        private void offsetIfNeeded(CoordinatorLayout coordinatorLayout, ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if (extendedFloatingActionButton.getRight() >= coordinatorLayout.getWidth() - layoutParams.rightMargin) {
                ...
                r1 = extendedFloatingActionButton.getLeft() <= layoutParams.leftMargin ? -rect.left : 0;
            }
            ...
            if (r3 != 0) {
                ViewCompat.offsetTopAndBottom(extendedFloatingActionButton, r3);
            }
            if (r1 != 0) {
                ViewCompat.offsetLeftAndRight(extendedFloatingActionButton, r1);
            }
        }
    }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1199R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C1199R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C1199R.animator.mtrl_extended_fab_hide_motion_spec;
        }
