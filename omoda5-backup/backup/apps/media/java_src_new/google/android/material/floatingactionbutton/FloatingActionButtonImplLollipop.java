...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int r6) {
        ...
        if (r6 > 0) {
            this.borderDrawable = createBorderDrawable(r6, colorStateList);
    ...
    BorderDrawable createBorderDrawable(int r6, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C1199R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C1199R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C1199R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C1199R.color.design_fab_stroke_end_outer_color));
        borderDrawable.setBorderWidth(r6);
