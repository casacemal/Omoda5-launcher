...
public final class FragmentUsbMusicPlayerRightBinding implements ViewBinding {
    ...
    private FragmentUsbMusicPlayerRightBinding(ConstraintLayout constraintLayout, MediaPlayerLayoutBinding mediaPlayerLayoutBinding, MediaPlayerTimeBarLayoutBinding mediaPlayerTimeBarLayoutBinding, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, LinearLayout linearLayout, RecycleViewSb recycleViewSb, SeekBar seekBar, TextView textView, TextView textView2, MarqueeTextView marqueeTextView) {
    ...
    public static FragmentUsbMusicPlayerRightBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentUsbMusicPlayerRightBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_usb_music_player_right, viewGroup, false);
        if (z) {
    ...
    public static FragmentUsbMusicPlayerRightBinding bind(View view) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (marqueeTextView != null) {
                                                        return new FragmentUsbMusicPlayerRightBinding((ConstraintLayout) view, mediaPlayerLayoutBindingBind, mediaPlayerTimeBarLayoutBindingBind, imageView, imageView2, imageView3, imageView4, linearLayout, recycleViewSb, seekBar, textView, textView2, marqueeTextView);
                                                    }
                                                }
                                            }
                                        }
