...
public final class FragmentVideoMainBinding implements ViewBinding {
    ...
    public static FragmentVideoMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentVideoMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_video_main, viewGroup, false);
        if (z) {
    ...
    public static FragmentVideoMainBinding bind(View view) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (textView3 != null) {
                                                                        ...
                                                                        if (textView4 != null) {
                                                                            ...
                                                                            if (textView5 != null) {
                                                                                return new FragmentVideoMainBinding((ConstraintLayout) view, constraintLayout, constraintLayout2, constraintLayout3, constraintLayout4, imageView, imageView2, imageView3, linearLayout, relativeLayout, recycleViewSb, recycleViewSb2, seekBar, imageView4, textView, textView2, textView3, textView4, textView5);
                                                                            }
                                                                        }
                                                                    }
                                                                }
