...
public final class FragmentUsbMusicPlayerBinding implements ViewBinding {
    ...
    private FragmentUsbMusicPlayerBinding(ConstraintLayout constraintLayout, MediaPlayerLayoutBinding mediaPlayerLayoutBinding, MediaPlayerTimeBarLayoutBinding mediaPlayerTimeBarLayoutBinding, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, LinearLayout linearLayout, RecycleViewSb recycleViewSb, SeekBar seekBar, TextView textView, TextView textView2, MarqueeTextView marqueeTextView) {
    ...
    public static FragmentUsbMusicPlayerBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentUsbMusicPlayerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C0632R.layout.fragment_usb_music_player, viewGroup, false);
        if (z) {
    ...
    public static FragmentUsbMusicPlayerBinding bind(View view) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (marqueeTextView != null) {
                                                        return new FragmentUsbMusicPlayerBinding((ConstraintLayout) view, mediaPlayerLayoutBindingBind, mediaPlayerTimeBarLayoutBindingBind, imageView, imageView2, imageView3, imageView4, linearLayout, recycleViewSb, seekBar, textView, textView2, marqueeTextView);
                                                    }
                                                }
                                            }
                                        }
