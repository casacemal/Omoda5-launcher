...
public final class ContentLengthInputStream extends FilterInputStream {
    ...
    public synchronized int read() throws IOException {
        int r0;
        r0 = super.read();
        checkReadSoFarOrThrow(r0 >= 0 ? 1 : -1);
        return r0;
    }
    ...
    @Override // java.io.FilterInputStream, java.io.InputStream
    public synchronized int read(byte[] bArr, int r2, int r3) throws IOException {
        return checkReadSoFarOrThrow(super.read(bArr, r2, r3));
    }

    private int checkReadSoFarOrThrow(int r5) throws IOException {
        if (r5 >= 0) {
            this.readSoFar += r5;
