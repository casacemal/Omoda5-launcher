...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int r29, RequestOptionsFactory requestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> map, List<RequestListener<Object>> list, boolean z, boolean z2) {
        ...
        this.glideContext = new GlideContext(context, arrayPool, this.registry, new ImageViewTargetFactory(), requestOptionsFactory, map, list, engine, z, r29);
    }
    ...
    public void trimMemory(int r3) {
        Util.assertMainThread();
        Iterator<RequestManager> it = this.managers.iterator();
        while (it.hasNext()) {
            it.next().onTrimMemory(r3);
        }
        this.memoryCache.trimMemory(r3);
        this.bitmapPool.trimMemory(r3);
        this.arrayPool.trimMemory(r3);
    }
