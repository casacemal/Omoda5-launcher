...
public class FixedSizeDrawable extends Drawable {
    ...
    public FixedSizeDrawable(Drawable drawable, int r4, int r5) {
        this(new State(drawable.getConstantState(), r4, r5), drawable);
    }
    ...
    public void setChangingConfigurations(int r1) {
        this.wrapped.setChangingConfigurations(r1);
    }
    ...
    @Override // android.graphics.drawable.Drawable
    public void setColorFilter(int r1, PorterDuff.Mode mode) {
        this.wrapped.setColorFilter(r1, mode);
    }
    ...
    static final class State extends Drawable.ConstantState {
        ...
        State(Drawable.ConstantState constantState, int r2, int r3) {
