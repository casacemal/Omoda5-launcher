...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public static <R> SingleRequest<R> obtain(Context context, GlideContext glideContext, Object obj, Object obj2, Class<R> cls, BaseRequestOptions<?> baseRequestOptions, int r24, int r25, Priority priority, Target<R> target, RequestListener<R> requestListener, List<RequestListener<R>> list, RequestCoordinator requestCoordinator, Engine engine, TransitionFactory<? super R> transitionFactory, Executor executor) {
        return new SingleRequest<>(context, glideContext, obj, obj2, cls, baseRequestOptions, r24, r25, priority, target, requestListener, list, requestCoordinator, engine, transitionFactory, executor);
    }

    private SingleRequest(Context context, GlideContext glideContext, Object obj, Object obj2, Class<R> cls, BaseRequestOptions<?> baseRequestOptions, int r10, int r11, Priority priority, Target<R> target, RequestListener<R> requestListener, List<RequestListener<R>> list, RequestCoordinator requestCoordinator, Engine engine, TransitionFactory<? super R> transitionFactory, Executor executor) {
        ...
        this.overrideWidth = r10;
        this.overrideHeight = r11;
    ...
    private Drawable loadDrawable(int r2) {
        return DrawableDecoderCompat.getDrawable(this.glideContext, r2, this.requestOptions.getTheme() != null ? this.requestOptions.getTheme() : this.context.getTheme());
    }
    ...
    public void onSizeReady(int r23, int r24) throws Throwable {
        this.stateVerifier.throwIfRecycled();
        synchronized (this.requestLock) {
            try {
                try {
                    ...
                    this.width = maybeApplySizeMultiplier(r23, sizeMultiplier);
                    this.height = maybeApplySizeMultiplier(r24, sizeMultiplier);
                    if (IS_VERBOSE_LOGGABLE) {
    ...
    private static int maybeApplySizeMultiplier(int r1, float f) {
        return r1 == Integer.MIN_VALUE ? r1 : Math.round(f * r1);
    }
    ...
    */
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7) {
        /*
            ...
            java.lang.Class<R> r2 = r5.transcodeClass     // Catch: java.lang.Throwable -> Lb6
            r7.append(r2)     // Catch: java.lang.Throwable -> Lb6
        ...
        L56:
            return
        L57:
            r5.onResourceReady(r6, r2, r7)     // Catch: java.lang.Throwable -> Lb6
            monitor-exit(r1)     // Catch: java.lang.Throwable -> Lb6
            return
        L5c:
            r5.resource = r0     // Catch: java.lang.Throwable -> Lb2
    ...
    private void onLoadFailed(GlideException glideException, int r10) {
    ...
    public boolean isEquivalentTo(Request request) {
        ...
        synchronized (this.requestLock) {
            r4 = this.overrideWidth;
            r5 = this.overrideHeight;
            obj = this.model;
        ...
        synchronized (singleRequest.requestLock) {
            r2 = singleRequest.overrideWidth;
            r11 = singleRequest.overrideHeight;
        ...
        return r4 == r2 && r5 == r11 && Util.bothModelsNullEquivalentOrEquals(obj, obj2) && cls.equals(cls2) && baseRequestOptions.equals(baseRequestOptions2) && priority == priority2 && size == size2;
    }
