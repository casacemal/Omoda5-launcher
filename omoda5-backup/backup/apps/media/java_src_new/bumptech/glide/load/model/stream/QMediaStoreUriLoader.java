...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public ModelLoader.LoadData<DataT> buildLoadData(Uri uri, int r15, int r16, Options options) {
        return new ModelLoader.LoadData<>(new ObjectKey(uri), new QMediaStoreUriFetcher(this.context, this.fileDelegate, this.uriDelegate, uri, r15, r16, options, this.dataClass));
    }
    ...
    private static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        QMediaStoreUriFetcher(Context context, ModelLoader<File, DataT> modelLoader, ModelLoader<Uri, DataT> modelLoader2, Uri uri, int r5, int r6, Options options, Class<DataT> cls) {
            this.context = context.getApplicationContext();
            this.fileDelegate = modelLoader;
            this.uriDelegate = modelLoader2;
            this.uri = uri;
