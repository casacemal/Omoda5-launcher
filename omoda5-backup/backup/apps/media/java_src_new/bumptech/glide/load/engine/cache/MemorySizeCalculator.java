...
public final class MemorySizeCalculator {
    ...
    MemorySizeCalculator(Builder builder) {
        ...
        int r2 = Math.round(builder.bitmapPoolScreens * widthPixels);
        int r1 = Math.round(widthPixels * builder.memoryCacheScreens);
        int r3 = maxSize - this.arrayPoolSize;
        int r4 = r1 + r2;
        if (r4 <= r3) {
            this.memoryCacheSize = r1;
            this.bitmapPoolSize = r2;
        } else {
            float f = r3 / (builder.bitmapPoolScreens + builder.memoryCacheScreens);
    ...
    private String toMb(int r3) {
        return Formatter.formatFileSize(this.context, r3);
    }
