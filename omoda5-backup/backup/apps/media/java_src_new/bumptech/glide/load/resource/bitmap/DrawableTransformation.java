...
public class DrawableTransformation implements Transformation<Drawable> {
    ...
    public Resource<Drawable> transform(Context context, Resource<Drawable> resource, int r5, int r6) {
        BitmapPool bitmapPool = Glide.get(context).getBitmapPool();
        Drawable drawable = resource.get();
        Resource<Bitmap> resourceConvert = DrawableToBitmapConverter.convert(bitmapPool, drawable, r5, r6);
        ...
        Resource<Bitmap> resourceTransform = this.wrapped.transform(context, resourceConvert, r5, r6);
