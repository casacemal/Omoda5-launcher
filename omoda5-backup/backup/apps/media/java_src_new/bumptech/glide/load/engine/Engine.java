...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object obj, Key key, int r28, int r29, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, Options options, boolean z3, boolean z4, boolean z5, boolean z6, ResourceCallback resourceCallback, Executor executor) {
        long logTime = VERBOSE_IS_LOGGABLE ? LogTime.getLogTime() : 0L;
        EngineKey engineKeyBuildKey = this.keyFactory.buildKey(obj, key, r28, r29, map, cls, cls2, options);
        synchronized (this) {
            ...
            if (engineResourceLoadFromMemory == null) {
                return waitForExistingOrStartNewJob(glideContext, obj, key, r28, r29, cls, cls2, priority, diskCacheStrategy, map, z, z2, options, z3, z4, z5, z6, resourceCallback, executor, engineKeyBuildKey, logTime);
            }
    ...
    private <R> LoadStatus waitForExistingOrStartNewJob(GlideContext glideContext, Object obj, Key key, int r24, int r25, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, Options options, boolean z3, boolean z4, boolean z5, boolean z6, ResourceCallback resourceCallback, Executor executor, EngineKey engineKey, long j) {
        ...
        DecodeJob<R> decodeJobBuild = this.decodeJobFactory.build(glideContext, obj, engineKey, key, r24, r25, cls, cls2, priority, diskCacheStrategy, map, z, z2, z6, options, engineJobBuild);
    ...
    public class LoadStatus {
        ...
        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f89cb);
            }
        }
    }
