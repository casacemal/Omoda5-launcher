...
final class ResourceCacheKey implements Key {
    ...
    ResourceCacheKey(ArrayPool arrayPool, Key key, Key key2, int r4, int r5, Transformation<?> transformation, Class<?> cls, Options options) {
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        int r0 = (((((this.sourceKey.hashCode() * 31) + this.signature.hashCode()) * 31) + this.width) * 31) + this.height;
        Transformation<?> transformation = this.transformation;
        if (transformation != null) {
            r0 = (r0 * 31) + transformation.hashCode();
        }
        return (((r0 * 31) + this.decodedResourceClass.hashCode()) * 31) + this.options.hashCode();
    }
