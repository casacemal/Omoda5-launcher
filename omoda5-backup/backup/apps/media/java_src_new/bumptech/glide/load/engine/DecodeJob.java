...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    DecodeJob<R> init(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int r21, int r22, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, boolean z3, Options options, Callback<R> callback, int r33) {
        this.decodeHelper.init(glideContext, obj, key, r21, r22, diskCacheStrategy, cls, cls2, priority, options, map, z, z2, this.diskCacheProvider);
    ...
    private void runWrapped() {
        int r0 = C05351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (r0 == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int r0 = C05351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (r0 == 1) {
    ...
    private Stage getNextStage(Stage stage) {
        int r0 = C05351.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage.ordinal()];
        if (r0 == 1) {
    ...
    <Z> Resource<Z> onResourceDecoded(DataSource dataSource, Resource<Z> resource) {
        ...
        int r12 = C05351.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
        if (r12 == 1) {
    ...
    static /* synthetic */ class C05351 {
        ...
        static {
            int[] r0 = new int[EncodeStrategy.values().length];
            $SwitchMap$com$bumptech$glide$load$EncodeStrategy = r0;
            try {
                r0[EncodeStrategy.SOURCE.ordinal()] = 1;
            ...
            int[] r2 = new int[Stage.values().length];
            $SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage = r2;
            try {
                r2[Stage.RESOURCE_CACHE.ordinal()] = 1;
            ...
            int[] r3 = new int[RunReason.values().length];
            $SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason = r3;
            try {
                r3[RunReason.INITIALIZE.ordinal()] = 1;
