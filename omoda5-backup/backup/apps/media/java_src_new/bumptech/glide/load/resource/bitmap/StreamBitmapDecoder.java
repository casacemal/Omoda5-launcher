...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    @Override // com.bumptech.glide.load.ResourceDecoder
    public Resource<Bitmap> decode(InputStream inputStream, int r11, int r12, Options options) throws IOException {
        boolean z;
        ...
        try {
            return this.downsampler.decode(new MarkEnforcingInputStream(exceptionCatchingInputStreamObtain), r11, r12, options, new UntrustedCallbacks(recyclableBufferedInputStream, exceptionCatchingInputStreamObtain));
        } finally {
