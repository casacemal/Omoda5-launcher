#define KANZI_SHADER_USE_MORPHING 0
#define KANZI_SHADER_USE_BASECOLOR_TEXTURE 0
#define KANZI_SHADER_SKINNING_BONE_COUNT 0
#define KANZI_SHADER_NUM_DIRECTIONAL_LIGHTS 1
#define KANZI_SHADER_NUM_POINT_LIGHTS 0
#define KANZI_SHADER_NUM_SPOT_LIGHTS 0
