.class abstract Lcom/android/car/protobuf/Utf8$Processor;
...
.method private static partialIsValidUtf8(Ljava/nio/ByteBuffer;II)I
    ...
    .line 546
    invoke-static {p0, p1, p2}, Lcom/android/car/protobuf/Utf8;->access$300(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-static {p0, v1, v0, p1}, Lcom/android/car/protobuf/Utf8;->access$400(Ljava/nio/ByteBuffer;III)I
...
.method final encodeUtf8(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v1, v2, v3}, Lcom/android/car/protobuf/Utf8;->encode(Ljava/lang/CharSequence;[BII)I
    ...
    .line 672
    invoke-virtual {p0, p1, p2}, Lcom/android/car/protobuf/Utf8$Processor;->encodeUtf8Direct(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V

    goto :goto_0

    .line 674
    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/android/car/protobuf/Utf8$Processor;->encodeUtf8Default(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
...
.method final encodeUtf8Default(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
    ...
    :cond_5
    :try_start_6
    new-instance v3, Lcom/android/car/protobuf/Utf8$UnpairedSurrogateException;

    const/4 v5, 0x0

    invoke-direct {v3, v2, v0, v5}, Lcom/android/car/protobuf/Utf8$UnpairedSurrogateException;-><init>(IILcom/android/car/protobuf/Utf8$1;)V

    .end local v0    # "inLength":I
    .end local v1    # "outIx":I
    .end local v2    # "inIx":I
    .end local p0    # "this":Lcom/android/car/protobuf/Utf8$Processor;
    ...
    .restart local p0    # "this":Lcom/android/car/protobuf/Utf8$Processor;
...
.method final isValidUtf8(Ljava/nio/ByteBuffer;II)Z
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8(ILjava/nio/ByteBuffer;II)I
...
.method final isValidUtf8([BII)Z
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8(I[BII)I
...
.method final partialIsValidUtf8(ILjava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {p0, p1, v1, v2, v3}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8(I[BII)I
    ...
    .line 435
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8Direct(ILjava/nio/ByteBuffer;II)I
    ...
    .line 437
    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8Default(ILjava/nio/ByteBuffer;II)I
...
.method final partialIsValidUtf8Default(ILjava/nio/ByteBuffer;II)I
    ...
    :cond_11
    :goto_3
    invoke-static {p2, v1, p4}, Lcom/android/car/protobuf/Utf8$Processor;->partialIsValidUtf8(Ljava/nio/ByteBuffer;II)I
