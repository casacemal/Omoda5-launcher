...
.method public static getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZIIZ)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {p1 .. p1}, Landroidx/core/provider/FontRequest;->getIdentifier()Ljava/lang/String;
    ...
    .line 344
    invoke-virtual {v3, v8}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->onFontRetrieved(Landroid/graphics/Typeface;)V
    ...
    .line 351
    invoke-static {p0, v2, v6}, Landroidx/core/provider/FontsContractCompat;->getFontInternal(Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/FontsContractCompat$TypefaceResult;

    move-result-object v0

    .line 352
    .local v0, "typefaceResult":Landroidx/core/provider/FontsContractCompat$TypefaceResult;
    if-eqz v3, :cond_3

    .line 353
    iget v9, v0, Landroidx/core/provider/FontsContractCompat$TypefaceResult;->mResult:I

    if-nez v9, :cond_2

    .line 354
    iget-object v9, v0, Landroidx/core/provider/FontsContractCompat$TypefaceResult;->mTypeface:Landroid/graphics/Typeface;

    invoke-virtual {v3, v9, v4}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {v3, v9, v4}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->callbackFailAsync(ILandroid/os/Handler;)V
    ...
    .line 362
    .end local v0    # "typefaceResult":Landroidx/core/provider/FontsContractCompat$TypefaceResult;
    :cond_4
    const/4 v9, 0x0
    ...
    .line 364
    sget-object v0, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;

    if-nez v0, :cond_6

    .line 365
    sget-object v10, Landroidx/core/provider/FontsContractCompat;->sLock:Ljava/lang/Object;
    ...
    sput-object v0, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;
    ...
    :cond_6
    :goto_1
    sget-object v9, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;

    .line 374
    :cond_7
    new-instance v0, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;

    invoke-direct {v0, p0, v2, v6, v7}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;-><init>(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/lang/String;)V

    move-object v10, v0

    .line 377
    .local v10, "fetcher":Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;
    const/4 v11, 0x0
    ...
    invoke-virtual {v0, v10, v5}, Landroidx/core/provider/SelfDestructiveThread;->postAndWait(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroidx/core/provider/FontsContractCompat$TypefaceResult;

    iget-object v0, v0, Landroidx/core/provider/FontsContractCompat$TypefaceResult;->mTypeface:Landroid/graphics/Typeface;

    return-object v0

    .line 382
    :cond_8
    new-instance v0, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;

    invoke-direct {v0, v10}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;-><init>(Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;)V

    .line 383
    .local v0, "task":Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;
    ...
    invoke-virtual {v0, v12, v13, v14}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Landroidx/core/provider/FontsContractCompat$TypefaceResult;

    iget-object v11, v12, Landroidx/core/provider/FontsContractCompat$TypefaceResult;->mTypeface:Landroid/graphics/Typeface;
    :try_end_1
    ...
    .line 386
    .end local v0    # "task":Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;
    :catch_0
    move-exception v0
    ...
    .line 393
    .local v0, "reply":Landroidx/core/provider/SelfDestructiveThread$ReplyCallback;, "Landroidx/core/provider/SelfDestructiveThread$ReplyCallback<Landroidx/core/provider/FontsContractCompat$TypefaceResult;>;"
    if-eqz v3, :cond_b
    ...
    .line 395
    new-instance v12, Landroidx/core/provider/FontsContractCompat$1;

    invoke-direct {v12, v3, v4}, Landroidx/core/provider/FontsContractCompat$1;-><init>(Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;)V
    ...
    .line 410
    :cond_a
    new-instance v12, Landroidx/core/provider/FontsContractCompat$2;

    invoke-direct {v12, v3}, Landroidx/core/provider/FontsContractCompat$2;-><init>(Landroidx/core/content/res/ResourcesCompat$FontCallback;)V
    ...
    .line 426
    .end local v0    # "reply":Landroidx/core/provider/SelfDestructiveThread$ReplyCallback;, "Landroidx/core/provider/SelfDestructiveThread$ReplyCallback<Landroidx/core/provider/FontsContractCompat$TypefaceResult;>;"
    .local v12, "reply":Landroidx/core/provider/SelfDestructiveThread$ReplyCallback;, "Landroidx/core/provider/SelfDestructiveThread$ReplyCallback<Landroidx/core/provider/FontsContractCompat$TypefaceResult;>;"
    :goto_2
    sget-object v13, Landroidx/core/provider/FontsContractCompat;->sLock:Ljava/lang/Object;
    ...
    .line 429
    .local v0, "pendingReplies":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroidx/core/provider/SelfDestructiveThread$ReplyCallback<Landroidx/core/provider/FontsContractCompat$TypefaceResult;>;>;"
    if-eqz v0, :cond_d
    ...
    invoke-virtual {v14, v7, v0}, Landroidx/collection/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 442
    .end local v0    # "pendingReplies":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroidx/core/provider/SelfDestructiveThread$ReplyCallback<Landroidx/core/provider/FontsContractCompat$TypefaceResult;>;>;"
    :cond_e
    monitor-exit v13
    :try_end_2
    ...
    new-instance v13, Landroidx/core/provider/FontsContractCompat$3;

    invoke-direct {v13, v7}, Landroidx/core/provider/FontsContractCompat$3;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v10, v13}, Landroidx/core/provider/SelfDestructiveThread;->postAndReply(Ljava/util/concurrent/Callable;Landroidx/core/provider/SelfDestructiveThread$ReplyCallback;)V
    ...
    new-instance v13, Landroidx/core/provider/FontsContractCompat$OnFetchCompletedAndFirePendingReplyCallback;

    invoke-direct {v13, v7}, Landroidx/core/provider/FontsContractCompat$OnFetchCompletedAndFirePendingReplyCallback;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v10, v13}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;-><init>(Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;Landroidx/core/provider/FontsContractCompat$OnCompletedCallback;)V
