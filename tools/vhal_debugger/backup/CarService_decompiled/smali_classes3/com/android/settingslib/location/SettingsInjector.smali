...
.method static synthetic access$000(Lcom/android/settingslib/location/SettingsInjector;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/settingslib/location/SettingsInjector;
...
.method private static parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settingslib/location/InjectedSetting;
    ...
    invoke-static {v7, v8, p1, v5, v4}, Lcom/android/settingslib/location/SettingsInjector;->parseAttributes(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;Landroid/content/res/Resources;Landroid/util/AttributeSet;)Lcom/android/settingslib/location/InjectedSetting;
    ...
    .end local p0    # "service":Landroid/content/pm/ResolveInfo;
    .end local p1    # "userHandle":Landroid/os/UserHandle;
    .end local p2    # "pm":Landroid/content/pm/PackageManager;
    throw v5
    ...
    .restart local p0    # "service":Landroid/content/pm/ResolveInfo;
    .restart local p1    # "userHandle":Landroid/os/UserHandle;
    .restart local p2    # "pm":Landroid/content/pm/PackageManager;
    :cond_3
...
.method protected getSettings(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .line 133
    .local v7, "settings":Ljava/util/List;, "Ljava/util/List<Lcom/android/settingslib/location/InjectedSetting;>;"
    ...
    :try_start_0
    invoke-static {v10, p1, v1}, Lcom/android/settingslib/location/SettingsInjector;->parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settingslib/location/InjectedSetting;

    move-result-object v11

    .line 136
    .local v11, "setting":Lcom/android/settingslib/location/InjectedSetting;
    if-nez v11, :cond_1
    ...
    .line 143
    .end local v11    # "setting":Lcom/android/settingslib/location/InjectedSetting;
    :catch_0
    move-exception v11
    ...
    const-string v5, "Loaded settings for profile id "
