...
.method private final buildCache(Lkotlin/coroutines/jvm/internal/BaseContinuationImpl;)Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;
    ...
    .line 79
    .local v1, "getModuleMethod":Ljava/lang/reflect/Method;
    ...
    .line 80
    .local v2, "methodClass":Ljava/lang/Class;
    ...
    .line 83
    .local v5, "nameMethod":Ljava/lang/reflect/Method;
    new-instance v6, Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;

    invoke-direct {v6, v1, v3, v5}, Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    move-object v7, v6

    .local v7, "it":Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;
    move v8, v0

    .local v8, "$i$a$1$also":I
    ...
    .end local v7    # "it":Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;
    .end local v8    # "$i$a$1$also":I
    return-object v6

    .line 84
    .end local v1    # "getModuleMethod":Ljava/lang/reflect/Method;
    .end local v2    # "methodClass":Ljava/lang/Class;
    .end local v3    # "getDescriptorMethod":Ljava/lang/reflect/Method;
    .end local v4    # "moduleDescriptorClass":Ljava/lang/Class;
    .end local v5    # "nameMethod":Ljava/lang/reflect/Method;
    :catch_0
    move-exception v1

    .line 85
    .local v1, "ignored":Ljava/lang/Exception;
    sget-object v2, Lkotlin/coroutines/jvm/internal/ModuleNameRetriever;->notOnJava9:Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;

    move-object v3, v2

    .local v0, "$i$a$2$also":I
    .local v3, "it":Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;
    ...
    .end local v0    # "$i$a$2$also":I
    .end local v3    # "it":Lkotlin/coroutines/jvm/internal/ModuleNameRetriever$Cache;
    return-object v2
.end method
