...
.method private static final endsWithLineSeparator(Ljava/nio/CharBuffer;)Z
    .locals 3
    .param p0, "$receiver"    # Ljava/nio/CharBuffer;
...
.method private static final flipBack(Ljava/nio/Buffer;)V
    .locals 1
    .param p0, "$receiver"    # Ljava/nio/Buffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public static final readLine(Ljava/io/InputStream;Ljava/nio/charset/CharsetDecoder;)Ljava/lang/String;
    ...
    .local v6, "$receiver":Ljava/nio/charset/CharsetDecoder;
    move v7, v2

    .line 178
    .local v7, "$i$a$2$with":I
    ...
    .line 177
    .end local v6    # "$receiver":Ljava/nio/charset/CharsetDecoder;
    .end local v7    # "$i$a$2$with":I
    nop

    .line 182
    move-object v1, v3

    .local v1, "$receiver":Ljava/nio/CharBuffer;
    move v6, v2

    .line 183
    .local v6, "$i$a$3$with":I
    ...
    .line 182
    .end local v1    # "$receiver":Ljava/nio/CharBuffer;
    .end local v6    # "$i$a$3$with":I
    nop
...
.method private static final tryDecode(Ljava/nio/charset/CharsetDecoder;Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Z
    .locals 5
    .param p0, "$receiver"    # Ljava/nio/charset/CharsetDecoder;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .local v1, "$receiver":Ljava/nio/charset/CoderResult;
    const/4 v2, 0x0

    move v3, v2

    .line 203
    .local v3, "$i$a$1$with":I
    ...
    .line 204
    .end local v1    # "$receiver":Ljava/nio/charset/CoderResult;
    .end local v3    # "$i$a$1$with":I
    :cond_0
    nop
    ...
    .line 207
    .end local v1    # "isDecoded":Z
    .end local v3    # "$i$a$2$also":I
    :goto_0
    nop
