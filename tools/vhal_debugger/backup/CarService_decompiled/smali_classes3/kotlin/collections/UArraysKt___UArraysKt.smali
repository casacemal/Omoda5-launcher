...
.method private static final random--ajY-9A([I)I
    ...
    invoke-static {p0, v1}, Lkotlin/collections/UArraysKt;->random-2D5oskM([ILkotlin/random/Random;)I
...
.method private static final random-GBYM_sE([B)B
    ...
    invoke-static {p0, v1}, Lkotlin/collections/UArraysKt;->random-oSF2wD8([BLkotlin/random/Random;)B
...
.method private static final random-QwZRm1k([J)J
    ...
    invoke-static {p0, v1}, Lkotlin/collections/UArraysKt;->random-JzugnMA([JLkotlin/random/Random;)J
...
.method private static final random-rL5Bavg([S)S
    ...
    invoke-static {p0, v1}, Lkotlin/collections/UArraysKt;->random-s5X_as8([SLkotlin/random/Random;)S
...
.method public static final toTypedArray--ajY-9A([I)[Lkotlin/UInt;
    ...
    .local v6, "index":I
    invoke-static {p0, v6}, Lkotlin/UIntArray;->get-impl([II)I
...
.method public static final toTypedArray-GBYM_sE([B)[Lkotlin/UByte;
    ...
    .line 646
    .local v5, "$i$a$3$<init>":I
    .local v6, "index":I
    invoke-static {p0, v6}, Lkotlin/UByteArray;->get-impl([BI)B

    move-result v6

    .end local v5    # "$i$a$3$<init>":I
    .end local v6    # "index":I
...
.method public static final toTypedArray-QwZRm1k([J)[Lkotlin/ULong;
    ...
    .line 637
    .local v5, "$i$a$2$<init>":I
    .local v6, "index":I
    invoke-static {p0, v6}, Lkotlin/ULongArray;->get-impl([JI)J

    move-result-wide v6

    .end local v5    # "$i$a$2$<init>":I
    .end local v6    # "index":I
...
.method public static final toTypedArray-rL5Bavg([S)[Lkotlin/UShort;
    ...
    .line 726
    .local v2, "$i$f$Array":I
    new-array v3, v0, [Lkotlin/UShort;
    ...
    .line 655
    .local v5, "$i$a$4$<init>":I
    .local v6, "index":I
    invoke-static {p0, v6}, Lkotlin/UShortArray;->get-impl([SI)S

    move-result v6

    .end local v5    # "$i$a$4$<init>":I
    .end local v6    # "index":I
