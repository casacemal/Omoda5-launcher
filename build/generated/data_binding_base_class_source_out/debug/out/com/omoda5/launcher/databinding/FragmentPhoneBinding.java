...
public final class FragmentPhoneBinding implements ViewBinding {
  ...
  private FragmentPhoneBinding(@NonNull LinearLayout rootView, @NonNull TextView tvSubtitle,
  ...
  public static FragmentPhoneBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPhoneBinding((LinearLayout) rootView, tvSubtitle, tvTitle);
    }
