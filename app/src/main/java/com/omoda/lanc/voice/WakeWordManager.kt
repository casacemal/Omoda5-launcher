 ...
 * Sürekli dinler, Hermes STT ile kontrol eder. (Cloud-Based Lite Version)
 */
class WakeWordManager(
            ...
            while (isListening) {
                ...
                if (audioData != null && audioData.size > 1000) {
                    ...
                    if (text != null) {
                        ...
                        // Hallucination and spam filtering
                        val hallucinationPatterns = listOf("altyazı", "abone", "teşekkür", "viewing", "evet.", "hadi.", "m.k", "m k", "m. k")
    ...
    private fun transcribe(audioData: ByteArray): String? {
        return try {
            ...
            val targetUrl = "${GlobalState.STT_BASE_URL}/audio/transcriptions"
            val apiKey = GlobalState.NINEROUTER_API_KEY
