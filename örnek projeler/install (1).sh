...
$ADB shell pm grant $PACKAGE android.permission.HIGH_SAMPLING_RATE_SENSORS 2>/dev/null || true
# Car permissions (Android Automotive)
$ADB shell pm grant $PACKAGE android.car.permission.CAR_SPEED 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_ENERGY 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_ENGINE_DETAILED 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_POWERTRAIN 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_TIRES 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_INFO 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_EXTERIOR_ENVIRONMENT 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_MILEAGE 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_VENDOR_EXTENSION 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_DYNAMICS_STATE 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CONTROL_CAR_CLIMATE 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.READ_CAR_DISPLAY_UNITS 2>/dev/null || true
$ADB shell pm grant $PACKAGE android.car.permission.CAR_DRIVING_STATE 2>/dev/null || true
